if (function (t, e) {
	...
	"object" == typeof module && "object" == typeof module.exports ? module.exports = t.document ? e(t, !0) : function (t) {
		...
		("undefined" != typeof window ? window : this, function (t, e) {
			"use strict";
			function n(t, e) {
				var n = (e = e || nt).createElement("script");
				n.text = t,
			...
			function s(t) {
				var e = {};
				return gt.each(t.match(Et) || [], function (t, n) {
					e[n] = !0
				}),
				e
			}
			...
			function m(t) {
				...
				i = t.nodeName,
				o = Vt[i];
				return o || (e = n.body.appendChild(n.createElement(i)), o = gt.css(e, "display"), e.parentNode.removeChild(e), "none" === o && (o = "block"), Vt[i] = o, o)
			}
			function v(t, e) {
				for (var n, i, o = [], r = 0, a = t.length; r < a; r++)
					(i = t[r]).style && (n = i.style.display, e ? ("none" === n && (o[r] = Ft.get(i, "display") || null, o[r] || (i.style.display = "")), "" === i.style.display && Ht(i) && (o[r] = m(i))) : "none" !== n && (o[r] = "none", Ft.set(i, "display", n)));
				for (r = 0; r < a; r++)
			...
			function x(t, e, n, i, o) {
				for (var r, a, s, l, u, c, d = e.createDocumentFragment(), h = [], f = 0, p = t.length; f < p; f++)
					if ((r = t[f]) || 0 === r)
						if ("object" === gt.type(r))
							gt.merge(h, r.nodeType ? [r] : r);
						else if (Qt.test(r)) {
							for (a = a || d.appendChild(e.createElement("div")), s = (Ut.exec(r) || ["", ""])[1].toLowerCase(), l = Gt[s] || Gt._default, a.innerHTML = l[1] + gt.htmlPrefilter(r) + l[2], c = l[0]; c--; )
								a = a.lastChild;
							gt.merge(h, a.childNodes),
							(a = d.firstChild).textContent = ""
						} else
							h.push(e.createTextNode(r));
				for (d.textContent = "", f = 0; r = h[f++]; )
					if (i && gt.inArray(r, i) > -1)
						o && o.push(r);
					else if (u = gt.contains(r.ownerDocument, r), a = y(d.appendChild(r), "script"), u && b(a), n)
						for (c = 0; r = a[c++]; )
			...
			function M(t, e) {
				...
				u;
				if (1 === e.nodeType) {
					if (Ft.hasData(t) && (r = Ft.access(t), a = Ft.set(e, r), u = r.events)) {
						delete a.handle,
						a.events = {};
						for (o in u)
							for (n = 0, i = u[o].length; n < i; n++)
								gt.event.add(e, o, u[o][n])
					}
			...
			function E(t, e, i, o) {
				...
				p = e[0],
				g = gt.isFunction(p);
				if (g || h > 1 && "string" == typeof p && !ft.checkClone && ne.test(p))
				...
				if (h && (r = x(e, t[0].ownerDocument, !1, t, o), a = r.firstChild, 1 === r.childNodes.length && (r = a), a || o)) {
					for (l = (s = gt.map(y(r, "script"), T)).length; d < h; d++)
						u = r, d !== f && (u = gt.clone(u, !0, !0), l && gt.merge(s, y(u, "script"))), i.call(t[d], u, d);
					if (l)
						for (c = s[s.length - 1].ownerDocument, gt.map(s, D), d = 0; d < l; d++)
							u = s[d], Yt.test(u.type || "") && !Ft.access(u, "globalEval") && gt.contains(c, u) && (u.src ? gt._evalUrl && gt._evalUrl(u.src) : n(u.textContent.replace(oe, ""), c))
				}
				return t
			}
			function I(t, e, n) {
				for (var i, o = e ? gt.filter(e, t) : t, r = 0; null != (i = o[r]); r++)
					n || 1 !== i.nodeType || gt.cleanData(y(i)), i.parentNode && (n && gt.contains(i.ownerDocument, i) && b(y(i, "script")), i.parentNode.removeChild(i));
				return t
			}
			function O(t, e, n) {
				var i,
				...
				a,
				s = t.style;
				return (n = n || se(t)) && ("" !== (a = n.getPropertyValue(e) || n[e]) || gt.contains(t.ownerDocument, t) || (a = gt.style(t, e)), !ft.pixelMarginRight() && ae.test(a) && re.test(e) && (i = s.width, o = s.minWidth, r = s.maxWidth, s.minWidth = s.maxWidth = s.width = a, a = n.width, s.width = i, s.minWidth = o, s.maxWidth = r)),
				void 0 !== a ? a + "" : a
			}
			function P(t, e) {
				return {
			...
			function L(t, e, n, i, o) {
				...
				for (r = n === (i ? "border" : "content") ? 4 : "width" === e ? 1 : 0; r < 4; r += 2)
					"margin" === n && (a += gt.css(t, n + jt[r], !0, o)), i ? ("content" === n && (a -= gt.css(t, "padding" + jt[r], !0, o)), "margin" !== n && (a -= gt.css(t, "border" + jt[r] + "Width", !0, o))) : (a += gt.css(t, "padding" + jt[r], !0, o), "padding" !== n && (a += gt.css(t, "border" + jt[r] + "Width", !0, o)));
				return a
			}
			function R(t, e, n) {
				var i,
				...
				return ae.test(r) ? r : (i = a && (ft.boxSizingReliable() || r === t.style[e]), "auto" === r && (r = t["offset" + e[0].toUpperCase() + e.slice(1)]), (r = parseFloat(r) || 0) + L(t, e, n || (a ? "border" : "content"), i, o) + "px")
			}
			function z(t, e, n, i, o) {
				return new z.prototype.init(t, e, n, i, o)
			}
			function W() {
				ge && (!1 === nt.hidden && t.requestAnimationFrame ? t.requestAnimationFrame(W) : t.setTimeout(W, gt.fx.interval), gt.fx.tick())
			}
			function j() {
			...
			function V(t, e, n) {
				...
				g = t.nodeType && Ht(t),
				m = Ft.get(t, "fxshow");
				n.queue || (null == (a = gt._queueHooks(t, "fx")).unqueued && (a.unqueued = 0, s = a.empty.fire, a.empty.fire = function () {
						a.unqueued || s()
					}), a.unqueued++, h.always(function () {
						h.always(function () {
							a.unqueued--,
							gt.queue(t, "fx").length || a.empty.fire()
						})
					}));
				for (i in e)
					if (o = e[i], me.test(o)) {
				...
				if ((l = !gt.isEmptyObject(e)) || !gt.isEmptyObject(f)) {
					d && 1 === t.nodeType && (n.overflow = [p.overflow, p.overflowX, p.overflowY], null == (u = m && m.display) && (u = Ft.get(t, "display")), "none" === (c = gt.css(t, "display")) && (u ? c = u : (v([t], !0), u = t.style.display || u, c = gt.css(t, "display"), v([t]))), ("inline" === c || "inline-block" === c && null != u) && "none" === gt.css(t, "float") && (l || (h.done(function () {
									p.display = u
			...
			function q(t, e) {
				...
				a;
				for (n in t)
					if (i = gt.camelCase(n), o = e[i], r = t[n], Array.isArray(r) && (o = r[1], r = t[n] = r[0]), n !== i && (t[i] = r, delete t[n]), (a = gt.cssHooks[i]) && "expand" in a) {
						r = a.expand(r),
						delete t[i];
						for (n in r)
			...
			function U(t, e, n) {
				...
				l = function () {
					if (o)
						return !1;
					for (var e = pe || j(), n = Math.max(0, u.startTime + u.duration - e), i = 1 - (n / u.duration || 0), r = 0, a = u.tweens.length; r < a; r++)
						u.tweens[r].run(i);
					return s.notifyWith(t, [u, i, n]),
					i < 1 && a ? n : (a || s.notifyWith(t, [u, 1, 0]), s.resolveWith(t, [u]), !1)
				},
				u = s.promise({
						elem: t,
						props: gt.extend({}, e),
				...
				for (q(c, u.opts.specialEasing); r < a; r++)
					if (i = U.prefilters[r].call(u, t, c, u.opts))
						return gt.isFunction(i.stop) && (gt._queueHooks(u.elem, u.opts.queue).stop = gt.proxy(i.stop, i)), i;
				return gt.map(c, B, u),
			...
			function Q(t, e, n, i) {
				...
				if (Array.isArray(e))
					gt.each(e, function (e, o) {
						n || De.test(t) ? i(t, o) : Q(t + "[" + ("object" == typeof o && null != o ? e : "") + "]", o, n, i)
					});
			...
			gt.extend = gt.fn.extend = function () {
				...
				for ("boolean" == typeof a && (u = a, a = arguments[s] || {}, s++), "object" == typeof a || gt.isFunction(a) || (a = {}), s === l && (a = this, s--); s < l; s++)
					if (null != (t = arguments[s]))
						for (e in t)
							n = a[e], i = t[e], a !== i && (u && i && (gt.isPlainObject(i) || (o = Array.isArray(i))) ? (o ? (o = !1, r = n && Array.isArray(n) ? n : []) : r = n && gt.isPlainObject(n) ? n : {}, a[e] = gt.extend(u, r, i)) : void 0 !== i && (a[e] = i));
				return a
			},
			gt.extend({
				...
				isPlainObject: function (t) {
					var e,
					n;
					return !(!t || "[object Object]" !== ut.call(t) || (e = it(t)) && ("function" != typeof(n = ct.call(e, "constructor") && e.constructor) || dt.call(n) !== ht))
				},
				...
				makeArray: function (t, e) {
					var n = e || [];
					return null != t && (i(Object(t)) ? gt.merge(n, "string" == typeof t ? [t] : t) : at.call(n, t)),
					n
				},
				...
				proxy: function (t, e) {
					...
					if ("string" == typeof e && (n = t[e], e = t, t = n), gt.isFunction(t))
						return i = ot.call(arguments, 2), o = function () {
							return t.apply(e || this, i.concat(ot.call(arguments)))
						},
					o.guid = t.guid = t.guid || gt.guid++,
					o
				},
				now: Date.now,
				support: ft
			...
			var xt = function (t) {
				function e(t, e, n, i) {
					...
					if (n = n || [], "string" != typeof t || !t || 1 !== p && 9 !== p && 11 !== p)
						return n;
					if (!i && ((e ? e.ownerDocument || e : z) !== I && E(e), e = e || I, P)) {
						if (11 !== p && (l = gt.exec(t)))
							if (o = l[1]) {
								if (9 === p) {
									...
									if (a.id === o)
										return n.push(a), n
								} else if (f && (a = f.getElementById(o)) && L(e, a) && a.id === o)
									return n.push(a), n
							} else {
								if (l[2])
									return X.apply(n, e.getElementsByTagName(t)), n;
								if ((o = l[3]) && x.getElementsByClassName && e.getElementsByClassName)
									return X.apply(n, e.getElementsByClassName(o)), n
							}
						if (x.qsa && !V[t + " "] && (!$ || !$.test(t))) {
							if (1 !== p)
								f = e, h = t;
							else if ("object" !== e.nodeName.toLowerCase()) {
								for ((s = e.getAttribute("id")) ? s = s.replace(bt, xt) : e.setAttribute("id", s = R), r = (c = C(t)).length; r--; )
									c[r] = "#" + s + " " + d(c[r]);
								h = c.join(","),
								f = mt.test(t) && u(e.parentNode) || e
							}
							if (h)
								try {
									return X.apply(n, f.querySelectorAll(h)),
									n
								} catch (t) {}
							finally {
					...
					return e.first ? function (e, n, o) {
					 ...
					 : function (e, n, l) {
						...
						if (l) {
							...
							for (; e = e[i]; )
								if (1 === e.nodeType || a)
									if (d = e[R] || (e[R] = {}), c = d[e.uniqueID] || (d[e.uniqueID] = {}), o && o === e.nodeName.toLowerCase())
										e = e[i] || e;
									else {
										if ((u = c[r]) && u[0] === W && u[1] === s)
											return h[2] = u[2];
										if (c[r] = h, h[2] = t(e, n, l))
											return !0
									}
						return !1
					}
				...
				function m(t, e, n, o, r, a) {
					...
					i(function (i, a, s, l) {
						...
						b = n ? r || (i ? t : m || o) ? [] : a : y;
						if (n && n(y, b, s, l), o)
							for (u = g(b, f), o(u, [], s, l), c = u.length; c--; )
								(d = u[c]) && (b[f[c]] = !(y[f[c]] = d));
						if (i) {
							if (r || t) {
								if (r) {
								...
								for (c = b.length; c--; )
									(d = b[c]) && (u = r ? J(i, d) : h[c]) > -1 && (i[u] = !(a[u] = d))
							}
						} else
							b = g(b === a ? b.splice(m, b.length) : b), r ? r(null, a, b, l) : X.apply(a, b)
					})
				}
				function v(t) {
					for (var e, n, i, o = t.length, r = w.relative[t[0].type], a = r || w.relative[" "], s = r ? 1 : 0, l = h(function (t) {
						...
						if (n = w.relative[t[s].type])
							...
							if ((n = w.filter[t[s].type].apply(null, t[s].matches))[R]) {
								for (i = ++s; i < o && !w.relative[t[i].type]; i++);
								return m(s > 1 && f(c), s > 1 && d(t.slice(0, s - 1).concat({
											value: " " === t[s - 2].type ? "*" : ""
										})).replace(rt, "$1"), n, s < i && v(t.slice(s, i)), i < o && v(t = t.slice(i)), i < o && d(t))
							}
							c.push(n)
						}
					return f(c)
				...
				try {
					X.apply(Y = Z.call(z.childNodes), z.childNodes),
				...
				E = e.setDocument = function (t) {
					...
					return i !== I && 9 === i.nodeType && i.documentElement ? (I = i, O = I.documentElement, P = !k(I), z !== I && (n = I.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", wt, !1) : n.attachEvent && n.attachEvent("onunload", wt)), x.attributes = o(function (t) {
								return t.className = "i",
								!t.getAttribute("className")
							}), x.getElementsByTagName = o(function (t) {
								return t.appendChild(I.createComment("")),
								!t.getElementsByTagName("*").length
							}), x.getElementsByClassName = pt.test(I.getElementsByClassName), x.getById = o(function (t) {
								return O.appendChild(t).id = R,
						...
						if (void 0 !== e.getElementsByClassName && P)
							return e.getElementsByClassName(t)
					}, F = [], $ = [], (x.qsa = pt.test(I.querySelectorAll)) && (o(function (t) {
								O.appendChild(t).innerHTML = "<a id='" + R + "'></a><select id='" + R + "-\r\\' msallowcapture=''><option selected=''></option></select>",
								t.querySelectorAll("[msallowcapture^='']").length && $.push("[*^$]=" + tt + "*(?:''|\"\")"),
								t.querySelectorAll("[selected]").length || $.push("\\[" + tt + "*(?:value|" + K + ")"),
								t.querySelectorAll("[id~=" + R + "-]").length || $.push("~="),
								t.querySelectorAll(":checked").length || $.push(":checked"),
								t.querySelectorAll("a#" + R + "+*").length || $.push(".#.+[+~]")
							}), o(function (t) {
								t.innerHTML = "<a href='' disabled='disabled'></a><select disabled='disabled'><option/></select>";
								var e = I.createElement("input");
								e.setAttribute("type", "hidden"),
								t.appendChild(e).setAttribute("name", "D"),
								t.querySelectorAll("[name=d]").length && $.push("name" + tt + "*[*^$|!~]?="),
								...
								$.push(",.*:")
							})), (x.matchesSelector = pt.test(N = O.matches || O.webkitMatchesSelector || O.mozMatchesSelector || O.oMatchesSelector || O.msMatchesSelector)) && o(function (t) {
							x.disconnectedMatch = N.call(t, "*"),
							N.call(t, "[s!='']:x"),
							F.push("!=", it)
						}), $ = $.length && new RegExp($.join("|")), F = F.length && new RegExp(F.join("|")), e = pt.test(O.compareDocumentPosition), L = e || pt.test(O.contains) ? function (t, e) {
						...
						return n || (n = (t.ownerDocument || t) === (e.ownerDocument || e) ? t.compareDocumentPosition(e) : 1, 1 & n || !x.sortDetached && e.compareDocumentPosition(t) === n ? t === I || t.ownerDocument === z && L(z, t) ? -1 : e === I || e.ownerDocument === z && L(z, e) ? 1 : M ? J(M, t) - J(M, e) : 0 : 4 & n ? -1 : 1)
					}
						 : function (t, e) {
						if (t === e)
							return A = !0, 0;
						...
						l = [e];
						if (!o || !r)
							return t === I ? -1 : e === I ? 1 : o ? -1 : r ? 1 : M ? J(M, t) - J(M, e) : 0;
						if (o === r)
							return a(t, e);
				...
				e.matchesSelector = function (t, n) {
					if ((t.ownerDocument || t) !== I && E(t), n = n.replace(lt, "='$1']"), x.matchesSelector && P && !V[n + " "] && (!F || !F.test(n)) && (!$ || !$.test(n)))
						try {
							var i = N.call(t, n);
				...
				e.contains = function (t, e) {
					return (t.ownerDocument || t) !== I && E(t),
					L(t, e)
				},
				e.attr = function (t, e) {
					(t.ownerDocument || t) !== I && E(t);
					var n = w.attrHandle[e.toLowerCase()],
					i = n && U.call(w.attrHandle, e.toLowerCase()) ? n(t, e, !P) : void 0;
				...
				(w = e.selectors = {
						...
						filter: {
								...
								return 1 === i && 0 === o ? function (t) {
								 ...
								 : function (e, n, l) {
									...
									if (m) {
										...
										} else if (y && (h = e, d = h[R] || (h[R] = {}), c = d[h.uniqueID] || (d[h.uniqueID] = {}), u = c[t] || [], f = u[0] === W && u[1], b = f), !1 === b)
											for (; (h = ++f && h && h[g] || (b = f = 0) || p.pop()) && ((s ? h.nodeName.toLowerCase() !== v : 1 !== h.nodeType) || !++b || (y && (d = h[R] || (h[R] = {}), c = d[h.uniqueID] || (d[h.uniqueID] = {}), c[t] = [W, b]), h !== e)); );
							...
							PSEUDO: function (t, n) {
								...
								return r[R] ? r(n) : r.length > 1 ? (o = [t, t, "", n], w.setFilters.hasOwnProperty(t.toLowerCase()) ? i(function (t, e) {
										for (var i, o = r(t, n), a = o.length; a--; )
											i = J(t, o[a]), t[i] = !(e[i] = o[a])
									}) : function (t) {
									return r(t, 0, o)
								}) : r
							}
				...
				C = e.tokenize = function (t, n) {
					...
					for (s = t, l = [], u = w.preFilter; s; ) {
						i && !(o = at.exec(s)) || (o && (s = s.slice(o[0].length) || s), l.push(r = [])),
						i = !1,
						(o = st.exec(s)) && (i = o.shift(), r.push({
								value: i,
								type: o[0].replace(rt, " ")
							}), s = s.slice(i.length));
						for (a in w.filter)
							!(o = dt[a].exec(s)) || u[a] && !(o = u[a](o)) || (i = o.shift(), r.push({
									value: i,
									type: a,
									matches: o
								}), s = s.slice(i.length));
				...
				S = e.compile = function (t, e) {
					...
					if (!r) {
						for (e || (e = C(t)), n = e.length; n--; )
							r = v(e[n]), r[R] ? i.push(r) : o.push(r);
						(r = V(t, y(o, i))).selector = t
					}
					return r
				},
				T = e.select = function (t, e, n, i) {
					...
					if (n = n || [], 1 === h.length) {
						...
						for (o = dt.needsContext.test(t) ? 0 : r.length; o-- && (a = r[o], !w.relative[s = a.type]); )
							if ((l = w.find[s]) && (i = l(a.matches[0].replace(vt, yt), mt.test(r[0].type) && u(e.parentNode) || e))) {
								if (r.splice(o, 1), !(t = i.length && d(r)))
									return X.apply(n, i), n;
								break
							}
					}
					return (c || S(t, h))(i, e, !P, n, !e || mt.test(t) && u(e.parentNode) || e),
					n
				},
			...
			(t);
			gt.find = xt,
			gt.expr = xt.selectors,
			gt.expr[":"] = gt.expr.pseudos,
			gt.uniqueSort = gt.unique = xt.uniqueSort,
			gt.text = xt.getText,
			gt.isXMLDoc = xt.isXML,
			gt.contains = xt.contains,
			gt.escapeSelector = xt.escape;
			...
			gt.filter = function (t, e, n) {
				var i = e[0];
				return n && (t = ":not(" + t + ")"),
				1 === e.length && 1 === i.nodeType ? gt.find.matchesSelector(i, t) ? [i] : [] : gt.find.matches(t, gt.grep(e, function (t) {
						return 1 === t.nodeType
					}))
			},
			gt.fn.extend({
			...
			(gt.fn.init = function (t, e, n) {
				...
				if (n = n || Tt, "string" == typeof t) {
					...
					if (i[1]) {
						if (e = e instanceof gt ? e[0] : e, gt.merge(this, gt.parseHTML(i[1], e && e.nodeType ? e.ownerDocument || e : nt, !0)), Ct.test(i[1]) && gt.isPlainObject(e))
							for (i in e)
								gt.isFunction(this[i]) ? this[i](e[i]) : this.attr(i, e[i]);
						return this
					}
					return (o = nt.getElementById(i[2])) && (this[0] = o, this.length = 1),
					this
				}
			...
			gt.fn.extend({
					...
					if (!kt.test(t))
						for (; i < o; i++)
							for (n = this[i]; n && n !== e; n = n.parentNode)
								if (n.nodeType < 11 && (a ? a.index(n) > -1 : 1 === n.nodeType && gt.find.matchesSelector(n, t))) {
									r.push(n);
									break
								}
				...
				index: function (t) {
					return t ? "string" == typeof t ? st.call(gt(t), this[0]) : st.call(this, t.jquery ? t[0] : t) : this[0] && this[0].parentNode ? this.first().prevAll().length : -1
				},
				add: function (t, e) {
			...
			gt.each({
				...
				gt.fn[t] = function (n, i) {
					...
					i && "string" == typeof i && (o = gt.filter(i, o)),
					this.length > 1 && (At[t] || gt.uniqueSort(o), Mt.test(t) && o.reverse()),
					this.pushStack(o)
				}
			});
			var Et = /[^\x20\t\r\n\f]+/g;
				...
				c = {
					...
					remove: function () {
						return gt.each(arguments, function (t, e) {
							for (var n; (n = gt.inArray(e, r, n)) > -1; )
								r.splice(n, 1), n <= l && l--
						}),
						this
					},
					...
					fireWith: function (t, n) {
						return o || (n = n || [], n = [t, n.slice ? n.slice() : n], a.push(n), e || u()),
						this
					},
					fire: function () {
			...
			gt.extend({
						...
						function r(e, n, i, o) {
							return function () {
								...
								d = function () {
									...
									d;
									if (!(e < a)) {
										if ((t = i.apply(s, c)) === n.promise())
											throw new TypeError("Thenable self-resolution");
											d = t && ("object" == typeof t || "function" == typeof t) && t.then,
											gt.isFunction(d) ? o ? d.call(t, r(a, n, l, o), r(a, n, u, o)) : (a++, d.call(t, r(a, n, l, o), r(a, n, u, o), r(a, n, l, n.notifyWith))) : (i !== l && (s = void 0, c = [t]), (o || n.resolveWith)(s, c))
										}
									},
									h = o ? d : function () {
										try {
											...
											gt.Deferred.exceptionHook && gt.Deferred.exceptionHook(t, h.stackTrace),
											e + 1 >= a && (i !== u && (s = void 0, c = [t]), n.rejectWith(s, c))
										}
									};
							...
							return gt.Deferred(function (t) {
								n[0][3].add(r(0, t, gt.isFunction(o) ? o : l, t.notifyWith)),
								n[1][3].add(r(0, t, gt.isFunction(e) ? e : l)),
								n[2][3].add(r(0, t, gt.isFunction(i) ? i : u))
							}).promise()
						},
						promise: function (t) {
				...
				when: function (t) {
					...
					if (e <= 1 && (c(t, r.done(a(n)).resolve, r.reject, !e), "pending" === r.state() || gt.isFunction(o[n] && o[n].then)))
						return r.then();
					for (; n--; )
						c(o[n], a(n), r.reject);
					return r.promise()
			...
			gt.extend({
				...
				readyWait: 1,
				ready: function (t) {
					(!0 === t ? --gt.readyWait : gt.isReady) || (gt.isReady = !0, !0 !== t && --gt.readyWait > 0 || Ot.resolveWith(nt, [gt]))
				}
			}),
			gt.ready.then = Ot.then,
			"complete" === nt.readyState || "loading" !== nt.readyState && !nt.documentElement.doScroll ? t.setTimeout(gt.ready) : (nt.addEventListener("DOMContentLoaded", d), t.addEventListener("load", d));
			var Pt = function (t, e, n, i, o, r, a) {
				var s = 0,
				l = t.length,
				u = null == n;
				if ("object" === gt.type(n)) {
					...
					for (s in n)
						Pt(t, e, s, n[s], !0, r, a)
				} else if (void 0 !== i && (o = !0, gt.isFunction(i) || (a = !0), u && (a ? (e.call(t, i), e = null) : (u = e, e = function (t, e, n) {
			...
			h.prototype = {
				...
				remove: function (t, e) {
					...
					if (void 0 !== i) {
						if (void 0 !== e) {
							Array.isArray(e) ? e = e.map(gt.camelCase) : (e = gt.camelCase(e), e = e in i ? [e] : e.match(Et) || []),
							n = e.length;
							for (; n--; )
								delete i[e[n]]
						}
				...
				data: function (t, e) {
					...
					if (void 0 === t) {
						if (this.length && (o = Nt.get(r), 1 === r.nodeType && !Ft.get(r, "hasDataAttrs"))) {
							for (n = a.length; n--; )
								a[n] && 0 === (i = a[n].name).indexOf("data-") && (i = gt.camelCase(i.slice(5)), p(r, i, o[i]));
			...
			gt.extend({
				queue: function (t, e, n) {
					var i;
					if (t)
						return e = (e || "fx") + "queue", i = Ft.get(t, e), n && (!i || Array.isArray(n) ? i = Ft.access(t, e, gt.makeArray(n)) : i.push(n)), i || []
				},
			...
			gt.fn.extend({
				...
				promise: function (t, e) {
					...
					for ("string" != typeof t && (e = t, t = void 0), t = t || "fx"; a--; )
						(n = Ft.get(r[a], t + "queueHooks")) && n.empty && (i++, n.empty.add(s));
					return s(),
					o.promise(e)
				}
			});
			...
			gt.fn.extend({
				...
				toggle: function (t) {
					return "boolean" == typeof t ? t ? this.show() : this.hide() : this.each(function () {
						Ht(this) ? gt(this).show() : gt(this).hide()
					})
				}
			});
			...
			var Qt = /<|&#?\w+;/;
			!function () {
				var t = nt.createDocumentFragment().appendChild(nt.createElement("div")),
			...
			gt.event = {
				...
				add: function (t, e, n, i, o) {
					...
					m = Ft.get(t);
					if (m)
						for (n.handler && (r = n, n = r.handler, o = r.selector), o && gt.find.matchesSelector(Xt, o), n.guid || (n.guid = gt.guid++), (l = m.events) || (l = m.events = {}), (a = m.handle) || (a = m.handle = function (e) {
								return void 0 !== gt && gt.event.triggered !== e.type ? gt.event.dispatch.apply(t, arguments) : void 0
							}), u = (e = (e || "").match(Et) || [""]).length; u--; )
							s = Kt.exec(e[u]) || [], f = g = s[1], p = (s[2] || "").split(".").sort(), f && (d = gt.event.special[f] || {}, f = (o ? d.delegateType : d.bindType) || f, d = gt.event.special[f] || {}, c = gt.extend({
										type: f,
										origType: g,
										data: i,
										handler: n,
										...
										namespace: p.join(".")
									}, r), (h = l[f]) || (h = l[f] = [], h.delegateCount = 0, d.setup && !1 !== d.setup.call(t, i, p, a) || t.addEventListener && t.addEventListener(f, a)), d.add && (d.add.call(t, c), c.handler.guid || (c.handler.guid = n.guid)), o ? h.splice(h.delegateCount++, 0, c) : h.push(c), gt.event.global[f] = !0)
				},
					...
					if (m && (l = m.events)) {
						for (u = (e = (e || "").match(Et) || [""]).length; u--; )
							if (s = Kt.exec(e[u]) || [], f = g = s[1], p = (s[2] || "").split(".").sort(), f) {
								for (d = gt.event.special[f] || {}, h = l[f = (i ? d.delegateType : d.bindType) || f] || [], s = s[2] && new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)"), a = r = h.length; r--; )
								...
								a && !h.length && (d.teardown && !1 !== d.teardown.call(t, p, m.handle) || gt.removeEvent(t, f, m.handle), delete l[f])
							} else
								for (f in l)
				...
				dispatch: function (t) {
					...
					if (s.delegateTarget = this, !c.preDispatch || !1 !== c.preDispatch.call(this, s)) {
						for (a = gt.event.handlers.call(this, s, u), e = 0; (o = a[e++]) && !s.isPropagationStopped(); )
							for (s.currentTarget = o.elem, n = 0; (r = o.handlers[n++]) && !s.isImmediatePropagationStopped(); )
								s.rnamespace && !s.rnamespace.test(r.namespace) || (s.handleObj = r, s.data = r.data, void 0 !== (i = ((gt.event.special[r.origType] || {}).handle || r.handler).apply(o.elem, l)) && !1 === (s.result = i) && (s.preventDefault(), s.stopPropagation()));
					...
					if (l && u.nodeType && !("click" === t.type && t.button >= 1))
						for (; u !== this; u = u.parentNode || this)
							if (1 === u.nodeType && ("click" !== t.type || !0 !== u.disabled)) {
								for (r = [], a = {}, n = 0; n < l; n++)
									i = e[n], o = i.selector + " ", void 0 === a[o] && (a[o] = i.needsContext ? gt(o, this).index(u) > -1 : gt.find(o, this, null, [u]).length), a[o] && r.push(i);
								r.length && s.push({
									elem: u,
									handlers: r
								})
			...
			gt.each({
				...
				gt.event.special[t] = {
					...
					handle: function (t) {
						...
						o = t.relatedTarget,
						r = t.handleObj;
						return o && (o === i || gt.contains(i, o)) || (t.type = r.origType, n = r.handler.apply(this, arguments), t.type = e),
						n
					}
				}
			}),
			gt.fn.extend({
				...
				off: function (t, e, n) {
					...
					if (t && t.preventDefault && t.handleObj)
						return i = t.handleObj, gt(t.delegateTarget).off(i.namespace ? i.origType + "." + i.namespace : i.origType, i.selector, i.handler), this;
					if ("object" == typeof t) {
						for (o in t)
							this.off(o, e, t[o]);
						return this
			...
			gt.extend({
				...
				clone: function (t, e, n) {
					...
					if (!(ft.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || gt.isXMLDoc(t)))
						for (a = y(s), r = y(t), i = 0, o = r.length; i < o; i++)
							A(r[i], a[i]);
					if (e)
						if (n)
							for (r = r || y(t), a = a || y(s), i = 0, o = r.length; i < o; i++)
								M(r[i], a[i]);
						else
							M(t, s);
					return (a = y(s, "script")).length > 0 && b(a, !l && y(t, "script")),
					s
				},
					...
					for (var e, n, i, o = gt.event.special, r = 0; void 0 !== (n = t[r]); r++)
						if ($t(n)) {
							if (e = n[Ft.expando]) {
								if (e.events)
									for (i in e.events)
										o[i] ? gt.event.remove(n, i) : gt.removeEvent(n, i, e.handle);
								n[Ft.expando] = void 0
							}
				...
				html: function (t) {
					return Pt(this, function (t) {
						...
						if (void 0 === t && 1 === e.nodeType)
							return e.innerHTML;
						if ("string" == typeof t && !ee.test(t) && !Gt[(Ut.exec(t) || ["", ""])[1].toLowerCase()]) {
							t = gt.htmlPrefilter(t);
							try {
								for (; n < i; n++)
									1 === (e = this[n] || {}).nodeType && (gt.cleanData(y(e, !1)), e.innerHTML = t);
								e = 0
							} catch (t) {}
						}
			...
			gt.each({
				...
				gt.fn[t] = function (t) {
					for (var n, i = [], o = gt(t), r = o.length - 1, a = 0; a <= r; a++)
						n = a === r ? this : this.clone(!0), gt(o[a])[e](n), at.apply(i, n.get());
			...
			!function () {
				...
				s.style && (s.style.backgroundClip = "content-box", s.cloneNode(!0).style.backgroundClip = "", ft.clearCloneStyle = "content-box" === s.style.backgroundClip, a.style.cssText = "border:0;width:8px;height:0;top:0;left:-9999px;padding:0;margin-top:1px;position:absolute", a.appendChild(s), gt.extend(ft, {
			...
			gt.extend({
				...
				style: function (t, e, n, i) {
					if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
						...
						u = t.style;
						return l || (e = F(s)),
						a = gt.cssHooks[e] || gt.cssHooks[s],
						void 0 === n ? a && "get" in a && void 0 !== (o = a.get(t, !1, i)) ? o : u[e] : ("string" === (r = typeof n) && (o = Wt.exec(n)) && o[1] && (n = g(t, e, o), r = "number"), void(null != n && n === n && ("number" === r && (n += o && o[3] || (gt.cssNumber[s] ? "" : "px")), ft.clearCloneStyle || "" !== n || 0 !== e.indexOf("background") || (u[e] = "inherit"), a && "set" in a && void 0 === (n = a.set(t, n, i)) || (l ? u.setProperty(e, n) : u[e] = n))))
					}
				},
				css: function (t, e, n, i) {
					...
					a,
					s = gt.camelCase(e);
					return ue.test(e) || (e = F(s)),
					(a = gt.cssHooks[e] || gt.cssHooks[s]) && "get" in a && (o = a.get(t, !0, n)),
					void 0 === o && (o = O(t, e, i)),
			...
			gt.each(["height", "width"], function (t, e) {
				gt.cssHooks[e] = {
					get: function (t, n, i) {
						if (n)
							return !le.test(gt.css(t, "display")) || t.getClientRects().length && t.getBoundingClientRect().width ? R(t, e, i) : Bt(t, ce, function () {
								return R(t, e, i)
							})
					},
					set: function (t, n, i) {
						var o,
						r = i && se(t),
						a = i && L(t, e, i, "border-box" === gt.css(t, "boxSizing", !1, r), r);
						return a && (o = Wt.exec(n)) && "px" !== (o[3] || "px") && (t.style[e] = n, n = gt.css(t, e)),
						N(t, n, a)
					}
				}
			}),
			gt.cssHooks.marginLeft = P(ft.reliableMarginLeft, function (t, e) {
					if (e)
						return (parseFloat(O(t, "marginLeft")) || t.getBoundingClientRect().left - Bt(t, {
								marginLeft: 0
							}, function () {
			...
			gt.each({
				...
				re.test(t) || (gt.cssHooks[t + e].set = N)
			}),
			gt.fn.extend({
				css: function (t, e) {
					return Pt(this, function (t, e, n) {
						...
						a = 0;
						if (Array.isArray(e)) {
							for (i = se(t), o = e.length; a < o; a++)
								r[e[a]] = gt.css(t, e[a], !1, i);
							return r
						}
			...
			gt.Animation = gt.extend(U, {
					tweeners: {
						"*": [function (t, e) {
								...
								return g(n.elem, t, Wt.exec(e), n),
								n
							}
						]
					},
					tweener: function (t, e) {
						gt.isFunction(t) ? (e = t, t = ["*"]) : t = t.match(Et);
						for (var n, i = 0, o = t.length; i < o; i++)
							n = t[i], U.tweeners[n] = U.tweeners[n] || [], U.tweeners[n].unshift(e)
					},
					prefilters: [V],
			...
			gt.speed = function (t, e, n) {
				...
				i.old = i.complete,
				i.complete = function () {
					gt.isFunction(i.old) && i.old.call(this),
					i.queue && gt.dequeue(this, i.queue)
				},
				i
			},
			gt.fn.extend({
				...
				finish: function (t) {
					...
					this.each(function () {
						...
						r = gt.timers,
						a = i ? i.length : 0;
						for (n.finish = !0, gt.queue(this, t, []), o && o.stop && o.stop.call(this, !0), e = r.length; e--; )
			...
			gt.fn.delay = function (e, n) {
				return e = gt.fx ? gt.fx.speeds[e] || e : e,
				n = n || "fx",
			...
			function () {
				...
				(t = nt.createElement("input")).value = "t",
				t.type = "radio",
			...
			gt.fn.extend({
				attr: function (t, e) {
					return Pt(this, gt.attr, t, e, arguments.length > 1)
				},
			...
			gt.extend({
				attr: function (t, e, n) {
					...
					r = t.nodeType;
					if (3 !== r && 8 !== r && 2 !== r)
						return void 0 === t.getAttribute ? gt.prop(t, e, n) : (1 === r && gt.isXMLDoc(t) || (o = gt.attrHooks[e.toLowerCase()] || (gt.expr.match.bool.test(e) ? ye : void 0)), void 0 !== n ? null === n ? void gt.removeAttr(t, e) : o && "set" in o && void 0 !== (i = o.set(t, n, e)) ? i : (t.setAttribute(e, n + ""), n) : o && "get" in o && null !== (i = o.get(t, e)) ? i : (i = gt.find.attr(t, e), null == i ? void 0 : i))
				},
				attrHooks: {
					type: {
						set: function (t, e) {
			...
			gt.each(gt.expr.match.bool.source.match(/\w+/g), function (t, e) {
				...
				be[e] = function (t, e, i) {
					...
					r,
					a = e.toLowerCase();
					return i || (r = be[a], be[a] = o, o = null != n(t, e, i) ? a : null, be[a] = r),
					o
				}
			});
			...
			gt.fn.extend({
				prop: function (t, e) {
					return Pt(this, gt.prop, t, e, arguments.length > 1)
				},
			...
			gt.extend({
				prop: function (t, e, n) {
					...
					r = t.nodeType;
					if (3 !== r && 8 !== r && 2 !== r)
						return 1 === r && gt.isXMLDoc(t) || (e = gt.propFix[e] || e, o = gt.propHooks[e]), void 0 !== n ? o && "set" in o && void 0 !== (i = o.set(t, n, e)) ? i : t[e] = n : o && "get" in o && null !== (i = o.get(t, e)) ? i : t[e]
				},
				propHooks: {
					tabIndex: {
						get: function (t) {
		...
		gt.fn.extend({
			addClass: function (t) {
					...
					if ("string" == typeof t && t)
						for (e = t.match(Et) || []; n = this[l++]; )
							if (o = G(n), i = 1 === n.nodeType && " " + Y(o) + " ") {
								for (a = 0; r = e[a++]; )
									i.indexOf(" " + r + " ") < 0 && (i += r + " ");
								o !== (s = Y(i)) && n.setAttribute("class", s)
							}
					return this
				},
				...
				toggleClass: function (t, e) {
					...
					return "boolean" == typeof e && "string" === n ? e ? this.addClass(t) : this.removeClass(t) : gt.isFunction(t) ? this.each(function (n) {
						...
						r;
						if ("string" === n)
							for (i = 0, o = gt(this), r = t.match(Et) || []; e = r[i++]; )
								o.hasClass(e) ? o.removeClass(e) : o.addClass(e);
						else
							void 0 !== t && "boolean" !== n || ((e = G(this)) && Ft.set(this, "__className__", e), this.setAttribute && this.setAttribute("class", e || !1 === t ? "" : Ft.get(this, "__className__") || ""))
					})
				},
				hasClass: function (t) {
					var e,
					...
					i = 0;
					for (e = " " + t + " "; n = this[i++]; )
						if (1 === n.nodeType && (" " + Y(G(n)) + " ").indexOf(e) > -1)
							return !0;
					return !1
				}
			});
			...
			gt.fn.extend({
				val: function (t) {
					...
					return arguments.length ? (i = gt.isFunction(t), this.each(function (n) {
						...
						})) : o ? (e = gt.valHooks[o.type] || gt.valHooks[o.nodeName.toLowerCase()], e && "get" in e && void 0 !== (n = e.get(o, "value")) ? n : (n = o.value, "string" == typeof n ? n.replace(_e, "") : null == n ? "" : n)) : void 0
				}
			}),
			gt.extend({
				valHooks: {
					...
					select: {
						...
						set: function (t, e) {
							for (var n, i, o = t.options, r = gt.makeArray(e), a = o.length; a--; )
								i = o[a], (i.selected = gt.inArray(gt.valHooks.option.get(i), r) > -1) && (n = !0);
			...
			gt.extend(gt.event, {
				trigger: function (e, n, i, o) {
					...
					if (a = s = i = i || nt, 3 !== i.nodeType && 8 !== i.nodeType && !ke.test(f + gt.event.triggered) && (f.indexOf(".") > -1 && (p = f.split("."), f = p.shift(), p.sort()), u = f.indexOf(":") < 0 && "on" + f, e = e[gt.expando] ? e : new gt.Event(f, "object" == typeof e && e), e.isTrigger = o ? 2 : 3, e.namespace = p.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = i), n = null == n ? [e] : gt.makeArray(n, [e]), d = gt.event.special[f] || {}, o || !d.trigger || !1 !== d.trigger.apply(i, n))) {
						if (!o && !d.noBubble && !gt.isWindow(i)) {
							for (l = d.delegateType || f, ke.test(l + f) || (a = a.parentNode); a; a = a.parentNode)
								h.push(a), s = a;
							s === (i.ownerDocument || nt) && h.push(s.defaultView || s.parentWindow || t)
						}
						for (r = 0; (a = h[r++]) && !e.isPropagationStopped(); )
							e.type = r > 1 ? l : d.bindType || f, (c = (Ft.get(a, "events") || {})[e.type] && Ft.get(a, "handle")) && c.apply(a, n), (c = u && a[u]) && c.apply && $t(a) && (e.result = c.apply(a, n), !1 === e.result && e.preventDefault());
						return e.type = f,
						o || e.isDefaultPrevented() || d._default && !1 !== d._default.apply(h.pop(), n) || !$t(i) || u && gt.isFunction(i[f]) && !gt.isWindow(i) && ((s = i[u]) && (i[u] = null), gt.event.triggered = f, i[f](), gt.event.triggered = void 0, s && (i[u] = s)),
						e.result
					}
				},
			...
			gt.fn.extend({
				...
				serializeArray: function () {
					return this.map(function () {
						...
						var t = this.type;
						return this.name && !gt(this).is(":disabled") && Ee.test(this.nodeName) && !Ae.test(t) && (this.checked || !qt.test(t))
					}).map(function (t, e) {
						var n = gt(this).val();
			...
			gt.extend({
				...
				ajax: function (e, n) {
					function i(e, n, i, s) {
						...
						w,
						_ = n;
						c || (c = !0, l && t.clearTimeout(l), o = void 0, a = s || "", k.readyState = e > 0 ? 4 : 0, u = e >= 200 && e < 300 || 304 === e, i && (x = K(p, k, i)), x = tt(p, x, k, u), u ? (p.ifModified && ((w = k.getResponseHeader("Last-Modified")) && (gt.lastModified[r] = w), (w = k.getResponseHeader("etag")) && (gt.etag[r] = w)), 204 === e || "HEAD" === p.type ? _ = "nocontent" : 304 === e ? _ = "notmodified" : (_ = x.state, h = x.data, f = x.error, u = !f)) : (f = _, !e && _ || (_ = "error", e < 0 && (e = 0))), k.status = e, k.statusText = (n || _) + "", u ? v.resolveWith(g, [h, _, k]) : v.rejectWith(g, [k, _, f]), k.statusCode(b), b = void 0, d && m.trigger(u ? "ajaxSuccess" : "ajaxError", [k, p, u ? h : f]), y.fireWith(g, [k, _]), d && (m.trigger("ajaxComplete", [k, p]), --gt.active || gt.event.trigger("ajaxStop")))
					}
					...
					if (v.promise(k), p.url = ((e || p.url || Ce.href) + "").replace(Le, Ce.protocol + "//"), p.type = n.method || n.type || p.method || p.type, p.dataTypes = (p.dataType || "*").toLowerCase().match(Et) || [""], null == p.crossDomain) {
					...
					if (p.data && p.processData && "string" != typeof p.data && (p.data = gt.param(p.data, p.traditional)), Z(Re, p, n, k), c)
						return k;
					(d = gt.event && p.global) && 0 == gt.active++ && gt.event.trigger("ajaxStart"),
					p.type = p.type.toUpperCase(),
					p.hasContent = !Ne.test(p.type),
					r = p.url.replace(Oe, ""),
					p.hasContent ? p.data && p.processData && 0 === (p.contentType || "").indexOf("application/x-www-form-urlencoded") && (p.data = p.data.replace(Ie, "+")) : (f = p.url.slice(r.length), p.data && (r += (Te.test(r) ? "&" : "?") + p.data, delete p.data), !1 === p.cache && (r = r.replace(Pe, "$1"), f = (Te.test(r) ? "&" : "?") + "_=" + Se++ + f), p.url = r + f),
					p.ifModified && (gt.lastModified[r] && k.setRequestHeader("If-Modified-Since", gt.lastModified[r]), gt.etag[r] && k.setRequestHeader("If-None-Match", gt.etag[r])),
					...
					if (p.beforeSend && (!1 === p.beforeSend.call(g, k, p) || c))
						return k.abort();
					if (_ = "abort", y.add(p.complete), k.done(p.success), k.fail(p.error), o = Z(ze, p, n, k)) {
						if (k.readyState = 1, d && m.trigger("ajaxSend", [k, p]), c)
							return k;
			...
			gt.each(["get", "post"], function (t, e) {
				gt[e] = function (t, n, i, o) {
					return gt.isFunction(n) && (o = o || i, i = n, n = void 0),
					gt.ajax(gt.extend({
							url: t,
							type: e,
							dataType: o,
			...
			ft.cors = !!Be && "withCredentials" in Be,
			ft.ajax = Be = !!Be,
			gt.ajaxTransport(function (e) {
				var n,
				i;
				if (ft.cors || Be && !e.crossDomain)
					return {
						send: function (o, r) {
							var a,
							s = e.xhr();
							...
							n = function (t) {
								return function () {
									n && (n = i = s.onload = s.onerror = s.onabort = s.onreadystatechange = null, "abort" === t ? s.abort() : "error" === t ? "number" != typeof s.status ? r(0, "error") : r(s.status, s.statusText) : r(He[s.status] || s.status, s.statusText, "text" !== (s.responseType || "text") || "string" != typeof s.responseText ? {
											binary: s.response
										}
											 : {
											text: s.responseText
			...
			gt.ajaxPrefilter("json jsonp", function (e, n, i) {
				...
				r,
				a,
				s = !1 !== e.jsonp && (qe.test(e.url) ? "url" : "string" == typeof e.data && 0 === (e.contentType || "").indexOf("application/x-www-form-urlencoded") && qe.test(e.data) && "data");
				if (s || "jsonp" === e.dataTypes[0])
					return o = e.jsonpCallback = gt.isFunction(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, s ? e[s] = e[s].replace(qe, "$1" + o) : !1 !== e.jsonp && (e.url += (Te.test(e.url) ? "&" : "?") + e.jsonp + "=" + o), e.converters["script json"] = function () {
						return a || gt.error(o + " was not called"),
						a[0]
					},
				e.dataTypes[0] = "json",
				r = t[o],
			...
			gt.parseHTML = function (t, e, n) {
				...
				o,
				r;
				return e || (ft.createHTMLDocument ? (e = nt.implementation.createHTMLDocument(""), i = e.createElement("base"), i.href = nt.location.href, e.head.appendChild(i)) : e = nt),
				o = Ct.exec(t),
				r = !n && [],
				o ? [e.createElement(o[1])] : (o = x([t], e, r), r && r.length && gt(r).remove(), gt.merge([], o.childNodes))
			},
			gt.fn.load = function (t, e, n) {
				...
				a = this,
				s = t.indexOf(" ");
				return s > -1 && (i = Y(t.slice(s)), t = t.slice(0, s)),
				gt.isFunction(e) ? (n = e, e = void 0) : e && "object" == typeof e && (o = "POST"),
				a.length > 0 && gt.ajax({
					url: t,
					type: o || "GET",
					dataType: "html",
					...
					r = arguments,
					a.html(i ? gt("<div>").append(gt.parseHTML(t)).find(i) : t)
			...
			gt.offset = {
				setOffset: function (t, e, n) {
					...
					r = gt.css(t, "top"),
					l = gt.css(t, "left"),
					("absolute" === u || "fixed" === u) && (r + l).indexOf("auto") > -1 ? (i = c.position(), a = i.top, o = i.left) : (a = parseFloat(r) || 0, o = parseFloat(l) || 0),
					gt.isFunction(e) && (e = e.call(t, n, gt.extend({}, s))),
			...
			gt.each({
				...
				gt.fn[t] = function (i) {
					return Pt(this, function (t, i, o) {
						var r;
						return gt.isWindow(t) ? r = t : 9 === t.nodeType && (r = t.defaultView),
						void 0 === o ? r ? r[e] : t[i] : void(r ? r.scrollTo(n ? r.pageXOffset : o, n ? o : r.pageYOffset) : t[i] = o)
					}, t, i, arguments.length)
				}
			}),
			gt.each(["top", "left"], function (t, e) {
				gt.cssHooks[e] = P(ft.pixelPosition, function (t, n) {
						if (n)
							return n = O(t, e), ae.test(n) ? gt(t).position()[e] + "px" : n
					})
			}),
			gt.each({
				Height: "height",
				...
				gt.each({
					...
					gt.fn[i] = function (o, r) {
						...
						return Pt(this, function (e, n, o) {
							var r;
							return gt.isWindow(e) ? 0 === i.indexOf("outer") ? e["inner" + t] : e.document.documentElement["client" + t] : 9 === e.nodeType ? (r = e.documentElement, Math.max(e.body["scroll" + t], r["scroll" + t], e.body["offset" + t], r["offset" + t], r["client" + t])) : void 0 === o ? gt.css(e, n, s) : gt.style(e, n, o, s)
						}, e, a ? o : void 0, a)
					}
				})
			}),
	...
	n.prototype.slide = function (e, i) {
		...
		if (this.$element.trigger(c), !c.isDefaultPrevented()) {
			...
			return t.support.transition && this.$element.hasClass("slide") ? (r.addClass(e), r[0].offsetWidth, o.addClass(s), r.addClass(s), o.one("bsTransitionEnd", function () {
				...
				}).emulateTransitionEnd(n.TRANSITION_DURATION)) : (o.removeClass("active"), r.addClass("active"), this.sliding = !1, this.$element.trigger(h)),
			a && this.cycle(),
			this
		}
	};
	...
	a.prototype.toggle = function (i) {
		...
		if (!o.is(".disabled, :disabled")) {
			...
			if (n(), !a) {
				...
				if (r.trigger(i = t.Event("show.bs.dropdown", s)), i.isDefaultPrevented())
					return;
...
(this, function (t) {
	!function (t) {
			...
			r = this.each(function () {
					...
					if (e.is("select")) {
						...
						if (r) {
							if (a)
								for (var s in a)
									a.hasOwnProperty(s) && (r.options[s] = a[s])
						} else {
							var l = t.extend({}, u.DEFAULTS, t.fn.selectpicker.defaults || {}, e.data(), a);
							l.template = t.extend({}, u.DEFAULTS.template, t.fn.selectpicker.defaults ? t.fn.selectpicker.defaults.template : {}, e.data().template, a.template),
							e.data("selectpicker", r = new u(this, l))
						}
						"string" == typeof i && (o = r[i]instanceof Function ? r[i].apply(r, n) : r.options[i])
					}
				});
			return void 0 !== o ? o : r
		}
		String.prototype.includes || function () {
			...
			i = function (e) {
				...
				l = s ? Number(s) : 0;
				return l != l && (l = 0),
				!(a + Math.min(Math.max(l, 0), o) > o) && -1 != n.call(i, r, l)
			};
		...
		String.prototype.startsWith || function () {
			...
			n = function (t) {
				...
				if (r + l > i)
					return !1;
				for (var u = -1; ++u < r; )
					if (n.charCodeAt(l + u) != o.charCodeAt(u))
						return !1;
				return !0
			};
		...
		t.fn.triggerNative = function (t) {
			...
			n.dispatchEvent ? ("function" == typeof Event ? e = new Event(t, {
						bubbles: !0
					}) : (e = document.createEvent("Event")).initEvent(t, !0, !1), n.dispatchEvent(e)) : n.fireEvent ? (e = document.createEventObject(), e.eventType = t, n.fireEvent("on" + t, e)) : this.trigger(t)
		},
		t.expr.pseudos.icontains = function (e, n, i) {
			var o = t(e).find("a");
			return (o.data("tokens") || o.text()).toString().toUpperCase().includes(i[3].toUpperCase())
		},
		t.expr.pseudos.ibegins = function (e, n, i) {
			var o = t(e).find("a");
			return (o.data("tokens") || o.text()).toString().toUpperCase().startsWith(i[3].toUpperCase())
		},
		t.expr.pseudos.aicontains = function (e, n, i) {
			var o = t(e).find("a");
			return (o.data("tokens") || o.data("normalizedText") || o.text()).toString().toUpperCase().includes(i[3].toUpperCase())
		},
		t.expr.pseudos.aibegins = function (e, n, i) {
			var o = t(e).find("a");
			return (o.data("tokens") || o.data("normalizedText") || o.text()).toString().toUpperCase().startsWith(i[3].toUpperCase())
		};
		var r = {
			"&amp;": "&",
			"&lt;": "<",
		...
		l = a(r),
		u = function (e, n) {
			i.useDefault || (t.valHooks.select.set = i._set, i.useDefault = !0),
			this.$element = t(e),
		...
		u.prototype = {
			...
			init: function () {
				...
				void 0 !== n && (this.$button.attr("data-id", n), t('label[for="' + n + '"]').click(function (t) {
						t.preventDefault(),
						e.$button.focus()
					})),
				this.checkDisabled(),
			...
			createLi: function () {
				...
				u = function (i, o, r, a) {
					return '<a tabindex="0"' + (void 0 !== o ? ' class="' + o + '"' : "") + (r ? ' style="' + r + '"' : "") + (n.options.liveSearchNormalize ? ' data-normalized-text="' + e(s(t(i).html())) + '"' : "") + (void 0 !== a || null !== a ? ' data-tokens="' + a + '"' : "") + ' role="option">' + i + '<span class="' + n.options.iconBase + " " + n.options.tickIcon + ' check-mark"></span></a>'
				};
				if (this.options.title && !this.multiple && (a--, !this.$element.find(".bs-title-option").length)) {
					...
					void 0 === t(c.options[c.selectedIndex]).attr("selected") && void 0 === this.$element.data("selected") && (r.selected = !0)
				}
				...
				return d.each(function (e) {
					...
					if (a++, !r.hasClass("bs-title-option")) {
						var c,
						h = this.className || "",
						f = s(this.style.cssText),
						p = r.data("content") ? r.data("content") : r.html(),
						g = r.data("tokens") ? r.data("tokens") : null,
						m = void 0 !== r.data("subtext") ? '<small class="text-muted">' + r.data("subtext") + "</small>" : "",
						v = void 0 !== r.data("icon") ? '<span class="' + n.options.iconBase + " " + r.data("icon") + '"></span> ' : "",
						y = r.parent(),
						b = "OPTGROUP" === y[0].tagName,
						x = b && y[0].disabled,
						w = this.disabled || x;
						if ("" !== v && w && (v = "<span>" + v + "</span>"), n.options.hideDisabled && (w && !b || x))
							return c = r.data("prevHiddenIndex"), r.next().data("prevHiddenIndex", void 0 !== c ? c : e), void a--;
						if (r.data("content") || (p = v + '<span class="text">' + p + m + "</span>"), b && !0 !== r.data("divider")) {
							if (n.options.hideDisabled && w) {
								if (void 0 === y.data("allOptionsDisabled")) {
									var _ = y.children();
									y.data("allOptionsDisabled", _.filter(":disabled").length === _.length)
								}
							...
							if (0 === r.index()) {
								...
								C = (y.data("icon") ? '<span class="' + n.options.iconBase + " " + y.data("icon") + '"></span> ' : "") + '<span class="text">' + s(C) + S + "</span>",
								0 !== e && i.length > 0 && (a++, i.push(l("", null, "divider", o + "div"))),
								a++,
								i.push(l(C, null, "dropdown-header" + k, o))
							}
							if (n.options.hideDisabled && w)
								return void a--;
							i.push(l(u(p, "opt " + h + k, f, g), e, "", o))
						} else if (!0 === r.data("divider"))
							i.push(l("", e, "divider"));
						else if (!0 === r.data("hidden"))
							c = r.data("prevHiddenIndex"), r.next().data("prevHiddenIndex", void 0 !== c ? c : e), i.push(l(u(p, h, f, g), e, "hidden is-hidden"));
						else {
							var T = this.previousElementSibling && "OPTGROUP" === this.previousElementSibling.tagName;
							if (!T && n.options.hideDisabled && void 0 !== (c = r.data("prevHiddenIndex"))) {
								var D = d.eq(c)[0].previousElementSibling;
								D && "OPTGROUP" === D.tagName && !D.disabled && (T = !0)
							}
							T && (a++, i.push(l("", null, "divider", o + "div"))),
							i.push(l(u(p, h, f, g), e))
						}
						n.liObj[e] = a
					}
				}),
			...
			render: function (e) {
				...
				var r = o.map(function () {
						if (this.selected) {
							...
							void 0 !== n.attr("title") ? n.attr("title") : n.data("content") && i.options.showContent ? n.data("content").toString() : o + n.html() + e
						}
					}).toArray(),
				...
				if (this.multiple && this.options.selectedTextFormat.indexOf("count") > -1) {
					...
					if (s.length > 1 && r.length > s[1] || 1 == s.length && r.length >= 2) {
						...
						a = ("function" == typeof this.options.countSelectedText ? this.options.countSelectedText(r.length, u) : this.options.countSelectedText).replace("{0}", r.length.toString()).replace("{1}", u.toString())
					}
				}
				void 0 == this.options.title && (this.options.title = this.$element.attr("title")),
				"static" == this.options.selectedTextFormat && (a = this.options.title),
				a || (a = void 0 !== this.options.title ? this.options.title : this.options.noneSelectedText),
				this.$button.attr("title", l(t.trim(a.replace(/<[^>]*>?/g, "")))),
			...
			liHeight: function (e) {
				if (e || !1 !== this.options.size && !this.sizeInfo) {
					...
					if (l.className = "text", n.className = this.$menu[0].parentNode.className + " open", i.className = "dropdown-menu open", o.className = "dropdown-menu inner", r.className = "divider", l.appendChild(document.createTextNode("Inner text")), s.appendChild(l), a.appendChild(s), o.appendChild(a), o.appendChild(r), u && i.appendChild(u), c) {
					...
					k = {
						vert: _.vert + parseInt(x ? x.marginTop : w.css("marginTop")) + parseInt(x ? x.marginBottom : w.css("marginBottom")) + 2,
						horiz: _.horiz + parseInt(x ? x.marginLeft : w.css("marginLeft")) + parseInt(x ? x.marginRight : w.css("marginRight")) + 2
					};
			...
			setSize: function () {
				if (this.findLis(), this.liHeight(), this.options.header && this.$menu.css("padding-top", 0), !1 !== this.options.size) {
					...
					C = function () {
						var e,
						n = u.$newElement.offset(),
						i = t(u.options.container);
						u.options.container && !i.is("body") ? (e = i.offset(), e.top += parseInt(i.css("borderTopWidth")), e.left += parseInt(i.css("borderLeftWidth"))) : e = {
							top: 0,
							left: 0
						};
						var o = u.options.windowPadding;
						r = n.top - e.top - h.scrollTop(),
						a = h.height() - r - f - e.top - o[2],
						s = n.left - e.left - h.scrollLeft(),
						l = h.width() - s - p - e.left - o[1],
						r -= o[0],
						s -= o[3]
					};
					if (C(), "auto" === this.options.size) {
						var S = function () {
							...
							e = a - _.vert,
							n = l - _.horiz,
							u.options.container ? (c.data("height") || c.data("height", c.height()), i = c.data("height"), c.data("width") || c.data("width", c.width()), o = c.data("width")) : (i = c.height(), o = c.width()),
							u.options.dropupAuto && u.$newElement.toggleClass("dropup", r > a && e - _.vert < i),
							u.$newElement.hasClass("dropup") && (e = r - _.vert),
							"auto" === u.options.dropdownAlignRight && c.toggleClass("dropdown-menu-right", s > l && n - _.horiz < o - p),
							h = k.length + S.length > 3 ? 3 * g + _.vert - 2 : 0,
							c.css({
								"max-height": e + "px",
								overflow: "hidden",
						...
						h.off("resize.getSize scroll.getSize").on("resize.getSize scroll.getSize", S)
						...
						e = g * this.options.size + D * x + w.vert,
						u.options.container ? (c.data("height") || c.data("height", c.height()), i = c.data("height")) : i = c.height(),
						u.options.dropupAuto && this.$newElement.toggleClass("dropup", r > a && e - _.vert < i),
						c.css({
			...
			selectPosition: function () {
				...
				a = function (t) {
					...
					r.is("body") ? n = {
					 ...
					 : (n = r.offset(), n.top += parseInt(r.css("borderTopWidth")) - r.scrollTop(), n.left += parseInt(r.css("borderLeftWidth")) - r.scrollLeft()),
				...
				this.$button.on("click", function () {
					var e = t(this);
					o.isDisabled() || (a(o.$newElement), o.$bsContainer.appendTo(o.options.container).toggleClass("open", !e.hasClass("open")).append(o.$menu))
				}),
			...
			setSelected: function (t, e, n) {
				n || (this.togglePlaceholder(), n = this.findLis().eq(this.liObj[t])),
			...
			clickListener: function () {
				...
				this.$menuInner.on("click", "li a", function (n) {
					...
					l = !0;
					if (e.multiple && 1 !== e.options.maxOptions && n.stopPropagation(), n.preventDefault(), !e.isDisabled() && !i.parent().hasClass("disabled")) {
						...
						if (e.multiple) {
							if (c.prop("selected", !d), e.setSelected(r, !d), i.blur(), !1 !== f || !1 !== p) {
								var g = f < u.filter(":selected").length,
								m = p < h.find("option:selected").length;
								if (f && g || p && m)
									if (f && 1 == f)
										u.prop("selected", !1), c.prop("selected", !0), e.$menuInner.find(".selected").removeClass("selected"), e.setSelected(r, !0);
									else if (p && 1 == p) {
										...
										b[2] && (x = x.replace("{var}", b[2][f > 1 ? 0 : 1]), w = w.replace("{var}", b[2][p > 1 ? 0 : 1])),
										c.prop("selected", !1),
										e.$menu.append(_),
										f && g && (_.append(t("<div>" + x + "</div>")), l = !1, e.$element.trigger("maxReached.bs.select")),
										p && m && (_.append(t("<div>" + w + "</div>")), l = !1, e.$element.trigger("maxReachedGrp.bs.select")),
										setTimeout(function () {
											e.setSelected(r, !1)
										}, 10),
							...
							u.prop("selected", !1), c.prop("selected", !0), e.$menuInner.find(".selected").removeClass("selected").find("a").attr("aria-selected", !1), e.setSelected(r, !0);
						!e.multiple || e.multiple && 1 === e.options.maxOptions ? e.$button.focus() : e.options.liveSearch && e.$searchbox.focus(),
						l && (a != e.$element.val() && e.multiple || s != e.$element.prop("selectedIndex") && !e.multiple) && (o = [r, c.prop("selected"), d], e.$element.triggerNative("change"))
					}
				}),
				...
				this.$element.change(function () {
					e.render(!1),
					e.$element.trigger("changed.bs.select", o),
					o = null
				})
			},
			liveSearchListener: function () {
				...
				this.$searchbox.on("input propertychange", function () {
					if (n.$lis.not(".is-hidden").removeClass("hidden"), n.$lis.filter(".active").removeClass("active"), i.remove(), n.$searchbox.val()) {
						var o,
						r = n.$lis.not(".is-hidden, .divider, .dropdown-header");
						if ((o = n.options.liveSearchNormalize ? r.not(":a" + n._searchStyle() + '("' + e(n.$searchbox.val()) + '")') : r.not(":" + n._searchStyle() + '("' + n.$searchbox.val() + '")')).length === r.length)
							i.html(n.options.noneResultsText.replace("{0}", '"' + s(n.$searchbox.val()) + '"')), n.$menuInner.append(i), n.$lis.addClass("hidden");
						else {
							o.addClass("hidden");
							var a,
							l = n.$lis.not(".hidden");
							l.each(function (e) {
								var n = t(this);
								n.hasClass("divider") ? void 0 === a ? n.addClass("hidden") : (a && a.addClass("hidden"), a = n) : n.hasClass("dropdown-header") && l.eq(e + 1).data("optgroup") !== n.data("optgroup") ? n.addClass("hidden") : a = null
							}),
							a && a.addClass("hidden"),
			...
			keydown: function (e) {
				...
				r,
				a = t(this),
				s = (a.is("input") ? a.parent().parent() : a.parent()).data("this"),
				...
				if (!(r = s.$newElement.hasClass("open")) && (e.keyCode >= 48 && e.keyCode <= 57 || e.keyCode >= 96 && e.keyCode <= 105 || e.keyCode >= 65 && e.keyCode <= 90))
					return s.options.container ? s.$button.trigger("click") : (s.setSize(), s.$menu.parent().addClass("open"), r = !0), void s.$searchbox.focus();
				if (s.options.liveSearch && /(^9$|27)/.test(e.keyCode.toString(10)) && r && (e.preventDefault(), e.stopPropagation(), s.$menuInner.click(), s.$button.focus()), /(38|40)/.test(e.keyCode.toString(10))) {
					if (!(n = s.$lis.filter(l)).length)
						return;
					i = s.options.liveSearch ? n.index(n.filter(".active")) : n.index(n.find("a").filter(":focus").parent()),
					o = s.$menuInner.data("prevIndex"),
					38 == e.keyCode ? (!s.options.liveSearch && i != o || -1 == i || i--, i < 0 && (i += n.length)) : 40 == e.keyCode && ((s.options.liveSearch || i == o) && i++, i %= n.length),
					s.$menuInner.data("prevIndex", i),
					s.options.liveSearch ? (e.preventDefault(), a.hasClass("dropdown-toggle") || (n.removeClass("active").eq(i).addClass("active").children("a").focus(), a.focus())) : n.eq(i).children("a").focus()
				} else if (!a.is("input")) {
					var c,
					d = [];
					(n = s.$lis.filter(l)).each(function (n) {
						t.trim(t(this).children("a").text().toLowerCase()).substring(0, 1) == u[e.keyCode] && d.push(n)
					}),
					c = t(document).data("keycount"),
					c++,
					t(document).data("keycount", c),
					t.trim(t(":focus").text().toLowerCase()).substring(0, 1) != u[e.keyCode] ? (c = 1, t(document).data("keycount", c)) : c >= d.length && (t(document).data("keycount", 0), c > d.length && (c = 1)),
					n.eq(d[c - 1]).children("a").focus()
				}
				if ((/(13|32)/.test(e.keyCode.toString(10)) || /(^9$)/.test(e.keyCode.toString(10)) && s.options.selectOnTab) && r) {
					if (/(32)/.test(e.keyCode.toString(10)) || e.preventDefault(), s.options.liveSearch)
						 / (32) / .test(e.keyCode.toString(10)) || (s.$menuInner.find(".active a").click(), a.focus());
					else {
						var h = t(":focus");
						h.click(),
						h.focus(),
		...
		t.fn.selectpicker.noConflict = function () {
			return t.fn.selectpicker = c,
			this
		},
		t(document).data("keycount", 0).on("keydown.bs.select", '.bootstrap-select [data-toggle=dropdown], .bootstrap-select [role="listbox"], .bs-searchbox input', u.prototype.keydown).on("focusin.modal", '.bootstrap-select [data-toggle=dropdown], .bootstrap-select [role="listbox"], .bs-searchbox input', function (t) {
			t.stopPropagation()
		}),
	...
	if (t.document) {
		var e = t.document;
		e.querySelectorAll || (e.querySelectorAll = function (n) {
			var i,
			o = e.createElement("style"),
			r = [];
			for (e.documentElement.firstChild.appendChild(o), e._qsa = [], o.styleSheet.cssText = n + "{x-qsa:expression(document._qsa && document._qsa.push(this))}", t.scrollBy(0, 0), o.parentNode.removeChild(o); e._qsa.length; )
				(i = e._qsa.shift()).style.removeAttribute("x-qsa"), r.push(i);
			return e._qsa = null,
			r
		}),
		...
		function (t) {
			...
			t.atob = t.atob || function (t) {
				...
				r = 0,
				a = 0;
				if ((t = (t = String(t)).replace(/\s/g, "")).length % 4 == 0 && (t = t.replace(/=+$/, "")), t.length % 4 == 1)
					throw Error("InvalidCharacterError");
				if (/[^+\/0-9A-Za-z]/.test(t))
					throw Error("InvalidCharacterError");
				for (; i < t.length; )
					n = e.indexOf(t.charAt(i)), r = r << 6 | n, 24 === (a += 6) && (o.push(String.fromCharCode(r >> 16 & 255)), o.push(String.fromCharCode(r >> 8 & 255)), o.push(String.fromCharCode(255 & r)), a = 0, r = 0), i += 1;
				return 12 === a ? (r >>= 4, o.push(String.fromCharCode(255 & r))) : 18 === a && (r >>= 2, o.push(String.fromCharCode(r >> 8 & 255)), o.push(String.fromCharCode(255 & r))),
				o.join("")
			},
			t.btoa = t.btoa || function (t) {
				...
				if (/[^\x00-\xFF]/.test(t))
					throw Error("InvalidCharacterError");
				for (; u < t.length; )
					n = t.charCodeAt(u++), i = t.charCodeAt(u++), o = t.charCodeAt(u++), r = n >> 2, a = (3 & n) << 4 | i >> 4, s = (15 & i) << 2 | o >> 6, l = 63 & o, u === t.length + 2 ? (s = 64, l = 64) : u === t.length + 1 && (l = 64), c.push(e.charAt(r), e.charAt(a), e.charAt(s), e.charAt(l));
				return c.join("")
			}
		}
		(t),
...
(this, function () {
	...
	([function (t, e, n) {
				...
				(function (e) {
					function i(t, e, n, i) {
						var a = o(n.substr(n.lastIndexOf(t.domain)), t);
						a && r({
							mode: null,
							el: i,
							flags: a,
					...
					function o(t, e) {
						var n = {
							theme: S(A.settings.themes.gray, null),
							stylesheets: e.stylesheets,
							instanceOptions: e
						},
						i = t.indexOf("?"),
						o = [t];
						-1 !== i && (o = [t.slice(0, i), t.slice(i + 1)]);
						var r = o[0].split("/");
						n.holderURL = t;
						var a = r[1],
						s = a.match(/([\d]+p?)x([\d]+p?)/);
						...
						if (n.fluid = -1 !== a.indexOf("p"), n.dimensions = {
							...
							if (n.auto = y.truthy(l.auto), l.bg && (n.theme.bg = y.parseColor(l.bg)), l.fg && (n.theme.fg = y.parseColor(l.fg)), l.bg && !l.fg && (n.autoFg = !0), l.theme && n.instanceOptions.themes.hasOwnProperty(l.theme) && (n.theme = S(n.instanceOptions.themes[l.theme], null)), l.text && (n.text = l.text), l.textmode && (n.textmode = l.textmode), l.size && (n.size = l.size), l.font && (n.font = l.font), l.align && (n.align = l.align), l.lineWrap && (n.lineWrap = l.lineWrap), n.nowrap = y.truthy(l.nowrap), n.outline = y.truthy(l.outline), y.truthy(l.random)) {
								A.vars.cache.themeKeys = A.vars.cache.themeKeys || Object.keys(n.instanceOptions.themes);
								var d = A.vars.cache.themeKeys[0 | Math.random() * A.vars.cache.themeKeys.length];
								n.theme = S(n.instanceOptions.themes[d], null)
							}
						}
						return n
					}
					function r(t) {
						...
						e = null == e ? i.fluid ? "fluid" : "image" : e;
						var d = /holder_([a-z]+)/g;
						if (null != i.text && (s.text = i.text, "object" === n.nodeName.toLowerCase())) {
							for (var h = s.text.split("\\n"), f = 0; f < h.length; f++)
								h[f] = y.encodeHtmlEntity(h[f]);
							s.text = h.join("\\n")
						}
						if (s.text) {
							var p = s.text.match(d);
							null !== p && p.forEach(function (t) {
								"holder_dimensions" === t && (s.text = s.text.replace(t, l))
							})
						}
						var g = i.holderURL,
						m = S(o, null);
						if (i.font && (s.font = i.font, !m.noFontFallback && "img" === n.nodeName.toLowerCase() && A.setup.supportsCanvas && "svg" === m.renderer && (m = S(m, {
											renderer: "canvas"
										}))), i.font && "canvas" == m.renderer && (m.reRender = !0), "background" == e)
					...
					function a(t) {
						...
						"background" == o ? (r.style.backgroundImage = "url(" + i + ")", l.noBackgroundSize || (r.style.backgroundSize = u.width + "px " + u.height + "px")) : ("img" === r.nodeName.toLowerCase() ? x.setAttr(r, {
								src: i
							}) : "object" === r.nodeName.toLowerCase() && x.setAttr(r, {
								data: i,
								type: "image/svg+xml"
								...
								if (null == t)
									throw "Holder: couldn't render placeholder";
								"img" === r.nodeName.toLowerCase() ? x.setAttr(r, {
									src: t
								}) : "object" === r.nodeName.toLowerCase() && x.setAttr(r, {
									data: t,
									type: "image/svg+xml"
					...
					function s(t) {
						function e(t, e, n, i) {
							e.width = n,
							e.height = i,
							t.width = Math.max(t.width, e.width),
							t.height += e.height
						}
						var n = A.defaults.size;
						switch (parseFloat(t.theme.size) ? n = t.theme.size : parseFloat(t.flags.size) && (n = t.flags.size), t.font = {
								family: t.theme.font ? t.theme.font : "Arial, Helvetica, Open Sans, sans-serif",
								size: l(t.width, t.height, n, A.defaults.scale),
								units: t.theme.units ? t.theme.units : A.defaults.units,
						...
						if (m.lineCount > 1) {
							...
							k = 0,
							C = 0;
							b = new s.Group("line" + C),
							"left" !== t.align && "right" !== t.align || (r = t.width * (1 - 2 * (1 - i)));
							for (var S = 0; S < m.words.length; S++) {
								var T = m.words[S];
								y = new s.Text(T.text);
								var D = "\\n" == T.text;
								!t.noWrap && (_ + T.width >= r || !0 === D) && (e(g, b, _, g.properties.leading), g.add(b), _ = 0, k += g.properties.leading, C += 1, b = new s.Group("line" + C), b.y = k),
								!0 !== D && (y.moveTo(_, 0), _ += m.spaceWidth + T.width, b.add(y))
							}
							if (e(g, b, _, g.properties.leading), g.add(b), "left" === t.align)
								g.moveTo(t.width - o, null, null);
							else if ("right" === t.align) {
								for (x in g.children)
									(b = g.children[x]).moveTo(t.width - b.width, null, null);
								g.moveTo(0 - (t.width - o), null, null)
							} else {
								for (x in g.children)
									(b = g.children[x]).moveTo((g.width - b.width) / 2, null, null);
								g.moveTo((t.width - g.width) / 2, null, null)
							}
							g.moveTo(null, (t.height - g.height) / 2, null),
							(t.height - g.height) / 2 < 0 && g.moveTo(null, 0, null)
						} else
							y = new s.Text(t.text), (b = new s.Group("line0")).add(y), g.add(b), "left" === t.align ? g.moveTo(t.width - o, null, null) : "right" === t.align ? g.moveTo(0 - (t.width - o), null, null) : g.moveTo((t.width - m.boundingBox.width) / 2, null, null), g.moveTo(null, (t.height - m.boundingBox.height) / 2, null);
						return a
					}
					function l(t, e, n, i) {
						var o = parseInt(t, 10),
					...
					function u(t) {
						for (var e, n = 0, i = (e = null == t || null == t.nodeType ? A.vars.resizableImages : [t]).length; n < i; n++) {
							var o = e[n];
							if (o.holderData) {
								var r = o.holderData.flags,
								s = T(o);
								if (s) {
									if (!o.holderData.resizeUpdate)
										continue;
									if (r.fluid && r.auto) {
									...
									var u = {
										...
										el: o,
										engineSettings: o.holderData.engineSettings
									};
									"exact" == r.textmode && (r.exactDimensions = s, u.holderSettings.dimensions = r.dimensions),
									a(u)
								} else
									h(o)
							}
					...
					function c(t) {
						if (t.holderData) {
							...
							if (e) {
								...
								i.fluidWidth && !i.fluidHeight ? (i.mode = "width", i.ratio = i.initialDimensions.width / parseFloat(n.dimensions.height)) : !i.fluidWidth && i.fluidHeight && (i.mode = "height", i.ratio = parseFloat(n.dimensions.width) / i.initialDimensions.height),
								t.holderData.fluidConfig = i
							} else
								h(t)
						}
					}
					function d() {
						var t,
						n = [];
						Object.keys(A.vars.invisibleImages).forEach(function (e) {
							t = A.vars.invisibleImages[e],
							T(t) && "img" == t.nodeName.toLowerCase() && (n.push(t), delete A.vars.invisibleImages[e])
						}),
						n.length && M.run({
							images: n
						}),
					...
					function h(t) {
						t.holderData.invisibleId || (A.vars.invisibleId += 1, A.vars.invisibleImages["i" + A.vars.invisibleId] = t, t.holderData.invisibleId = A.vars.invisibleId)
					}
					function f(t) {
						A.vars.debounceTimer || t.call(this),
						A.vars.debounceTimer && e.clearTimeout(A.vars.debounceTimer),
						A.vars.debounceTimer = e.setTimeout(function () {
					...
					M = {
						...
						addTheme: function (t, e) {
							return null != t && null != e && (A.settings.themes[t] = e),
						...
						setResizeUpdate: function (t, e) {
							t.holderData && (t.holderData.resizeUpdate = !!e, t.holderData.resizeUpdate && u(t))
						},
						run: function (t) {
							t = t || {};
							var n = {},
							a = S(A.settings, t);
							A.vars.preempted = !0,
							A.vars.dataAttr = a.dataAttr || A.setup.dataAttr,
							n.renderer = a.renderer ? a.renderer : A.setup.renderer,
							-1 === A.setup.renderers.join(",").indexOf(n.renderer) && (n.renderer = A.setup.supportsSVG ? "svg" : A.setup.supportsCanvas ? "canvas" : "html");
							...
							u.forEach(function (t) {
								if (t.attributes.rel && t.attributes.href && "stylesheet" == t.attributes.rel.value) {
									...
									i = x.newEl("a");
									i.href = e;
									var o = i.protocol + "//" + i.host + i.pathname + i.search;
									n.stylesheets.push(o)
								}
							}),
							l.forEach(function (t) {
								if (e.getComputedStyle) {
									var i = e.getComputedStyle(t, null).getPropertyValue("background-image"),
									s = t.getAttribute("data-background-src") || i,
									l = null,
									u = a.domain + "/",
									c = s.indexOf(u);
									if (0 === c)
										...
										if (null !== d)
											l = d[1];
										else if (0 === s.indexOf("url("))
											throw "Holder: unable to parse background URL: " + s
									}
									if (l) {
										var h = o(l, a);
										h && r({
							...
							c.forEach(function (t) {
								var e = {};
								try {
									e.data = t.getAttribute("data"),
									e.dataSrc = t.getAttribute(A.vars.dataAttr)
								} catch (t) {}
								var o = null != e.data && 0 === e.data.indexOf(a.domain),
								r = null != e.dataSrc && 0 === e.dataSrc.indexOf(a.domain);
								o ? i(a, n, e.data, t) : r && i(a, n, e.dataSrc, t)
							}),
							s.forEach(function (t) {
								...
								o ? 0 === e.src.indexOf(a.domain) ? i(a, n, e.src, t) : r && (s ? i(a, n, e.dataSrc, t) : function (t, e, n, o, r) {
									y.imageExists(t, function (t) {
										t || i(e, n, o, r)
									})
								}
									(e.src, a, n, e.dataSrc, t)) : r && i(a, n, e.dataSrc, t)
							}),
							this
						}
					},
					...
					E = function () {
						...
						return function (i) {
							...
							if (A.setup.supportsSVG) {
								var r = !1;
								null != t && t.parentNode === document.body || (r = !0),
								(t = b.initSVG(t, o.properties.width, o.properties.height)).style.display = "block",
								r && (e = x.newEl("text", D), n = function (t) {
									return document.createTextNode(t)
								}
									(null), x.setAttr(e, {
										x: 0
									}), e.appendChild(n), t.appendChild(e), document.body.appendChild(t), t.style.visibility = "hidden", t.style.position = "absolute", t.style.top = "-100%", t.style.left = "-100%");
								...
								if (l > 1) {
									...
									for (var g = 0; g < u.length; g++)
										if (0 !== u[g].length) {
											n.nodeValue = y.decodeHtmlEntity(u[g]);
											var m = e.getBBox();
											p.push({
												text: u[g],
												width: m.width
					...
					();
					for (var I in A.flags)
						A.flags.hasOwnProperty(I) && (A.flags[I].match = function (t) {
					...
					function () {
						...
						t.getContext && -1 != t.toDataURL("image/png").indexOf("data:image/png") && (A.setup.renderer = "canvas", A.setup.supportsCanvas = !0),
						document.createElementNS && document.createElementNS(D, "svg").createSVGRect && (A.setup.renderer = "svg", A.setup.supportsSVG = !0)
					}
					(),
					function () {
						A.vars.visibilityCheckStarted || (e.requestAnimationFrame(d), A.vars.visibilityCheckStarted = !0)
					}
					(),
					g && g(function () {
						A.vars.preempted || M.run(),
						e.addEventListener ? (e.addEventListener("resize", p, !1), e.addEventListener("orientationchange", p, !1)) : e.attachEvent("onresize", p),
						"object" == typeof e.Turbolinks && e.document.addEventListener("page:change", function () {
							M.run()
						})
					}),
					t.exports = M
				...
				t.exports = "undefined" != typeof window && function (t) {
					...
					function n(t) {
						(b || t.type === l || a[h] === d) && (i(), e())
					}
					function i() {
						b ? (a[y](m, n, u), t[y](l, n, u)) : (a[p](v, n), t[p](c, n))
					}
					function o(t, e) {
				...
				e.parse = function (t) {
					...
					for (var e = {}, n = t.split("&"), i = 0; i < n.length; i++) {
						...
						h = o(d[0]);
						if (a = s.exec(h))
							e[a[1]] = e[a[1]] || [], e[a[1]][a[2]] = o(d[1]);
						else if (a = l.test(h)) {
							for (a = h.split("."), u = e; a.length; )
								if ((c = a.shift()).length) {
									if (u[c]) {
										if (u[c] && "object" != typeof u[c])
											break
									} else
										u[c] = {};
									a.length || (u[c] = o(d[1])),
				...
				var n = function (t) {
					...
					i.prototype.add = function (t) {
						var e = t.name;
						if (void 0 !== this.children[e])
							throw "SceneGraph: child already exists: " + e;
						this.children[e] = t,
						t.parent = this
					};
					var o = function () {
					...
					o.prototype = new i;
					var r = function (t, n) {
						if (i.call(this, t), this.properties = {
								fill: "#000000"
							}, void 0 !== n)
							e(this.properties, n);
						else if (void 0 !== t && "string" != typeof t)
				...
				(function (t) {
					...
					e.encodeHtmlEntity = function (t) {
						for (var e = [], n = 0, i = t.length - 1; i >= 0; i--)
							n = t.charCodeAt(i), n > 128 ? e.unshift(["&#", n, ";"].join("")) : e.unshift(t[i]);
						return e.join("")
					},
					...
					e.parseColor = function (t) {
						...
						i = /^rgb\((\d{1,3})\s*,\s*(\d{1,3})\s*,\s*(\d{1,3})\s*\)$/,
						o = /^rgba\((\d{1,3})\s*,\s*(\d{1,3})\s*,\s*(\d{1,3})\s*,\s*(0\.\d{1,}|1)\)$/,
						r = t.match(n);
						return null !== r ? (e = r[1] || r[2], "#" !== e[0] ? "#" + e : e) : (r = t.match(i), null !== r ? e = "rgb(" + r.slice(1).join(",") + ")" : (r = t.match(o), null !== r ? e = "rgba(" + r.slice(1).join(",") + ")" : null))
					},
					e.canvasRatio = function () {
						...
						if (t.document) {
							...
							if (i.getContext) {
								...
								n = o.webkitBackingStorePixelRatio || o.mozBackingStorePixelRatio || o.msBackingStorePixelRatio || o.oBackingStorePixelRatio || o.backingStorePixelRatio || 1
							}
						}
						return e / n
					}
				...
				(function (t) {
					...
					e.initSVG = function (t, e, n) {
						var r,
						a,
						s = !1;
						t && t.querySelector ? null === (a = t.querySelector("style")) && (s = !0) : (t = i.newEl("svg", o), s = !0),
						s && (r = i.newEl("defs", o), a = i.newEl("style", o), i.setAttr(a, {
								type: "text/css"
							}), r.appendChild(a), t.appendChild(r)),
						t.webkitMatchesSelector && t.setAttribute("xmlns", o);
						for (var l = 0; l < t.childNodes.length; l++)
							8 === t.childNodes[l].nodeType && t.removeChild(t.childNodes[l]);
					...
					e.svgStringToDataURI = function () {
						return function (e, n) {
							return n ? "data:image/svg+xml;charset=UTF-8;base64," + btoa(t.unescape(encodeURIComponent(e))) : "data:image/svg+xml;charset=UTF-8," + encodeURIComponent(e)
						}
					}
					(),
					e.serializeSVG = function (e, n) {
						if (t.XMLSerializer) {
							var o = new XMLSerializer,
							r = "",
							a = n.stylesheets;
							if (n.svgXMLStylesheet) {
								for (var s = i.createXML(), l = a.length - 1; l >= 0; l--) {
								...
								r = o.serializeToString(s)
							}
							var c = o.serializeToString(e);
							return c = c.replace(/\&amp;(\#[0-9]{2,}\;)/g, "&$1"),
							r + c
						}
					}
				}).call(e, function () {
				...
				(function (t) {
					e.newEl = function (e, n) {
						if (t.document)
							return null == n ? t.document.createElement(e) : t.document.createElementNS(n, e)
					},
					...
					e.getNodeArray = function (e) {
						var n = null;
						return "string" == typeof e ? n = document.querySelectorAll(e) : t.NodeList && e instanceof t.NodeList ? n = e : t.Node && e instanceof t.Node ? n = [e] : t.HTMLCollection && e instanceof t.HTMLCollection ? n = e : e instanceof Array ? n = e : null === e && (n = []),
				...
				n.rgb2hex = function (t, e, n) {
					function i(t) {
						var e = (0 | t).toString(16);
						return t < 16 && (e = "0" + e),
						e
					}
					return [t, e, n].map(i).join("")
				},
				n.hsl2rgb = function (t, e, n) {
					var i = t / 60,
					o = (1 - Math.abs(2 * n - 1)) * e,
					r = o * (1 - Math.abs(parseInt(i) % 2 - 1)),
					a = n - o / 2,
					s = 0,
					l = 0,
					u = 0;
					return i >= 0 && i < 1 ? (s = o, l = r) : i >= 1 && i < 2 ? (s = r, l = o) : i >= 2 && i < 3 ? (l = o, u = r) : i >= 3 && i < 4 ? (l = r, u = o) : i >= 4 && i < 5 ? (s = r, u = o) : i >= 5 && i < 6 && (s = o, u = r),
					s += a,
					l += a,
					u += a,
					s = parseInt(255 * s),
				...
				n.prototype.set = function (t) {
					...
					r =  - .09991 * e - .33609 * n + .436 * i,
					a = .615 * e - .55861 * n - .05639 * i;
					return this.rgb = {
						r: e,
						g: n,
						b: i
				...
				n.prototype.lighten = function (t) {
					...
					i = Math.min(255, Math.max(0, this.rgb.r + e)),
				...
				n.prototype.lighterThan = function (t) {
					return t instanceof n || (t = new n(t)),
					this.yuv.y > t.yuv.y
				},
				n.prototype.blendAlpha = function (t) {
					t instanceof n || (t = new n(t));
					var e = t,
					i = this,
					o = e.alpha * e.rgb.r + (1 - e.alpha) * i.rgb.r,
					r = e.alpha * e.rgb.g + (1 - e.alpha) * i.rgb.g,
					a = e.alpha * e.rgb.b + (1 - e.alpha) * i.rgb.b;
					return new n(n.rgb2hex(o, r, a))
				},
				t.exports = n
			}, function (t, e) {
				t.exports = {
				...
				function r(t, e, n) {
					var i = n / 2;
					return ["M", i, i, "H", t - i, "V", e - i, "H", i, "V", 0, "M", 0, i, "L", t, e - i, "M", 0, e - i, "L", t, i].join(" ")
				}
				var a = n(13),
				s = n(8),
				l = n(11),
				...
				t.exports = function (t, e) {
					var n = e.engineSettings.stylesheets.map(function (t) {
					...
					if (u.children.holderBg.properties.outline) {
						...
						m = d.element({
								tag: "path",
								d: r(u.children.holderBg.width, u.children.holderBg.height, v.width),
								"stroke-width": v.width,
								stroke: v.fill,
								fill: "none"
							})
					}
					var y = i(u.children.holderBg, "rect"),
					b = [];
					b.push(y),
					v && b.push(m),
					b.push(g);
					...
					C = a(k);
					return C = n + C[0],
					s.svgStringToDataURI(C, "background" === e.mode)
				}
			}, function (t, e, n) {
				n(14),
				t.exports = function t(e, n, i) {
					...
					if (i = i || {}, "string" == typeof e[0])
						e[0] = function (t) {
							...
							r = t.match(/\$([\w-]+)/),
							a = t.match(/\.[\w-]+/g);
							return o && (n.attr.id = o[1], i[o[1]] = n),
							r && (i[r[1]] = n),
						...
						if (void 0 !== e[u] && !0 !== e[u])
							if ("string" == typeof e[u])
								c && (e[u] = function (t) {
									...
									(e[u])), e[0].children.push(e[u]);
							else if ("number" == typeof e[u])
								e[0].children.push(e[u]);
							else if (Array.isArray(e[u])) {
								if (Array.isArray(e[u][0])) {
									if (e[u].reverse().forEach(function (t) {
											e.splice(u + 1, 0, t)
										}), 0 !== u)
										continue;
									u++
								...
								t(e[u], n, i),
								e[u][0] && e[0].children.push(e[u][0])
							} else if ("function" == typeof e[u])
								s = e[u];
							else {
								if ("object" != typeof e[u])
									throw new TypeError('"' + e[u] + '" is not allowed as a value.');
								for (a in e[u])
									e[u].hasOwnProperty(a) && null !== e[u][a] && !1 !== e[u][a] && ("style" === a && "object" == typeof e[u][a] ? e[0].attr[a] = JSON.stringify(e[u][a], o).slice(2, -2).replace(/","/g, ";").replace(/":"/g, ":").replace(/\\"/g, "'") : e[0].attr[a] = e[u][a])
							}
					}
					if (!1 !== e[0]) {
						r = "<" + e[0].tag;
						for (l in e[0].attr)
							e[0].attr.hasOwnProperty(l) && (r += " " + l + '="' + function (t) {
				...
				o = n(7);
				t.exports = function () {
					var t = i.newEl("canvas"),
					e = null;
					return function (n) {
						null == e && (e = t.getContext("2d"));
						var i = o.canvasRatio(),
						r = n.root;
						t.width = i * r.properties.width,
						t.height = i * r.properties.height,
						...
						e.fillRect(0, 0, s, l),
						a.properties.outline && (e.strokeStyle = a.properties.outline.fill, e.lineWidth = a.properties.outline.width, e.moveTo(1, 1), e.lineTo(s - 1, 1), e.lineTo(s - 1, l - 1), e.lineTo(1, l - 1), e.lineTo(1, 1), e.moveTo(0, 1), e.lineTo(s, l - 1), e.moveTo(0, l - 1), e.lineTo(s, 1), e.stroke());
						var u = r.children.holderTextGroup;
						e.font = u.properties.font.weight + " " + i * u.properties.font.size + u.properties.font.units + " " + u.properties.font.family + ", monospace",
						e.fillStyle = u.properties.fill;
						for (var c in u.children) {
							var d = u.children[c];
							for (var h in d.children) {
								var f = d.children[h],
								p = i * (u.x + d.x + f.x),
								g = i * (u.y + d.y + f.y + u.properties.leading / 2);
...
(this, "undefined" != typeof Meteor && "undefined" != typeof Package), function (t) {
	t.slidebars = function (e) {
		function n() {
			!u.disableOver || "number" == typeof u.disableOver && u.disableOver >= _ ? (w = !0, t("html").addClass("sb-init"), u.hideControlClasses && k.removeClass("sb-hide"), i()) : "number" == typeof u.disableOver && u.disableOver < _ && (w = !1, t("html").removeClass("sb-init"), u.hideControlClasses && k.addClass("sb-hide"), m.css("minHeight", ""), (y || x) && a())
		}
		function i() {
			m.css("minHeight", "");
			var e = parseInt(m.css("height"), 10);
			parseInt(t("html").css("height"), 10) > e && m.css("minHeight", t("html").css("height")),
			v && v.hasClass("sb-width-custom") && v.css("width", v.attr("data-sb-width")),
			b && b.hasClass("sb-width-custom") && b.css("width", b.attr("data-sb-width")),
			v && (v.hasClass("sb-style-push") || v.hasClass("sb-style-overlay")) && v.css("marginLeft", "-" + v.css("width")),
			b && (b.hasClass("sb-style-push") || b.hasClass("sb-style-overlay")) && b.css("marginRight", "-" + b.css("width")),
			u.scrollLock && t("html").addClass("sb-scroll-lock")
		}
		function o(t, e, n) {
			function o() {
				r.removeAttr("style"),
			...
			var r;
			if (r = t.hasClass("sb-style-push") ? m.add(t).add(C) : t.hasClass("sb-style-overlay") ? t : m.add(C), "translate" === S)
				"0px" === e ? o() : r.css("transform", "translate( " + e + " )");
			else if ("side" === S)
				"0px" === e ? o() : ("-" === e[0] && (e = e.substr(1)), r.css(n, "0px"), setTimeout(function () {
						r.css(n, e)
					}, 1));
			else if ("jQuery" === S) {
				"-" === e[0] && (e = e.substr(1));
				var a = {};
				a[n] = e,
				r.stop().animate(a, 400)
			}
		}
		function r(e) {
			function n() {
				w && "left" === e && v ? (t("html").addClass("sb-active sb-active-left"), v.addClass("sb-active"), o(v, v.css("width"), "left"), setTimeout(function () {
						y = !0
					}, 400)) : w && "right" === e && b && (t("html").addClass("sb-active sb-active-right"), b.addClass("sb-active"), o(b, "-" + b.css("width"), "right"), setTimeout(function () {
						x = !0
					}, 400))
			}
		...
		function a(e, n) {
			(y || x) && (y && (o(v, "0px", "left"), y = !1), x && (o(b, "0px", "right"), x = !1), setTimeout(function () {
					t("html").removeClass("sb-active sb-active-left sb-active-right"),
					v && v.removeClass("sb-active"),
					b && b.removeClass("sb-active"),
					void 0 !== e && (void 0 === typeof n && (n = "_self"), window.open(e, n))
				}, 400))
		}
		function s(t) {
			"left" === t && v && (y ? a() : r("left")),
			"right" === t && b && (x ? a() : r("right"))
		}
		function l(t, e) {
			t.stopPropagation(),
			t.preventDefault(),
			"touchend" === t.type && e.off("click")
		}
		var u = t.extend({
				siteClose: !0,
				scrollLock: !1,
		...
		d = !1,
		h = !1;
		("" === c.MozTransition || "" === c.WebkitTransition || "" === c.OTransition || "" === c.transition) && (d = !0),
		("" === c.MozTransform || "" === c.WebkitTransform || "" === c.OTransform || "" === c.transform) && (h = !0);
		var f = navigator.userAgent,
		p = !1,
		g = !1;
		/Android/.test(f) ? p = f.substr(f.indexOf("Android") + 8, 3) : /(iPhone|iPod|iPad)/.test(f) && (g = f.substr(f.indexOf("OS ") + 3, 3).replace("_", ".")),
		(p && 3 > p || g && 5 > g) && t("html").addClass("sb-static");
		var m = t("#sb-site, .sb-site-container");
		if (t(".sb-left").length)
			var v = t(".sb-left"), y = !1;
		if (t(".sb-right").length)
			var b = t(".sb-right"), x = !1;
		var w = !1,
		_ = t(window).width(),
		...
		t(window).resize(function () {
			...
			_ !== e && (_ = e, n(), y && r("left"), x && r("right"))
		});
		var S;
		d && h ? (S = "translate", p && 4.4 > p && (S = "side")) : S = "jQuery",
		this.slidebars = {
			open: r,
			close: a,
			toggle: s,
			...
			active: function (t) {
				return "left" === t && v ? y : "right" === t && b ? x : void 0
			},
			destroy: function (t) {
				"left" === t && v && (y && a(), setTimeout(function () {
						v.remove(),
						v = !1
					}, 400)),
				"right" === t && b && (x && a(), setTimeout(function () {
						b.remove(),
						b = !1
					}, 400))
			}
		...
		t(".sb-close").on("touchend click", function (e) {
			if (t(this).is("a") || t(this).children().is("a")) {
				if ("click" === e.type) {
					...
					a(n.attr("href"), n.attr("target") ? n.attr("target") : "_self")
				}
			} else
				l(e, t(this)), a()
		}),
		m.on("touchend click", function (e) {
			u.siteClose && (y || x) && (l(e, t(this)), a())
		})
	}
}
(jQuery), function (t) {
...
(function (t) {
	...
	o = function (e) {
		...
		return t(e).each(function () {
			...
			null === a ? o.push(e) : Math.floor(Math.abs(n - r)) <= 1 ? o[o.length - 1] = a.add(e) : o.push(e),
			n = r
		}),
		o
	},
...
var _self = "undefined" != typeof window ? window : "undefined" != typeof WorkerGlobalScope && self instanceof WorkerGlobalScope ? self : {}, Prism = function () {
	...
	n = _self.Prism = {
		...
		languages: {
			...
			DFS: function (t, e, i, o) {
				o = o || {};
				for (var r in t)
					t.hasOwnProperty(r) && (e.call(t, r, t[r], i || r), "Object" !== n.util.type(t[r]) || o[n.util.objId(t[r])] ? "Array" !== n.util.type(t[r]) || o[n.util.objId(t[r])] || (o[n.util.objId(t[r])] = !0, n.languages.DFS(t[r], e, r, o)) : (o[n.util.objId(t[r])] = !0, n.languages.DFS(t[r], e, null, o)))
			}
		},
		plugins: {},
		highlightAll: function (t, e) {
			...
			for (var o, r = i.elements || document.querySelectorAll(i.selector), a = 0; o = r[a++]; )
				n.highlightElement(o, !0 === t, i.callback)
		},
		highlightElement: function (e, i, o) {
			for (var r, a, s = e; s && !t.test(s.className); )
				s = s.parentNode;
			s && (r = (s.className.match(t) || [, ""])[1].toLowerCase(), a = n.languages[r]),
			e.className = e.className.replace(t, "").replace(/\s+/g, " ") + " language-" + r,
			s = e.parentNode,
			/pre/i.test(s.nodeName) && (s.className = s.className.replace(t, "").replace(/\s+/g, " ") + " language-" + r);
			var l = {
				element: e,
				language: r,
				grammar: a,
			...
			if (n.hooks.run("before-sanity-check", l), !l.code || !l.grammar)
				return l.code && (l.element.textContent = l.code), void n.hooks.run("complete", l);
			if (n.hooks.run("before-highlight", l), i && _self.Worker) {
				...
				l.highlightedCode = n.highlight(l.code, l.grammar, l.language), n.hooks.run("before-insert", l), l.element.innerHTML = l.highlightedCode, o && o.call(e), n.hooks.run("after-highlight", l), n.hooks.run("complete", l)
		},
					...
					for (var u = 0; u < l.length; ++u) {
						...
						for (var v = 0, y = 0; v < r.length; y += r[v].length, ++v) {
							...
							if (!(b instanceof o)) {
								...
								w = 1;
								if (!x && f && v != r.length - 1) {
									if (c.lastIndex = y, !(x = c.exec(t)))
										break;
									for (var _ = x.index + (h ? x[1].length : 0), k = x.index + x[0].length, C = v, S = y, T = r.length; C < T && S < k; ++C)
										_ >= (S += r[C].length) && (++v, y = S);
									if (r[v]instanceof o || r[C - 1].greedy)
										continue;
									w = C - v,
									b = t.slice(y, S),
									x.index -= y
								...
								if (x) {
									...
									A = [v, w];
									D && A.push(D);
									var E = new o(s, d ? n.tokenize(x, d) : x, g, x, f);
									A.push(E),
									M && A.push(M),
									Array.prototype.splice.apply(r, A)
								}
							}
						}
					}
	...
	return o && (n.filename = o.src, document.addEventListener && !o.hasAttribute("data-manual") && ("loading" !== document.readyState ? window.requestAnimationFrame ? window.requestAnimationFrame(n.highlightAll) : window.setTimeout(n.highlightAll, 16) : document.addEventListener("DOMContentLoaded", n.highlightAll))),
	_self.Prism
}
();
"undefined" != typeof module && module.exports && (module.exports = Prism), "undefined" != typeof global && (global.Prism = Prism), Prism.languages.markup = {
	...
	function : /[a-z0-9_]+(?=\()/i, number: /\b-?(?:0x[\da-f]+|\d*\.?\d+(?:e[+-]?\d+)?)\b/i, operator: /--?|\+\+?|!=?=?|<=?|>=?|==?=?|&&?|\|\|?|\?|\*|\/|~|\^|%/, punctuation: /[{}[\];(),.:]/
		...
		function : /[_$a-zA-Z\xA0-\uFFFF][_$a-zA-Z0-9\xA0-\uFFFF]*(?=\()/i, operator: /--?|\+\+?|!=?=?|<=?|>=?|==?=?|&&?|\|\|?|\?|\*\*?|\/|~|\^|%|\.{3}/
...
regex: {
	...
	"undefined" != typeof self && self.Prism && self.document && document.querySelector && (self.Prism.fileHighlight = function () {
		...
		Array.prototype.forEach && Array.prototype.slice.call(document.querySelectorAll("pre[data-src]")).forEach(function (e) {
			for (var n, i = e.getAttribute("data-src"), o = e, r = /\blang(?:uage)?-(?!\*)(\w+)\b/i; o && !r.test(o.className); )
				o = o.parentNode;
			if (o && (n = (e.className.match(r) || [, ""])[1]), !n) {
				var a = (i.match(/\.(\w+)$/) || [, ""])[1];
				n = t[a] || a
			}
...
(), function () {
	"undefined" != typeof self && self.Prism && self.document && Prism.hooks.add("complete", function (t) {
		if (t.code) {
			var e = t.element.parentNode,
			n = /\s*\bline-numbers\b\s*/;
			if (e && /pre/i.test(e.nodeName) && (n.test(e.className) || n.test(t.element.className)) && !t.element.querySelector(".line-numbers-rows")) {
...
(), function () {
	...
	e = function () {
		...
		t.prototype.createEvent = function (t, e, n, i) {
			...
			null == n && (n = !1),
			null == i && (i = null),
			null != document.createEvent ? (o = document.createEvent("CustomEvent")).initCustomEvent(t, e, n, i) : null != document.createEventObject ? (o = document.createEventObject(), o.eventType = t) : o.eventName = t,
			o
		},
	...
	this.WOW = function () {
		...
		o.prototype.start = function () {
			...
			this.config.live ? new t(function (t) {
				return function (e) {
					...
					r,
					a;
					for (a = [], n = 0, i = e.length; i > n; n++)
						r = e[n], a.push(function () {
							var t,
							e,
							n,
							i;
		...
		o.prototype.doSync = function (t) {
			...
			if (null == t && (t = this.element), 1 === t.nodeType) {
				for (r = [], n = 0, i = (o = (t = t.parentNode || t).querySelectorAll("." + this.config.boxClass)).length; i > n; n++)
					e = o[n], a.call(this.all, e) < 0 ? (this.boxes.push(e), this.all.push(e), this.stopped || this.disabled() ? this.resetStyle() : this.applyStyle(e, !0), r.push(this.scrolled = !0)) : r.push(void 0);
				return r
			}
		},
		...
		o.prototype.vendorSet = function (t, e) {
			...
			for (n in e)
				o = e[n], t["" + n] = o, i.push(function () {
					...
					a,
					s;
					for (s = [], e = 0, i = (a = this.vendors).length; i > e; e++)
						r = a[e], s.push(t["" + r + n.charAt(0).toUpperCase() + n.substr(1)] = o);
					return s
				}
					.call(this));
			return i
		...
		o.prototype.vendorCSS = function (t, e) {
			...
			s,
			l;
			for (a = (s = i(t)).getPropertyCSSValue(e), n = 0, o = (r = this.vendors).length; o > n; n++)
				l = r[n], a = a || s.getPropertyCSSValue("-" + l + "-" + e);
			return a
		},
...
.call(this), function (t, e) {
	"use strict";
	"object" == typeof module && "object" == typeof module.exports ? module.exports = e(t, document) : "function" == typeof define && define.amd ? define([], function () {
			return e(t, document)
		}) : t.plyr = e(t, document)
}
("undefined" != typeof window ? window : this, function (t, e) {
	...
	function c(t, e) {
		for (var n in e)
			t.setAttribute(n, $.boolean(e[n]) && e[n] ? "" : e[n])
	}
	function d(t, n, i) {
	...
	function f(t, e, n) {
		if (t)
			if (t.classList)
				...
				var i = (" " + t.className + " ").replace(/\s+/g, " ").replace(" " + e + " ", "");
				t.className = i + (n ? " " + e : "")
			}
	}
	function p(t, e) {
	...
	function g(t, n) {
		...
		return (i.matches || i.webkitMatchesSelector || i.mozMatchesSelector || i.msMatchesSelector || function (t) {
	...
	function v(t, e, n, i, o) {
		...
		if ($.boolean(o) || (o = !1), t instanceof NodeList)
			for (var a = 0; a < t.length; a++)
				t[a]instanceof Node && v(t[a], arguments[1], arguments[2], arguments[3]);
		else
			for (var s = 0; s < r.length; s++)
				t[i ? "addEventListener" : "removeEventListener"](r[s], n, o)
	}
	function y(t, e, n, i) {
		t && v(t, e, n, !0, i)
	}
	...
	function x(t, e) {
		if (t)
			return e = $.boolean(e) ? e : !t.getAttribute("aria-pressed"), t.setAttribute("aria-pressed", e), e
	}
	function w(t, e) {
	...
	function _() {
		...
		if (t.length) {
			if (1 === t.length)
				return t[0];
			for (var e = Array.prototype.shift.call(t), n = t.length, i = 0; i < n; i++) {
				var o = t[i];
				for (var r in o)
					o[r] && o[r].constructor && o[r].constructor === Object ? (e[r] = e[r] || {}, _(e[r], o[r])) : e[r] = o[r]
			}
			return e
		}
	}
	...
	function S() {
		...
		if ($.undefined(e.cancelFullScreen))
			for (var i = 0, o = n.length; i < o; i++) {
				if (t.prefix = n[i], !$.undefined(e[t.prefix + "CancelFullScreen"])) {
					t.supportsFullScreen = !0;
					break
				}
				if (!$.undefined(e.msExitFullscreen) && e.msFullscreenEnabled) {
					t.prefix = "ms",
					t.supportsFullScreen = !0;
					break
				}
	...
	function T(v, T) {
		...
		function N(e, n) {
			T.debug && t.console && (n = Array.prototype.slice.call(n), $.string(T.logPrefix) && T.logPrefix.length && n.unshift(T.logPrefix), console[e].apply(console, n))
		}
		function L() {
			return {
				url: T.iconUrl,
				absolute: 0 === T.iconUrl.indexOf("http") || Vt.browser.isIE
			}
		}
		function R() {
			var t = [],
			e = L(),
			n = (e.absolute ? "" : e.url) + "#" + T.iconPrefix;
			return r(T.controls, "play-large") && t.push('<button type="button" data-plyr="play" class="plyr__play-large">', '<svg><use xlink:href="' + n + '-play" /></svg>', '<span class="plyr__sr-only">' + T.i18n.play + "</span>", "</button>"),
			t.push('<div class="plyr__controls">'),
			r(T.controls, "restart") && t.push('<button type="button" data-plyr="restart">', '<svg><use xlink:href="' + n + '-restart" /></svg>', '<span class="plyr__sr-only">' + T.i18n.restart + "</span>", "</button>"),
			...
			r(T.controls, "play") && t.push('<button type="button" data-plyr="play">', '<svg><use xlink:href="' + n + '-play" /></svg>', '<span class="plyr__sr-only">' + T.i18n.play + "</span>", "</button>", '<button type="button" data-plyr="pause">', '<svg><use xlink:href="' + n + '-pause" /></svg>', '<span class="plyr__sr-only">' + T.i18n.pause + "</span>", "</button>"),
			...
			r(T.controls, "progress") && (t.push('<span class="plyr__progress">', '<label for="seek{id}" class="plyr__sr-only">Seek</label>', '<input id="seek{id}" class="plyr__progress--seek" type="range" min="0" max="100" step="0.1" value="0" data-plyr="seek">', '<progress class="plyr__progress--played" max="100" value="0" role="presentation"></progress>', '<progress class="plyr__progress--buffer" max="100" value="0">', "<span>0</span>% " + T.i18n.buffered, "</progress>"), T.tooltips.seek && t.push('<span class="plyr__tooltip">00:00</span>'), t.push("</span>")),
			r(T.controls, "current-time") && t.push('<span class="plyr__time">', '<span class="plyr__sr-only">' + T.i18n.currentTime + "</span>", '<span class="plyr__time--current">00:00</span>', "</span>"),
			r(T.controls, "duration") && t.push('<span class="plyr__time">', '<span class="plyr__sr-only">' + T.i18n.duration + "</span>", '<span class="plyr__time--duration">00:00</span>', "</span>"),
			r(T.controls, "mute") && t.push('<button type="button" data-plyr="mute">', '<svg class="icon--muted"><use xlink:href="' + n + '-muted" /></svg>', '<svg><use xlink:href="' + n + '-volume" /></svg>', '<span class="plyr__sr-only">' + T.i18n.toggleMute + "</span>", "</button>"),
			...
			r(T.controls, "captions") && t.push('<button type="button" data-plyr="captions">', '<svg class="icon--captions-on"><use xlink:href="' + n + '-captions-on" /></svg>', '<svg><use xlink:href="' + n + '-captions-off" /></svg>', '<span class="plyr__sr-only">' + T.i18n.toggleCaptions + "</span>", "</button>"),
		...
		function z() {
			if (Vt.supported.full && ("audio" !== Vt.type || T.fullscreen.allowAudio) && T.fullscreen.enabled) {
				...
				t || T.fullscreen.fallback && !U() ? (Yt((t ? "Native" : "Fallback") + " fullscreen enabled"), f(Vt.container, T.classes.fullscreen.enabled, !0)) : Yt("Fullscreen not supported and fallback disabled"),
				Vt.buttons && Vt.buttons.fullscreen && x(Vt.buttons.fullscreen, !1),
				Y()
			}
		}
		function W() {
			if ("video" === Vt.type) {
				q(T.selectors.captions) || Vt.videoContainer.insertAdjacentHTML("afterbegin", '<div class="' + h(T.selectors.captions) + '"></div>'),
				Vt.usingTextTracks = !1,
				Vt.media.textTracks && (Vt.usingTextTracks = !0);
				for (var t, e = "", n = Vt.media.childNodes, i = 0; i < n.length; i++)
					"track" === n[i].nodeName.toLowerCase() && ("captions" !== (t = n[i].kind) && "subtitles" !== t || (e = n[i].getAttribute("src")));
				if (Vt.captionExists = !0, "" === e ? (Vt.captionExists = !1, Yt("No caption track found")) : Yt("Caption track found; URI: " + e), Vt.captionExists) {
					for (var o = Vt.media.textTracks, r = 0; r < o.length; r++)
						o[r].mode = "hidden";
					if (B(), (Vt.browser.isIE && Vt.browser.version >= 10 || Vt.browser.isFirefox && Vt.browser.version >= 31) && (Yt("Detected browser with known TextTrack issues - using manual fallback"), Vt.usingTextTracks = !1), Vt.usingTextTracks) {
						Yt("TextTracks supported");
					...
					} else if (Yt("TextTracks not supported so rendering captions manually"), Vt.currentCaption = "", Vt.captions = [], "" !== e) {
						var l = new XMLHttpRequest;
						l.onreadystatechange = function () {
							if (4 === l.readyState)
								if (200 === l.status) {
									...
									for (var o = 0; o < e.length; o++) {
										...
										a = 0;
										-1 === r[a].indexOf(":") && (a = 1),
										Vt.captions[o] = [r[a], r[a + 1]]
									}
									Vt.captions.shift(),
									Yt("Successfully loaded the caption file via AJAX")
								} else
									Gt(T.logPrefix + "There was a problem loading the caption file via AJAX")
						},
						l.open("get", e, !0),
						l.send()
					}
				} else
					f(Vt.container, T.classes.captions.enabled)
			}
		}
		function j(t) {
			...
			n.innerHTML = "",
			$.undefined(t) && (t = ""),
			$.string(t) ? i.innerHTML = t.trim() : i.appendChild(t),
			n.appendChild(i),
			n.offsetHeight
		}
		function H(t) {
			...
			if (!Vt.usingTextTracks && "video" === Vt.type && Vt.supported.full && (Vt.subcount = 0, t = $.number(t) ? t : Vt.media.currentTime, Vt.captions[Vt.subcount])) {
				for (; n(Vt.captions[Vt.subcount][0]) < t.toFixed(1); )
					if (++Vt.subcount > Vt.captions.length - 1) {
						Vt.subcount = Vt.captions.length - 1;
						break
					}
				Vt.media.currentTime.toFixed(1) >= function (t) {
					return e(t, 0)
				}
				(Vt.captions[Vt.subcount][0]) && Vt.media.currentTime.toFixed(1) <= n(Vt.captions[Vt.subcount][0]) ? (Vt.currentCaption = Vt.captions[Vt.subcount][1], j(Vt.currentCaption)) : j()
			}
		}
		function B() {
			if (Vt.buttons.captions) {
				f(Vt.container, T.classes.captions.enabled, !0);
				var t = Vt.storage.captionsEnabled;
				$.boolean(t) || (t = T.captions.defaultActive),
				t && (f(Vt.container, T.classes.captions.active, !0), x(Vt.buttons.captions, !0))
			}
		}
		function V(t) {
		...
		function Y() {
			function t(t) {
				9 === t.which && Vt.isFullscreen && (t.target !== i || t.shiftKey ? t.target === n && t.shiftKey && (t.preventDefault(), i.focus()) : (t.preventDefault(), n.focus()))
			}
		...
		function Q() {
			...
			var n = T.html;
			Yt("Injecting custom controls"),
			n || (n = R()),
			n = a(n = a(n, "{seektime}", T.seekTime), "{id}", Math.floor(1e4 * Math.random()));
			var i;
			if ($.string(T.selectors.controls.container) && (i = e.querySelector(T.selectors.controls.container)), $.htmlElement(i) || (i = Vt.container), i.insertAdjacentHTML("beforeend", n), T.tooltips.controls)
				for (var o = V([T.selectors.controls.wrapper, " ", T.selectors.labels, " .", T.classes.hidden].join("")), r = o.length - 1; r >= 0; r--) {
					var s = o[r];
					f(s, T.classes.hidden, !1),
					f(s, T.classes.tooltip, !0)
				}
		}
		function X() {
			try {
				return Vt.controls = q(T.selectors.controls.wrapper),
				Vt.buttons = {},
				Vt.buttons.seek = q(T.selectors.buttons.seek),
				Vt.buttons.play = V(T.selectors.buttons.play),
				Vt.buttons.pause = q(T.selectors.buttons.pause),
				Vt.buttons.restart = q(T.selectors.buttons.restart),
				Vt.buttons.rewind = q(T.selectors.buttons.rewind),
				Vt.buttons.forward = q(T.selectors.buttons.forward),
				Vt.buttons.fullscreen = q(T.selectors.buttons.fullscreen),
				Vt.buttons.mute = q(T.selectors.buttons.mute),
				Vt.buttons.captions = q(T.selectors.buttons.captions),
				Vt.progress = {},
				Vt.progress.container = q(T.selectors.progress.container),
				Vt.progress.buffer = {},
				Vt.progress.buffer.bar = q(T.selectors.progress.buffer),
				Vt.progress.buffer.text = Vt.progress.buffer.bar && Vt.progress.buffer.bar.getElementsByTagName("span")[0],
				Vt.progress.played = q(T.selectors.progress.played),
				Vt.progress.tooltip = Vt.progress.container && Vt.progress.container.querySelector("." + T.classes.tooltip),
				Vt.volume = {},
				Vt.volume.input = q(T.selectors.volume.input),
				Vt.volume.display = q(T.selectors.volume.display),
				Vt.duration = q(T.selectors.duration),
				Vt.currentTime = q(T.selectors.currentTime),
				Vt.seekTime = V(T.selectors.seekTime),
				!0
			} catch (t) {
				return Gt("It looks like there is a problem with your controls HTML"),
				J(!0),
				!1
			}
		}
		function Z() {
			f(Vt.container, T.selectors.container.replace(".", ""), Vt.supported.full)
		}
		function J(t) {
			t && r(T.types.html5, Vt.type) ? Vt.media.setAttribute("controls", "") : Vt.media.removeAttribute("controls")
		}
		function K(t) {
			var e = T.i18n.play;
			if ($.string(T.title) && T.title.length && (e += ", " + T.title, Vt.container.setAttribute("aria-label", T.title)), Vt.supported.full && Vt.buttons.play)
				for (var n = Vt.buttons.play.length - 1; n >= 0; n--)
					Vt.buttons.play[n].setAttribute("aria-label", e);
			$.htmlElement(t) && t.setAttribute("title", T.i18n.frameTitle.replace("{title}", T.title))
		}
		function tt() {
			var e = null;
			Vt.storage = {},
			F.supported && T.storage.enabled && (t.localStorage.removeItem("plyr-volume"), (e = t.localStorage.getItem(T.storage.key)) && (/^\d+(\.\d+)?$/.test(e) ? et({
						volume: parseFloat(e)
					}) : Vt.storage = JSON.parse(e)))
		}
		function et(e) {
			F.supported && T.storage.enabled && (_(Vt.storage, e), t.localStorage.setItem(T.storage.key, JSON.stringify(Vt.storage)))
		}
		function nt() {
			if (Vt.media) {
				if (Vt.supported.full && (f(Vt.container, T.classes.type.replace("{0}", Vt.type), !0), r(T.types.embed, Vt.type) && f(Vt.container, T.classes.type.replace("{0}", "video"), !0), f(Vt.container, T.classes.stopped, T.autoplay), f(Vt.container, T.classes.isIos, Vt.browser.isIos), f(Vt.container, T.classes.isTouch, Vt.browser.isTouch), "video" === Vt.type)) {
					...
					t.setAttribute("class", T.classes.videoWrapper),
					s(Vt.media, t),
					Vt.videoContainer = t
				}
				r(T.types.embed, Vt.type) && it()
			} else
				Gt("No media element found!")
		}
		function it() {
			var n,
			...
			for (var a = V('[id^="' + Vt.type + '-"]'), s = a.length - 1; s >= 0; s--)
				l(a[s]);
			if (f(Vt.media, T.classes.videoWrapper, !0), f(Vt.media, T.classes.embedWrapper, !0), "youtube" === Vt.type)
				Vt.media.appendChild(i), i.setAttribute("id", r), $.object(t.YT) ? rt(n, i) : (o(T.urls.youtube.api), t.onYouTubeReadyCallbacks = t.onYouTubeReadyCallbacks || [], t.onYouTubeReadyCallbacks.push(function () {
						rt(n, i)
				...
				if (Vt.supported.full ? Vt.media.appendChild(i) : i = Vt.media, i.setAttribute("id", r), $.object(t.Vimeo))
					at(n, i);
				else {
					o(T.urls.vimeo.api);
					var u = t.setInterval(function () {
							$.object(t.Vimeo) && (t.clearInterval(u), at(n, i))
						}, 50)
				}
				...
				i.appendChild(d),
				Vt.media.appendChild(i),
				t.SC || o(T.urls.soundcloud.api);
				var h = t.setInterval(function () {
						t.SC && d.loaded && (t.clearInterval(h), st.call(d))
					}, 50)
			}
		}
		function ot() {
			Vt.supported.full && (jt(), Ht()),
			K(q("iframe"))
		}
		function rt(e, n) {
			Vt.embed = new t.YT.Player(n.id, {
					videoId: e,
					playerVars: {
						autoplay: T.autoplay ? 1 : 0,
						controls: Vt.supported.full ? 0 : 1,
						rel: 0,
						showinfo: 0,
						iv_load_policy: 3,
					...
					events: {
						...
						onReady: function (e) {
							...
							Vt.media.pause = function () {
								n.pauseVideo(),
								Vt.media.paused = !0
							},
							Vt.media.stop = function () {
								n.stopVideo(),
								Vt.media.paused = !0
							},
							Vt.media.duration = n.getDuration(),
							Vt.media.paused = !0,
							Vt.media.currentTime = 0,
							Vt.media.muted = n.isMuted(),
							T.title = n.getVideoData().title,
							Vt.supported.full && Vt.media.querySelector("iframe").setAttribute("tabindex", "-1"),
							ot(),
							A(Vt.media, "timeupdate"),
							A(Vt.media, "durationchange"),
							t.clearInterval(qt.buffering),
							qt.buffering = t.setInterval(function () {
									Vt.media.buffered = n.getVideoLoadedFraction(),
									(null === Vt.media.lastBuffered || Vt.media.lastBuffered < Vt.media.buffered) && A(Vt.media, "progress"),
									Vt.media.lastBuffered = Vt.media.buffered,
									1 === Vt.media.buffered && (t.clearInterval(qt.buffering), A(Vt.media, "canplaythrough"))
								}, 200)
						},
						onStateChange: function (e) {
							...
							case 1:
								Vt.media.paused = !1,
								Vt.media.seeking && A(Vt.media, "seeked"),
								Vt.media.seeking = !1,
								A(Vt.media, "play"),
								A(Vt.media, "playing"),
								qt.playing = t.setInterval(function () {
										Vt.media.currentTime = n.getCurrentTime(),
										A(Vt.media, "timeupdate")
									}, 100),
								Vt.media.duration !== n.getDuration() && (Vt.media.duration = n.getDuration(), A(Vt.media, "durationchange"));
								break;
							case 2:
								Vt.media.paused = !0,
								A(Vt.media, "pause")
							}
							A(Vt.container, "statechange", !1, {
								code: e.data
							})
						}
					}
		...
		function at(e, n) {
			...
			Vt.media.currentTime = 0,
			ot(),
			Vt.embed.getCurrentTime().then(function (t) {
				Vt.media.currentTime = t,
				A(Vt.media, "timeupdate")
			}),
			Vt.embed.getDuration().then(function (t) {
				Vt.media.duration = t,
				A(Vt.media, "durationchange")
			}),
			Vt.embed.on("loaded", function () {
				$.htmlElement(Vt.embed.element) && Vt.supported.full && Vt.embed.element.setAttribute("tabindex", "-1")
			}),
			Vt.embed.on("play", function () {
				Vt.media.paused = !1,
				A(Vt.media, "play"),
				A(Vt.media, "playing")
			}),
			Vt.embed.on("pause", function () {
				Vt.media.paused = !0,
				A(Vt.media, "pause")
			}),
			Vt.embed.on("timeupdate", function (t) {
				Vt.media.seeking = !1,
				Vt.media.currentTime = t.seconds,
				A(Vt.media, "timeupdate")
			}),
			Vt.embed.on("progress", function (t) {
				Vt.media.buffered = t.percent,
				A(Vt.media, "progress"),
				1 === parseInt(t.percent) && A(Vt.media, "canplaythrough")
			}),
			Vt.embed.on("seeked", function () {
				Vt.media.seeking = !1,
				A(Vt.media, "seeked"),
				A(Vt.media, "play")
			}),
			Vt.embed.on("ended", function () {
				Vt.media.paused = !0,
				A(Vt.media, "ended")
			})
		}
		function st() {
			Vt.embed = t.SC.Widget(this),
			Vt.embed.bind(t.SC.Widget.Events.READY, function () {
				Vt.media.play = function () {
					Vt.embed.play(),
					Vt.media.paused = !1
				},
				...
				Vt.media.paused = !0,
				Vt.media.currentTime = 0,
				Vt.embed.getDuration(function (t) {
					Vt.media.duration = t / 1e3,
					ot()
				}),
				Vt.embed.getPosition(function (t) {
					Vt.media.currentTime = t,
					A(Vt.media, "timeupdate")
				}),
				Vt.embed.bind(t.SC.Widget.Events.PLAY, function () {
					Vt.media.paused = !1,
					A(Vt.media, "play"),
					A(Vt.media, "playing")
				}),
				Vt.embed.bind(t.SC.Widget.Events.PAUSE, function () {
					Vt.media.paused = !0,
					A(Vt.media, "pause")
				}),
				Vt.embed.bind(t.SC.Widget.Events.PLAY_PROGRESS, function (t) {
					Vt.media.seeking = !1,
					Vt.media.currentTime = t.currentPosition / 1e3,
					A(Vt.media, "timeupdate")
				}),
				Vt.embed.bind(t.SC.Widget.Events.LOAD_PROGRESS, function (t) {
					Vt.media.buffered = t.loadProgress,
					A(Vt.media, "progress"),
					1 === parseInt(t.loadProgress) && A(Vt.media, "canplaythrough")
				}),
				Vt.embed.bind(t.SC.Widget.Events.FINISH, function () {
					Vt.media.paused = !0,
					A(Vt.media, "ended")
				})
			})
		...
		function lt() {
			"play" in Vt.media && Vt.media.play()
		}
		function ut() {
			"pause" in Vt.media && Vt.media.pause()
		}
		function ct(t) {
			return $.boolean(t) || (t = Vt.media.paused),
			t ? lt() : ut(),
			t
		}
		function dt(t) {
			$.number(t) || (t = T.seekTime),
			ft(Vt.media.currentTime - t)
		}
		function ht(t) {
			$.number(t) || (t = T.seekTime),
			ft(Vt.media.currentTime + t)
		...
		function ft(t) {
			...
			n = Vt.media.paused,
			i = pt();
			$.number(t) ? e = t : $.object(t) && r(["input", "change"], t.type) && (e = t.target.value / t.target.max * i),
			e < 0 ? e = 0 : e > i && (e = i),
			It(e);
			try {
				Vt.media.currentTime = e.toFixed(4)
			} catch (t) {}
			...
			Yt("Seeking to " + Vt.media.currentTime + " seconds"),
			H(e)
		}
		function pt() {
			var t = parseInt(T.duration),
			e = 0;
			return null === Vt.media.duration || isNaN(Vt.media.duration) || (e = Vt.media.duration),
			isNaN(t) ? e : t
		}
		function gt() {
			f(Vt.container, T.classes.playing, !Vt.media.paused),
			f(Vt.container, T.classes.stopped, Vt.media.paused),
			Pt(Vt.media.paused)
		}
		function mt() {
			O = {
		...
		function yt(t) {
			...
			if (n) {
				if (!t || t.type !== I.fullScreenEventName)
					return I.isFullScreen(Vt.container) ? I.cancelFullScreen() : (mt(), I.requestFullScreen(Vt.container)), void(Vt.isFullscreen = I.isFullScreen(Vt.container));
				Vt.isFullscreen = I.isFullScreen(Vt.container)
			} else
				Vt.isFullscreen = !Vt.isFullscreen, e.body.style.overflow = Vt.isFullscreen ? "hidden" : "";
			f(Vt.container, T.classes.fullscreen.active, Vt.isFullscreen),
			Y(Vt.isFullscreen),
			Vt.buttons && Vt.buttons.fullscreen && x(Vt.buttons.fullscreen, Vt.isFullscreen),
			A(Vt.container, Vt.isFullscreen ? "enterfullscreen" : "exitfullscreen", !0),
			!Vt.isFullscreen && n && vt()
		}
		function bt(t) {
		...
		function xt(t) {
			var e = T.volumeMax,
			n = T.volumeMin;
			if ($.undefined(t) && (t = Vt.storage.volume), (null === t || isNaN(t)) && (t = T.volume), t > e && (t = e), t < n && (t = n), Vt.media.volume = parseFloat(t / e), Vt.volume.display && (Vt.volume.display.value = t), r(T.types.embed, Vt.type)) {
				switch (Vt.type) {
				case "youtube":
		...
		function kt() {
			...
			Vt.supported.full && (Vt.volume.input && (Vt.volume.input.value = t), Vt.volume.display && (Vt.volume.display.value = t)),
			et({
				volume: t
			}),
			f(Vt.container, T.classes.muted, 0 === t),
			Vt.supported.full && Vt.buttons.mute && x(Vt.buttons.mute, 0 === t)
		}
		function Ct(t) {
			Vt.supported.full && Vt.buttons.captions && ($.boolean(t) || (t = -1 === Vt.container.className.indexOf(T.classes.captions.active)), Vt.captionsEnabled = t, x(Vt.buttons.captions, Vt.captionsEnabled), f(Vt.container, T.classes.captions.active, Vt.captionsEnabled), A(Vt.container, Vt.captionsEnabled ? "captionsenabled" : "captionsdisabled", !0), et({
					captionsEnabled: Vt.captionsEnabled
				}))
		}
		function St(t) {
			var e = "waiting" === t.type;
			clearTimeout(qt.loading),
			qt.loading = setTimeout(function () {
					f(Vt.container, T.classes.loading, e),
					Pt(e)
				}, e ? 250 : 0)
		}
		function Tt(t) {
			if (Vt.supported.full) {
				...
				if (t)
					...
					case "timeupdate":
					case "seeking":
						if (Vt.controls.pressed)
							return;
						n = w(Vt.media.currentTime, i),
						"timeupdate" === t.type && Vt.buttons.seek && (Vt.buttons.seek.value = n);
						break;
					case "playing":
					case "progress":
						e = Vt.progress.buffer,
						n = function () {
							var t = Vt.media.buffered;
							return t && t.length ? w(t.end(0), i) : $.number(t) ? 100 * t : 0
						}
						()
					}
				Dt(e, n)
		...
		function Dt(t, e) {
			if (Vt.supported.full) {
				if ($.undefined(e) && (e = 0), $.undefined(t)) {
					if (!Vt.progress || !Vt.progress.buffer)
						return;
		...
		function Mt(t, e) {
			if (e) {
				isNaN(t) && (t = 0),
				Vt.secs = parseInt(t % 60),
				Vt.mins = parseInt(t / 60 % 60),
				Vt.hours = parseInt(t / 60 / 60 % 60);
				var n = parseInt(pt() / 60 / 60 % 60) > 0;
				Vt.secs = ("0" + Vt.secs).slice(-2),
				Vt.mins = ("0" + Vt.mins).slice(-2),
				e.innerHTML = (n ? Vt.hours + ":" : "") + Vt.mins + ":" + Vt.secs
			}
		}
		function At() {
			if (Vt.supported.full) {
				var t = pt() || 0;
				!Vt.duration && T.displayDuration && Vt.media.paused && Mt(t, Vt.currentTime),
				Vt.duration && Mt(t, Vt.duration),
				Ot()
			}
		}
		function Et(t) {
			Mt(Vt.media.currentTime, Vt.currentTime),
			t && "timeupdate" === t.type && Vt.media.seeking || Tt(t)
		}
		function It(t) {
			$.number(t) || (t = 0);
			var e = w(t, pt());
			Vt.progress && Vt.progress.played && (Vt.progress.played.value = e),
			Vt.buttons && Vt.buttons.seek && (Vt.buttons.seek.value = e)
		}
		function Ot(t) {
			var e = pt();
			if (T.tooltips.seek && Vt.progress.container && 0 !== e) {
				var n = Vt.progress.container.getBoundingClientRect(),
				i = 0,
				o = T.classes.tooltip + "--visible";
				if (t)
					i = 100 / n.width * (t.pageX - n.left);
				else {
					if (!p(Vt.progress.tooltip, o))
						return;
					i = Vt.progress.tooltip.style.left.replace("%", "")
				}
				i < 0 ? i = 0 : i > 100 && (i = 100),
				Mt(e / 100 * i, Vt.progress.tooltip),
				Vt.progress.tooltip.style.left = i + "%",
				t && r(["mouseenter", "mouseleave"], t.type) && f(Vt.progress.tooltip, o, "mouseenter" === t.type)
			}
		}
		function Pt(e) {
			if (T.hideControls && "audio" !== Vt.type) {
				...
				if ($.boolean(e) || (e && e.type ? (i = "enterfullscreen" === e.type, o = r(["mousemove", "touchstart", "mouseenter", "focus"], e.type), r(["mousemove", "touchmove"], e.type) && (n = 2e3), "focus" === e.type && (n = 3e3)) : o = p(Vt.container, T.classes.hideControls)), t.clearTimeout(qt.hover), o || Vt.media.paused || a) {
					if (f(Vt.container, T.classes.hideControls, !1), Vt.media.paused || a)
						return;
					Vt.browser.isTouch && (n = 3e3)
				}
				o && Vt.media.paused || (qt.hover = t.setTimeout(function () {
							(!Vt.controls.pressed && !Vt.controls.hover || i) && f(Vt.container, T.classes.hideControls, !0)
						}, n))
			}
		}
		function $t(t) {
			if ($.undefined(t)) {
				...
				case "youtube":
					...
					break;
				case "vimeo":
					Vt.embed.getVideoUrl.then(function (t) {
						e = t
					});
					break;
				case "soundcloud":
					Vt.embed.getCurrentSound(function (t) {
						e = t.permalink_url
					});
					break;
				default:
		...
		function Ft(t) {
			function n() {
				if (Vt.embed = null, l(Vt.media), "video" === Vt.type && Vt.videoContainer && l(Vt.videoContainer), Vt.container && Vt.container.removeAttribute("class"), "type" in t && (Vt.type = t.type, "video" === Vt.type)) {
					var n = t.sources[0];
					"type" in n && r(T.types.embed, n.type) && (Vt.type = n.type)
				}
				...
				case "vimeo":
				case "soundcloud":
					Vt.media = e.createElement("div"),
					Vt.embedId = t.sources[0].src
				}
				u(Vt.container, Vt.media),
				$.boolean(t.autoplay) && (T.autoplay = t.autoplay),
				r(T.types.html5, Vt.type) && (T.crossorigin && Vt.media.setAttribute("crossorigin", ""), T.autoplay && Vt.media.setAttribute("autoplay", ""), "poster" in t && Vt.media.setAttribute("poster", t.poster), T.loop && Vt.media.setAttribute("loop", "")),
				f(Vt.container, T.classes.fullscreen.active, Vt.isFullscreen),
				f(Vt.container, T.classes.captions.active, Vt.captionsEnabled),
				Z(),
				r(T.types.html5, Vt.type) && G("source", t.sources),
				nt(),
				r(T.types.html5, Vt.type) && ("tracks" in t && G("track", t.tracks), Vt.media.load()),
				(r(T.types.html5, Vt.type) || r(T.types.embed, Vt.type) && !Vt.supported.full) && (jt(), Ht()),
				T.title = t.title,
				K()
			}
		...
		function Nt(t) {
			"video" === Vt.type && Vt.media.setAttribute("poster", t)
		}
		function Lt() {
			function n() {
				var t = ct(),
				e = Vt.buttons[t ? "play" : "pause"],
				n = Vt.buttons[t ? "pause" : "play"];
				if (n = n && n.length > 1 ? n[n.length - 1] : n[0]) {
					var i = p(e, T.classes.tabFocus);
					setTimeout(function () {
						n.focus(),
						i && (f(e, T.classes.tabFocus, !1), f(n, T.classes.tabFocus, !0))
					}, 100)
				}
			}
			function i() {
				...
				for (var e in Vt.buttons) {
					...
					if ($.nodeList(n))
						for (var i = 0; i < n.length; i++)
							f(n[i], T.classes.tabFocus, n[i] === t);
					else
						f(n, T.classes.tabFocus, n === t)
				}
			}
			function s(t) {
				var e = o(t),
				...
				if ($.number(e))
					if (n) {
						...
						!I.supportsFullScreen && Vt.isFullscreen && 27 === e && yt(),
						u = e
					} else
						u = null
			}
			...
			if (T.keyboardShorcuts.focused) {
				...
				T.keyboardShorcuts.global && y(t, "keydown keyup", function (t) {
					...
					1 !== E().length || !r(a, e) || $.htmlElement(n) && g(n, T.selectors.editable) || s(t)
				}),
				y(Vt.container, "keydown keyup", s)
			}
			...
			y(e.body, "click", function () {
				f(q("." + T.classes.tabFocus), T.classes.tabFocus, !1)
			});
			...
			m(Vt.buttons.play, "click", T.listeners.play, n),
			m(Vt.buttons.pause, "click", T.listeners.pause, n),
			m(Vt.buttons.restart, "click", T.listeners.restart, ft),
			m(Vt.buttons.rewind, "click", T.listeners.rewind, dt),
			m(Vt.buttons.forward, "click", T.listeners.forward, ht),
			m(Vt.buttons.seek, l, T.listeners.seek, ft),
			m(Vt.volume.input, l, T.listeners.volume, function () {
				xt(Vt.volume.input.value)
			}),
			m(Vt.buttons.mute, "click", T.listeners.mute, bt),
			m(Vt.buttons.fullscreen, "click", T.listeners.fullscreen, yt),
			I.supportsFullScreen && y(e, I.fullScreenEventName, yt),
			m(Vt.buttons.captions, "click", T.listeners.captions, Ct),
			y(Vt.progress.container, "mouseenter mouseleave mousemove", Ot),
			T.hideControls && (y(Vt.container, "mouseenter mouseleave mousemove touchstart touchend touchcancel touchmove enterfullscreen", Pt), y(Vt.controls, "mouseenter mouseleave", function (t) {
					Vt.controls.hover = "mouseenter" === t.type
				}), y(Vt.controls, "mousedown mouseup touchstart touchend touchcancel", function (t) {
					Vt.controls.pressed = r(["mousedown", "touchstart"], t.type)
				}), y(Vt.controls, "focus blur", Pt, !0)),
			y(Vt.volume.input, "wheel", function (t) {
				t.preventDefault();
				var e = t.webkitDirectionInvertedFromDevice,
				n = T.volumeStep / 5;
				(t.deltaY < 0 || t.deltaX > 0) && (e ? _t(n) : wt(n)),
				(t.deltaY > 0 || t.deltaX < 0) && (e ? wt(n) : _t(n))
			})
		}
		function Rt() {
			if (y(Vt.media, "timeupdate seeking", Et), y(Vt.media, "timeupdate", H), y(Vt.media, "durationchange loadedmetadata", At), y(Vt.media, "ended", function () {
					"video" === Vt.type && T.showPosterOnEnd && ("video" === Vt.type && j(), ft(), Vt.media.load())
				}), y(Vt.media, "progress playing", Tt), y(Vt.media, "volumechange", kt), y(Vt.media, "play pause ended", gt), y(Vt.media, "waiting canplay seeked", St), T.clickToPlay && "audio" !== Vt.type) {
				var t = q("." + T.classes.videoWrapper);
				if (!t)
					return;
				t.style.cursor = "pointer",
				y(t, "click", function () {
					T.hideControls && Vt.browser.isTouch && !Vt.media.paused || (Vt.media.paused ? lt() : Vt.media.ended ? (ft(), lt()) : ut())
				})
			}
			T.disableContextMenu && y(Vt.media, "contextmenu", function (t) {
				t.preventDefault()
			}),
			y(Vt.media, T.events.concat(["keyup", "keydown"]).join(" "), function (t) {
				A(Vt.container, t.type, !0)
			})
		}
		function zt() {
			if (r(T.types.html5, Vt.type)) {
				for (var t = Vt.media.querySelectorAll("source"), e = 0; e < t.length; e++)
					l(t[e]);
				Vt.media.setAttribute("src", T.blankUrl),
				Vt.media.load(),
				Yt("Cancelled network requests")
			}
		}
		function Wt(n, i) {
			function o() {
				clearTimeout(qt.cleanUp),
				$.boolean(i) || (i = !0),
				$.function(n) && n.call(Ut),
				i && (Vt.init = !1, Vt.container.parentNode.replaceChild(Ut, Vt.container), e.body.style.overflow = "", A(Ut, "destroyed", !0))
			}
			if (!Vt.init)
				return null;
			switch (Vt.type) {
			case "youtube":
				t.clearInterval(qt.buffering),
				t.clearInterval(qt.playing),
				Vt.embed.destroy(),
				o();
				break;
			case "vimeo":
				Vt.embed.unload().then(o),
				qt.cleanUp = t.setTimeout(o, 200);
				break;
			case "video":
			case "audio":
				J(!0),
		...
		function jt() {
			if (!Vt.supported.full)
				return Gt("Basic support only", Vt.type), l(q(T.selectors.controls.wrapper)), l(q(T.selectors.buttons.play)), void J(!0);
			var t = !V(T.selectors.controls.wrapper).length;
			t && Q(),
			X() && (t && Lt(), Rt(), J(), z(), W(), xt(), kt(), Et(), gt())
		}
		function Ht() {
			t.setTimeout(function () {
				A(Vt.media, "ready")
			}, 0),
			f(Vt.media, P.classes.setup, !0),
			f(Vt.container, T.classes.ready, !0),
			Vt.media.plyr = Bt,
			T.autoplay && lt()
		}
		var Bt,
		...
		Bt = {
			...
			getCurrentTime: function () {
				return Vt.media.currentTime
			},
			getVolume: function () {
				return Vt.media.volume
			},
			isMuted: function () {
				return Vt.media.muted
			},
			isReady: function () {
				return p(Vt.container, T.classes.ready)
			},
			isLoading: function () {
				return p(Vt.container, T.classes.loading)
			},
			isPaused: function () {
				return Vt.media.paused
			},
			on: function (t, e) {
				return y(Vt.container, t, e),
				this
			},
			play: lt,
			pause: ut,
		...
		function () {
			if (Vt.init)
				return null;
			if (I = S(), Vt.browser = n(), $.htmlElement(Vt.media)) {
				tt();
				var t = v.tagName.toLowerCase();
				"div" === t ? (Vt.type = v.getAttribute("data-type"), Vt.embedId = v.getAttribute("data-video-id"), v.removeAttribute("data-type"), v.removeAttribute("data-video-id")) : (Vt.type = t, T.crossorigin = null !== v.getAttribute("crossorigin"), T.autoplay = T.autoplay || null !== v.getAttribute("autoplay"), T.loop = T.loop || null !== v.getAttribute("loop")),
				Vt.supported = M(Vt.type),
				Vt.supported.basic && (Vt.container = s(v, e.createElement("div")), Vt.container.setAttribute("tabindex", 0), Z(), Yt(Vt.browser.name + " " + Vt.browser.version), nt(), (r(T.types.html5, Vt.type) || r(T.types.embed, Vt.type) && !Vt.supported.full) && (jt(), Ht(), K()), Vt.init = !0)
			}
		}
		(),
		Vt.init ? Bt : null
	...
	function D(t, n) {
		...
		if (!$.string(n) || !$.htmlElement(e.querySelector("#" + n))) {
			var o = e.createElement("div");
			o.setAttribute("hidden", ""),
			$.string(n) && o.setAttribute("id", n),
			e.body.insertBefore(o, e.body.childNodes[0]),
			"withCredentials" in i && (i.open("GET", t, !0), i.onload = function () {
	...
	function A(t, n) {
		...
		if ($.string(t) ? t = e.querySelectorAll(t) : $.htmlElement(t) ? t = [t] : $.nodeList(t) || $.array(t) || $.string(t) || ($.undefined(n) && $.object(t) && (n = t), t = e.querySelectorAll(a)), $.nodeList(t) && (t = Array.prototype.slice.call(t)), !M().basic || !t.length)
			return !1;
		...
		return o.forEach(function (t) {
			...
			var o = {};
			try {
				o = JSON.parse(e.getAttribute("data-plyr"))
			} catch (t) {}
			var a = _({}, P, n, o);
			if (!a.enabled)
				return null;
			...
			if ($.object(s)) {
				if (a.debug) {
					...
					y(s.getContainer(), l.join(" "), function (t) {
...
("undefined" != typeof window ? window : this, function (t, e) {
	...
	function o(t, e, r) {
		return this instanceof o ? ("string" == typeof t && (t = document.querySelectorAll(t)), this.elements = i(t), this.options = n({}, this.options), "function" == typeof e ? r = e : n(this.options, e), r && this.on("always", r), this.getImages(), s && (this.jqDeferred = new s.Deferred), void setTimeout(function () {
				this.check()
			}
...
(window, function (t, e) {
	...
	function n(n, r, s) {
		...
		function u(t, e) {
			t.each(function (t, i) {
				var o = s.data(i, n);
				o ? (o.option(e), o._init()) : (o = new r(i, e), s.data(i, n, o))
			})
		}
...
(window, function () {
	...
	function o() {
		if (!c) {
			...
			n.appendChild(e);
			var o = i(e);
			r.isBoxSizeOuter = a = 200 == t(o.width),
			n.removeChild(e)
		}
	}
	function r(e) {
		if (o(), "string" == typeof e && (e = document.querySelector(e)), e && "object" == typeof e && e.nodeType) {
			...
			w = c && a,
			_ = t(r.width);
			!1 !== _ && (s.width = _ + (w ? 0 : g + b));
			var k = t(r.height);
			return !1 !== k && (s.height = k + (w ? 0 : m + x)),
			s.innerWidth = s.width - (g + b),
			s.innerHeight = s.height - (m + x),
	...
	var a,
	s = "undefined" == typeof console ? e : function (t) {
		console.error(t)
	},
...
(window, function (t, e) {
	...
	i._getItemLayoutPosition = function (t) {
		...
		for (var o = this[this.options.horizontalOrder ? "_getHorizontalColPosition" : "_getTopColPosition"](i, t), r = {
				...
				y: o.y
			}, a = o.y + t.size.outerHeight, s = i + o.col, l = o.col; s > l; l++)
			this.colYs[l] = a;
		return r
	},
	...
	i._manageStamp = function (t) {
		...
		for (var l = (this._getOption("originTop") ? i.top : i.bottom) + n.outerHeight, u = a; s >= u; u++)
	...
	e.prototype.refresh = function () {
		...
		for (var r in t) {
			...
			for (var s in this.waypoints[r]) {
				...
				m = 0,
				v = null == g;
				f.element !== f.element.window && (m = f.adapter.offset()[a.offsetProp]),
				...
				f.triggerPoint = m + l - p,
				u = g < a.oldScroll,
				c = f.triggerPoint >= a.oldScroll,
				d = u && c,
				h = !u && !c,
				!v && d ? (f.queueTrigger(a.backward), i[f.group.id] = f.group) : !v && h ? (f.queueTrigger(a.forward), i[f.group.id] = f.group) : v && a.oldScroll >= f.triggerPoint && (f.queueTrigger(a.forward), i[f.group.id] = f.group)
			}
		}
...
(), function () {
	...
	function t(t) {
		return function () {
			var n = [],
			i = arguments[0];
			return t.isFunction(arguments[0]) && (i = t.extend({}, arguments[1]), i.handler = arguments[0]),
			this.each(function () {
				var o = t.extend({}, i, {
						element: this
					});
	...
	t.fn.counterUp = function (e) {
		...
		return this.each(function () {
			...
			o = {
				...
				offset: t(this).data("counterup-offset") || i.offset,
				beginAt: t(this).data("counterup-beginat") || i.beginAt,
				context: t(this).data("counterup-context") || i.context
			},
			r = function () {
				var r = [],
				a = o.time / o.delay,
				...
				e.text(o.beginAt);
				var y = function () {
					e.data("counterup-nums") ? (e.html(e.data("counterup-nums").shift()), e.data("counterup-nums").length ? setTimeout(e.data("counterup-func"), o.delay) : (e.data("counterup-nums", null), e.data("counterup-func", null), i.callback.call(this))) : i.callback.call(this)
				};
	...
	({
		...
		2: [function (t, e, n) {
				...
				r.prototype = {
					...
					clone: function () {
						...
						o = n.values;
						for (var a in i)
							i.hasOwnProperty(a) && (t = i[a], e = {}
								.toString.call(t), "[object Array]" === e ? o[a] = t.slice(0) : "[object Number]" === e ? o[a] = t : console.error("unexpected color value:", t));
						return n
					}
				},
				r.prototype.spaces = {
				...
				r.prototype.setValues = function (t, e) {
					...
					var u;
					for (n = 0; n < t.length; n++)
						u = Math.max(0, Math.min(a[t][n], o[t][n])), o[t][n] = Math.round(u);
					for (var c in r)
						c !== t && (o[c] = i[t][c](o[t]));
					return !0
				},
		...
		3: [function (t, e, n) {
				...
				function h(t) {
					...
					l = t[2] / 100;
					if (0 == s)
						return r = 255 * l, [r, r, r];
					e = 2 * l - (n = l < .5 ? l * (1 + s) : l + s - l * s),
					o = [0, 0, 0];
					for (var u = 0; u < 3; u++)
						(i = a + 1 / 3 *  - (u - 1)) < 0 && i++, i > 1 && i--, r = 6 * i < 1 ? e + 6 * (n - e) * i : 2 * i < 1 ? n : 3 * i < 2 ? e + (n - e) * (2 / 3 - i) * 6 : e, o[u] = 255 * r;
					return o
				}
				function f(t) {
					var e,
				...
				function L(t) {
					...
					a = t[1],
					s = t[2];
					return r <= 8 ? (n = 100 * r / 903.3, o = n / 100 * 7.787 + 16 / 116) : (n = 100 * Math.pow((r + 16) / 116, 3), o = Math.pow(n / 100, 1 / 3)),
		...
		6: [function (t, e, n) {
				...
				(this, function () {
					...
					function g(t) {
						if (null == t._isValid) {
							var e = p(t),
							n = _i.call(e.parsedDateParts, function (t) {
									return null != t
								}),
					...
					function m(t) {
						var e = h(NaN);
						return null != t ? d(p(e), t) : p(e).userInvalidated = !0,
						e
					}
					function v(t, e) {
						var n,
						i,
						o;
						if (a(e._isAMomentObject) || (t._isAMomentObject = e._isAMomentObject), a(e._i) || (t._i = e._i), a(e._f) || (t._f = e._f), a(e._l) || (t._l = e._l), a(e._strict) || (t._strict = e._strict), a(e._tzm) || (t._tzm = e._tzm), a(e._isUTC) || (t._isUTC = e._isUTC), a(e._offset) || (t._offset = e._offset), a(e._pf) || (t._pf = p(e)), a(e._locale) || (t._locale = e._locale), ki.length > 0)
							for (n = 0; n < ki.length; n++)
								i = ki[n], o = e[i], a(o) || (t[i] = o);
						return t
					}
					function y(t) {
						v(this, t),
						...
						!1 === Ci && (Ci = !0, n.updateOffset(this), Ci = !1)
					}
					function b(t) {
					...
					function M(t, e) {
						...
						i = d({}, t);
						for (n in e)
							c(e, n) && (o(t[n]) && o(e[n]) ? (i[n] = {}, d(i[n], t[n]), d(i[n], e[n])) : null != e[n] ? i[n] = e[n] : delete i[n]);
						for (n in t)
							c(t, n) && !c(e, n) && o(t[n]) && (i[n] = d({}, i[n]));
						return i
					}
					function A(t) {
						null != t && this.set(t)
					...
					function L(t) {
						return "string" == typeof t ? Pi[t] || Pi[t.toLowerCase()] : void 0
					}
					function R(t) {
						var e,
						n,
					...
					function j(t, e) {
						return function (i) {
							return null != i ? (B(this, t, i), n.updateOffset(this, e), this) : H(this, t)
						}
					}
					function H(t, e) {
					...
					function q(t, e) {
						if ("object" == typeof t)
							for (var n = W(t = R(t)), i = 0; i < n.length; i++)
								this[n[i].unit](t[n[i].unit]);
						else if (t = L(t), T(this[t]))
							return this[t](e);
						return this
					}
					function U(t, e, n) {
					...
					function Q(t) {
						...
						for (e = 0, n = i.length; e < n; e++)
							Ri[i[e]] ? i[e] = Ri[i[e]] : i[e] = G(i[e]);
						return function (e) {
							var o,
							r = "";
							for (o = 0; o < n; o++)
								r += T(i[o]) ? i[o].call(e, t) : i[o];
							return r
						}
					}
					function X(t, e) {
						return t.isValid() ? (e = Z(e, t.localeData()), Li[e] = Li[e] || Q(e), Li[e](t)) : t.localeData().invalidDate()
					}
					function Z(t, e) {
						function n(t) {
						...
						var i = 5;
						for (Ni.lastIndex = 0; i >= 0 && Ni.test(t); )
							t = t.replace(Ni, n), Ni.lastIndex = 0, i -= 1;
						return t
					}
					function J(t, e, n) {
						no[t] = T(e) ? e : function (t, i) {
							return t && n ? n : e
						}
					}
					function K(t, e) {
						return c(no, t) ? no[t](e._strict, e._locale) : new RegExp(tt(t))
					}
					function tt(t) {
						return et(t.replace("\\", "").replace(/\\(\[)|\\(\])|\[([^\]\[]*)\]|\\(.)/g, function (t, e, n, i, o) {
								return e || n || i || o
							}))
					}
					function et(t) {
					...
					function it(t, e) {
						nt(t, function (t, n, i, o) {
							i._w = i._w || {},
							e(t, i._w, i, o)
						})
					}
					function ot(t, e, n) {
						null != e && c(io, t) && io[t](e, n._a, n, t)
					}
					function rt(t, e) {
						return new Date(Date.UTC(t, e + 1, 0)).getUTCDate()
					}
					function at(t, e) {
						return t ? i(this._months) ? this._months[t.month()] : this._months[(this._months.isFormat || go).test(e) ? "format" : "standalone"][t.month()] : i(this._months) ? this._months : this._months.standalone
					}
					function st(t, e) {
						return t ? i(this._monthsShort) ? this._monthsShort[t.month()] : this._monthsShort[go.test(e) ? "format" : "standalone"][t.month()] : i(this._monthsShort) ? this._monthsShort : this._monthsShort.standalone
					}
					function lt(t, e, n) {
						var i,
						o,
						...
						return n ? "MMM" === e ? (o = po.call(this._shortMonthsParse, a), -1 !== o ? o : null) : (o = po.call(this._longMonthsParse, a), -1 !== o ? o : null) : "MMM" === e ? (o = po.call(this._shortMonthsParse, a), -1 !== o ? o : (o = po.call(this._longMonthsParse, a), -1 !== o ? o : null)) : (o = po.call(this._longMonthsParse, a), -1 !== o ? o : (o = po.call(this._shortMonthsParse, a), -1 !== o ? o : null))
					}
					function ut(t, e, n) {
						var i,
						o,
					...
					function dt(t) {
						return null != t ? (ct(this, t), n.updateOffset(this, !0), this) : H(this, "Month")
					}
					function ht() {
					...
					function gt() {
						...
						r = [];
						for (e = 0; e < 12; e++)
							n = h([2e3, e]), i.push(this.monthsShort(n, "")), o.push(this.months(n, "")), r.push(this.months(n, "")), r.push(this.monthsShort(n, ""));
						for (i.sort(t), o.sort(t), r.sort(t), e = 0; e < 12; e++)
							i[e] = et(i[e]), o[e] = et(o[e]);
						for (e = 0; e < 24; e++)
							r[e] = et(r[e]);
					...
					function _t(t, e, n, i, o) {
						var r,
						a,
						s = 1 + 7 * (e - 1) + (7 + n - i) % 7 + wt(t, i, o);
						return s <= 0 ? (r = t - 1, a = mt(r) + s) : s > mt(t) ? (r = t + 1, a = s - mt(t)) : (r = t, a = s), {
							year: r,
							dayOfYear: a
						}
					}
					function kt(t, e, n) {
						...
						return a < 1 ? (o = t.year() - 1, i = a + Ct(o, e, n)) : a > Ct(t.year(), e, n) ? (i = a - Ct(t.year(), e, n), o = t.year() + 1) : (o = t.year(), i = a), {
							week: i,
							year: o
						}
					}
					...
					function Bt() {
						...
						u = [];
						for (e = 0; e < 7; e++)
							n = h([2e3, 1]).day(e), i = this.weekdaysMin(n, ""), o = this.weekdaysShort(n, ""), r = this.weekdays(n, ""), a.push(i), s.push(o), l.push(r), u.push(i), u.push(o), u.push(r);
						for (a.sort(t), s.sort(t), l.sort(t), u.sort(t), e = 0; e < 7; e++)
							s[e] = et(s[e]), l[e] = et(l[e]), u[e] = et(u[e]);
					...
					function Zt(t) {
						for (var e, n, i, o, r = 0; r < t.length; ) {
							for (e = (o = Xt(t[r]).split("-")).length, n = (n = Xt(t[r + 1])) ? n.split("-") : null; e > 0; ) {
								if (i = Jt(o.slice(0, e).join("-")))
									return i;
								if (n && n.length >= e && _(o, n, !0) >= e - 1)
									break;
								e--
							}
							r++
					...
					function Kt(t, e) {
						var n;
						return t && (n = a(e) ? ne(t) : te(t, e)) && (Mo = n),
						Mo._abbr
					}
					function te(t, e) {
						if (null !== e) {
							var n = Io;
							if (e.abbr = t, null != Oo[t])
								S("defineLocaleOverride", "use moment.updateLocale(localeName, config) to change an existing locale. moment.defineLocale(localeName, config) should only be used for creating a new locale See http://momentjs.com/guides/#/warnings/define-locale/ for more info."), n = Oo[t]._config;
							else if (null != e.parentLocale) {
								if (null == Oo[e.parentLocale])
									return Po[e.parentLocale] || (Po[e.parentLocale] = []), Po[e.parentLocale].push({
										name: t,
										config: e
									}), null;
								n = Oo[e.parentLocale]._config
							}
							return Oo[t] = new A(M(n, e)),
							Po[t] && Po[t].forEach(function (t) {
								te(t.name, t.config)
							}),
							Kt(t),
							Oo[t]
					...
					function ee(t, e) {
						if (null != e) {
							var n,
							i = Io;
							null != Oo[t] && (i = Oo[t]._config),
							(n = new A(e = M(i, e))).parentLocale = Oo[t],
							Oo[t] = n,
							Kt(t)
						} else
							null != Oo[t] && (null != Oo[t].parentLocale ? Oo[t] = Oo[t].parentLocale : null != Oo[t] && delete Oo[t]);
						return Oo[t]
					}
					function ne(t) {
						var e;
					...
					function oe(t) {
						var e,
						n = t._a;
						return n && -2 === p(t).overflow && (e = n[ro] < 0 || n[ro] > 11 ? ro : n[ao] < 1 || n[ao] > rt(n[oo], n[ro]) ? ao : n[so] < 0 || n[so] > 24 || 24 === n[so] && (0 !== n[lo] || 0 !== n[uo] || 0 !== n[co]) ? so : n[lo] < 0 || n[lo] > 59 ? lo : n[uo] < 0 || n[uo] > 59 ? uo : n[co] < 0 || n[co] > 999 ? co : -1, p(t)._overflowDayOfYear && (e < oo || e > ao) && (e = ao), p(t)._overflowWeeks && -1 === e && (e = ho), p(t)._overflowWeekday && -1 === e && (e = fo), p(t).overflow = e),
						t
					}
					function re(t) {
						var e,
						...
						if (l) {
							for (p(t).iso = !0, e = 0, n = Lo.length; e < n; e++)
								if (Lo[e][1].exec(l[1])) {
									o = Lo[e][0],
									i = !1 !== Lo[e][2];
									break
					...
					function ae(t) {
						...
						if (e = t._i.replace(/\([^\)]*\)|[\n\t]/g, " ").replace(/(\s\s+)/g, " ").replace(/^\s|\s$/g, ""), n = Wo.exec(e)) {
							if (i = n[1] ? "ddd" + (5 === n[1].length ? ", " : " ") : "", o = "D MMM " + (n[2].length > 10 ? "YYYY " : "YY "), r = "HH:mm" + (n[4] ? ":ss" : ""), n[1]) {
					...
					function se(t) {
						var e = zo.exec(t._i);
						return null !== e ? void(t._d = new Date(+e[1])) : (re(t), void(!1 === t._isValid && (delete t._isValid, ae(t), !1 === t._isValid && (delete t._isValid, n.createFromInputFallback(t)))))
					}
					function le(t, e, n) {
					...
					function ce(t) {
						...
						r = [];
						if (!t._d) {
							for (i = ue(t), t._w && null == t._a[ao] && null == t._a[ro] && de(t), null != t._dayOfYear && (o = le(t._a[oo], i[oo]), (t._dayOfYear > mt(o) || 0 === t._dayOfYear) && (p(t)._overflowDayOfYear = !0), n = xt(o, 0, t._dayOfYear), t._a[ro] = n.getUTCMonth(), t._a[ao] = n.getUTCDate()), e = 0; e < 3 && null == t._a[e]; ++e)
								t._a[e] = r[e] = i[e];
							for (; e < 7; e++)
								t._a[e] = r[e] = null == t._a[e] ? 2 === e ? 1 : 0 : t._a[e];
							24 === t._a[so] && 0 === t._a[lo] && 0 === t._a[uo] && 0 === t._a[co] && (t._nextDay = !0, t._a[so] = 0),
							t._d = (t._useUTC ? xt : bt).apply(null, r),
							null != t._tzm && t._d.setUTCMinutes(t._d.getUTCMinutes() - t._tzm),
							t._nextDay && (t._a[so] = 24)
						}
					}
					function de(t) {
						var e,
						...
						if (null != (e = t._w).GG || null != e.W || null != e.E)
							r = 1, a = 4, n = le(e.GG, t._a[oo], kt(xe(), 1, 4).year), i = le(e.W, 1), ((o = le(e.E, 1)) < 1 || o > 7) && (l = !0);
						else {
							r = t._locale._week.dow,
							a = t._locale._week.doy;
							var u = kt(xe(), r, a);
							n = le(e.gg, t._a[oo], u.year),
							i = le(e.w, u.week),
							null != e.d ? ((o = e.d) < 0 || o > 6) && (l = !0) : null != e.e ? (o = e.e + r, (e.e < 0 || e.e > 6) && (l = !0)) : o = r
						}
						i < 1 || i > Ct(n, r, a) ? p(t)._overflowWeeks = !0 : null != l ? p(t)._overflowWeekday = !0 : (s = _t(n, i, o, r, a), t._a[oo] = s.year, t._dayOfYear = s.dayOfYear)
					}
					function he(t) {
						if (t._f !== n.ISO_8601)
							if (t._f !== n.RFC_2822) {
								...
								l = s.length,
								u = 0;
								for (o = Z(t._f, t._locale).match(Fi) || [], e = 0; e < o.length; e++)
									r = o[e], (i = (s.match(K(r, t)) || [])[0]) && ((a = s.substr(0, s.indexOf(i))).length > 0 && p(t).unusedInput.push(a), s = s.slice(s.indexOf(i) + i.length), u += i.length), Ri[r] ? (i ? p(t).empty = !1 : p(t).unusedTokens.push(r), ot(r, i, t)) : t._strict && !i && p(t).unusedTokens.push(r);
								p(t).charsLeftOver = l - u,
								s.length > 0 && p(t).unusedInput.push(s),
								t._a[so] <= 12 && !0 === p(t).bigHour && t._a[so] > 0 && (p(t).bigHour = void 0),
								p(t).parsedDateParts = t._a.slice(0),
								p(t).meridiem = t._meridiem,
								t._a[so] = fe(t._locale, t._a[so], t._meridiem),
								ce(t),
								oe(t)
							} else
								ae(t);
					...
					function pe(t) {
						...
						for (o = 0; o < t._f.length; o++)
							r = 0, e = v({}, t), null != t._useUTC && (e._useUTC = t._useUTC), e._f = t._f[o], he(e), g(e) && (r += p(e).charsLeftOver, r += 10 * p(e).unusedTokens.length, p(e).score = r, (null == i || r < i) && (i = r, n = e));
						d(t, n || e)
					}
					function ge(t) {
						if (!t._d) {
					...
					function ve(t) {
						...
						null === e || void 0 === n && "" === e ? m({
							nullInput: !0
						}) : ("string" == typeof e && (t._i = e = t._locale.preparse(e)), b(e) ? new y(oe(e)) : (l(e) ? t._d = e : i(n) ? pe(t) : n ? he(t) : ye(t), g(t) || (t._d = null), t))
					}
					function ye(t) {
						var e = t._i;
						a(e) ? t._d = new Date(n.now()) : l(e) ? t._d = new Date(e.valueOf()) : "string" == typeof e ? se(t) : i(e) ? (t._a = u(e.slice(0), function (t) {
										return parseInt(t, 10)
									}), ce(t)) : o(e) ? ge(t) : s(e) ? t._d = new Date(e) : n.createFromInputFallback(t)
					}
					...
					function Ce(t) {
						for (var e in t)
							if (-1 === Vo.indexOf(e) || null != t[e] && isNaN(t[e]))
								return !1;
						for (var n = !1, i = 0; i < Vo.length; ++i)
							if (t[Vo[i]]) {
								if (n)
									return !1;
								parseFloat(t[Vo[i]]) !== w(t[Vo[i]]) && (n = !0)
							}
						return !0
					}
					function Se() {
					...
					function Ie(t, e) {
						...
						if (null === n)
							return null;
						var i = ((n[n.length - 1] || []) + "").match(qo) || ["-", 0, 0],
						o = 60 * i[1] + w(i[2]);
					...
					function Oe(t, e) {
						var i,
						o;
						return e._isUTC ? (i = e.clone(), o = (b(t) || l(t) ? t.valueOf() : xe(t).valueOf()) - i.valueOf(), i._d.setTime(i._d.valueOf() + o), n.updateOffset(i, !1), i) : xe(t).local()
					}
					function Pe(t) {
					...
					function $e(t, e, i) {
						...
						if (null != t) {
							...
							return !this._isUTC && e && (o = Pe(this)),
							this._offset = t,
							this._isUTC = !0,
							null != o && this.add(o, "m"),
							r !== t && (!e || this._changeInProgress ? Xe(this, qe(t - r, "m"), 1, !1) : this._changeInProgress || (this._changeInProgress = !0, n.updateOffset(this, !0), this._changeInProgress = null)),
							this
						}
					...
					function Le(t) {
						return this._isUTC && (this.utcOffset(0, t), this._isUTC = !1, t && this.subtract(Pe(this), "m")),
						this
					}
					function Re() {
						if (null != this._tzm)
					...
					function qe(t, e) {
						...
						return Me(t) ? r = {
						 ...
						 : s(t) ? (r = {}, e ? r[e] = t : r.milliseconds = t) : (a = Uo.exec(t)) ? (n = "-" === a[1] ? -1 : 1, r = {
								y: 0,
								d: w(a[ao]) * n,
								h: w(a[so]) * n,
								m: w(a[lo]) * n,
						 ...
						 : "object" == typeof r && ("from" in r || "to" in r) && (o = Ge(xe(r.from), xe(r.to)), r = {}, r.ms = o.milliseconds, r.M = o.months),
						i = new De(r),
						Me(t) && c(t, "_locale") && (i._locale = t._locale),
						i
					}
					function Ue(t, e) {
					...
					function Ge(t, e) {
						var n;
						return t.isValid() && e.isValid() ? (e = Oe(e, t), t.isBefore(e) ? n = Ye(t, e) : (n = Ye(e, t), n.milliseconds = -n.milliseconds, n.months = -n.months), n) : {
							milliseconds: 0,
							months: 0
						}
					}
					function Qe(t, e) {
						return function (n, i) {
							var o,
							r;
							return null === i || isNaN(+i) || (S(e, "moment()." + e + "(period, number) is deprecated. Please use moment()." + e + "(number, period). See http://momentjs.com/guides/#/warnings/add-inverted-param/ for more info."), r = n, n = i, i = r),
					...
					function Xe(t, e, i, o) {
						...
						a = Ae(e._days),
						s = Ae(e._months);
						t.isValid() && (o = null == o || o, r && t._d.setTime(t._d.valueOf() + r * i), a && B(t, "Date", H(t, "Date") + a * i), s && ct(t, H(t, "Month") + s * i), o && n.updateOffset(t, a || s))
					}
					function Ze(t, e) {
					...
					function Je(t, e) {
						...
						return this.format(a || this.localeData().calendar(r, this, xe(i)))
					}
					function Ke() {
						return new y(this)
					}
					function tn(t, e) {
						var n = b(t) ? t : xe(t);
						return !(!this.isValid() || !n.isValid()) && (e = L(a(e) ? "millisecond" : e), "millisecond" === e ? this.valueOf() > n.valueOf() : n.valueOf() < this.clone().startOf(e).valueOf())
					}
					function en(t, e) {
						var n = b(t) ? t : xe(t);
						return !(!this.isValid() || !n.isValid()) && (e = L(a(e) ? "millisecond" : e), "millisecond" === e ? this.valueOf() < n.valueOf() : this.clone().endOf(e).valueOf() < n.valueOf())
					}
					function nn(t, e, n, i) {
						return i = i || "()",
					...
					function sn(t, e, n) {
						...
						r,
						a;
						return this.isValid() ? (i = Oe(t, this), i.isValid() ? (o = 6e4 * (i.utcOffset() - this.utcOffset()), e = L(e), "year" === e || "month" === e || "quarter" === e ? (a = ln(this, i), "quarter" === e ? a /= 3 : "year" === e && (a /= 12)) : (r = this - i, a = "second" === e ? r / 1e3 : "minute" === e ? r / 6e4 : "hour" === e ? r / 36e5 : "day" === e ? (r - o) / 864e5 : "week" === e ? (r - o) / 6048e5 : r), n ? a : x(a)) : NaN) : NaN
					}
					function ln(t, e) {
						var n,
						i,
						...
						return e - r < 0 ? (n = t.clone().add(o - 1, "months"), i = (e - r) / (r - n)) : (n = t.clone().add(o + 1, "months"), i = (e - r) / (n - r)),
						 - (o + i) || 0
					}
					function un() {
					...
					function fn(t, e) {
						return this.isValid() && (b(t) && t.isValid() || xe(t).isValid()) ? qe({
							to: this,
							from: t
					...
					function vn(t) {
						var e;
						return void 0 === t ? this._locale._abbr : (null != (e = ne(t)) && (this._locale = e), this)
					}
					function yn() {
						return this._locale
					}
					...
					function Nn(t, e, n, i, o) {
						var r;
						return null == t ? kt(this, i, o).year : (r = Ct(t, i, o), e > r && (e = r), Ln.call(this, t, e, n, i, o))
					}
					...
					function Gn(t, e, n, i) {
						...
						r = t ? o._week.dow : 0;
						if (null != n)
							return Un(e, (n + r) % 7, i, "day");
						var a,
						l = [];
						for (a = 0; a < 7; a++)
							l[a] = Un(e, (a + r) % 7, i, "day");
						return l
					}
					function Qn(t, e) {
					...
					function ti() {
						var t = this._data;
						return this._milliseconds = or(this._milliseconds),
					...
					function ri() {
						...
						s = this._months,
						l = this._data;
						return r >= 0 && a >= 0 && s >= 0 || r <= 0 && a <= 0 && s <= 0 || (r += 864e5 * oi(si(s) + a), a = 0, s = 0),
					...
					var xi,
					wi,
					_i = wi = Array.prototype.some ? Array.prototype.some : function (t) {
						for (var e = Object(this), n = e.length >>> 0, i = 0; i < n; i++)
							if (i in e && t.call(this, e[i], i, e))
								return !0;
						return !1
					},
					ki = n.momentProperties = [],
					Ci = !1,
					Si = {};
					...
					var Ti,
					Di,
					Mi = Ti = Object.keys ? Object.keys : function (t) {
						var e,
						n = [];
						for (e in t)
							c(t, e) && n.push(e);
					...
					ho = 7,
					fo = 8,
					po = Di = Array.prototype.indexOf ? Array.prototype.indexOf : function (t) {
						var e;
					...
					nt(["MMM", "MMMM"], function (t, e, n, i) {
						...
						null != o ? e[ro] = o : p(n).invalidMonth = t
					});
					var go = /D[oD]?(\[[^\[\]]*\]|\s)+MMMM?/,
					...
					J("YYYYYY", Qi, Bi),
					nt(["YYYYY", "YYYYYY"], oo),
					nt("YYYY", function (t, e) {
						e[oo] = 2 === t.length ? n.parseTwoDigitYear(t) : w(t)
					}),
					nt("YY", function (t, e) {
						e[oo] = n.parseTwoDigitYear(t)
					}),
					nt("Y", function (t, e) {
						e[oo] = parseInt(t, 10)
					}),
					...
					Y("k", ["kk", 2], 0, qt),
					Y("hmm", 0, 0, function () {
						return "" + Vt.apply(this) + U(this.minutes(), 2)
					}),
					Y("hmmss", 0, 0, function () {
						return "" + Vt.apply(this) + U(this.minutes(), 2) + U(this.seconds(), 2)
					}),
					Y("Hmm", 0, 0, function () {
					...
					No = /Z|[+-]\d\d(?::?\d\d)?/,
					Lo = [["YYYYYY-MM-DD", /[+-]\d{6}-\d\d-\d\d/], ["YYYY-MM-DD", /\d{4}-\d\d-\d\d/], ["GGGG-[W]WW-E", /\d{4}-W\d\d-\d/], ["GGGG-[W]WW", /\d{4}-W\d\d/, !1], ["YYYY-DDD", /\d{4}-\d{3}/], ["YYYY-MM", /\d{4}-\d\d/, !1], ["YYYYYYMMDD", /[+-]\d{10}/], ["YYYYMMDD", /\d{8}/], ["GGGG[W]WWE", /\d{4}W\d{3}/], ["GGGG[W]WW", /\d{4}W\d{2}/, !1], ["YYYYDDD", /\d{7}/]],
					...
					nr.weekYear = On,
					nr.isoWeekYear = Pn,
					nr.quarter = nr.quarters = Rn,
					nr.month = dt,
					nr.daysInMonth = ht,
					nr.week = nr.weeks = Mt,
					nr.isoWeek = nr.isoWeeks = At,
					nr.weeksInYear = Fn,
					nr.isoWeeksInYear = $n,
					nr.date = Zo,
					nr.day = nr.days = Lt,
					...
					nr.dayOfYear = zn,
					nr.hour = nr.hours = Eo,
					nr.minute = nr.minutes = Jo,
					nr.second = nr.seconds = Ko,
					nr.millisecond = nr.milliseconds = er,
					nr.utcOffset = $e,
					nr.utc = Ne,
					nr.local = Le,
					nr.parseZone = Re,
					nr.hasAlignedHourOffset = ze,
					nr.isDST = We,
					nr.isLocal = He,
					nr.isUtcOffset = Be,
					nr.isUtc = Ve,
					...
					nr.zoneAbbr = jn,
					nr.zoneName = Hn,
					nr.dates = C("dates accessor is deprecated. Use date instead.", Zo),
					nr.months = C("months accessor is deprecated. Use month instead", dt),
					nr.years = C("years accessor is deprecated. Use year instead", xo),
					nr.zone = C("moment().zone is deprecated, use moment().utcOffset instead. http://momentjs.com/guides/#/warnings/zone/", Fe),
					nr.isDSTShifted = C("isDSTShifted is deprecated. See http://momentjs.com/guides/#/warnings/dst-shifted/ for more information", je);
					var ir = A.prototype;
					ir.calendar = E,
					ir.longDateFormat = I,
					ir.invalidDate = O,
					...
					ir.monthsParse = ut,
					ir.monthsRegex = pt,
					ir.monthsShortRegex = ft,
					ir.week = St,
					ir.firstDayOfYear = Dt,
					ir.firstDayOfWeek = Tt,
					ir.weekdays = Ot,
					ir.weekdaysMin = $t,
					ir.weekdaysShort = Pt,
					ir.weekdaysParse = Nt,
					ir.weekdaysRegex = Wt,
					ir.weekdaysShortRegex = jt,
					ir.weekdaysMinRegex = Ht,
					ir.isPM = Gt,
					ir.meridiem = Qt,
					Kt("en", {
					...
					n.lang = C("moment.lang is deprecated. Use moment.locale instead.", Kt),
					n.langData = C("moment.langData is deprecated. Use moment.localeData instead.", ne);
					var or = Math.abs,
					rr = ci("ms"),
					ar = ci("s"),
					sr = ci("m"),
					...
					kr.locale = vn,
					kr.localeData = yn,
					kr.toIsoString = C("toIsoString() is deprecated. Please use toISOString() instead (notice the capitals)", bi),
					kr.lang = Xo,
					Y("X", 0, 0, "unix"),
					Y("x", 0, 0, "valueOf"),
					J("x", Zi),
					...
					n.weekdaysShort = Jn,
					n.normalizeUnits = L,
					n.relativeTimeRounding = mi,
					n.relativeTimeThreshold = vi,
					n.calendarFormat = Ze,
					n.prototype = nr,
					n
				})
				...
				e.exports = function (t) {
					...
					t.controllers.bar = t.DatasetController.extend({
							...
							updateElement: function (t, n, i) {
								...
								t._xScale = o.getScaleForId(a.xAxisID),
								t._yScale = o.getScaleForId(a.yAxisID),
							...
							getStackCount: function (t) {
								...
								s = [];
								for (e = 0; e < a; ++e)
									(n = o.getDatasetMeta(e)).bar && o.isDatasetVisible(e) && (!1 === r || !0 === r && -1 === s.indexOf(n.stack) || void 0 === r && (void 0 === n.stack || -1 === s.indexOf(n.stack))) && s.push(n.stack);
								return s.length
							},
							...
							getRuler: function () {
								...
								s = a / o,
								l = s * i.barPercentage;
								return l = Math.min(e.getValueOrDefault(i.barThickness, l), e.getValueOrDefault(i.maxBarThickness, 1 / 0)), {
									stackCount: o,
									tickSize: r,
									categorySize: a,
									categorySpacing: r - a,
							...
							calculateBarValuePixels: function (t, e) {
								...
								if (p || void 0 === p && void 0 !== g)
									for (n = 0; n < t; ++n)
										(i = u.getDatasetMeta(n)).bar && i.stack === g && i.controller.getValueScaleId() === d.id && u.isDatasetVisible(n) && (o = Number(h[n].data[e]), (f < 0 && o < 0 || f >= 0 && o > 0) && (m += o));
								return r = d.getPixelForValue(m),
								a = d.getPixelForValue(m + f),
								s = (a - r) / 2, {
									size: s,
									base: r,
									head: a,
							...
							draw: function () {
								...
								a = o.length,
								s = 0;
								for (e.canvas.clipArea(i.ctx, i.chartArea); s < a; ++s)
									null === (t = r.data[s]) || void 0 === t || isNaN(t) || o[s].draw();
							...
							setHoverStyle: function (t) {
								...
								o = t.custom || {},
								r = t._model;
								r.backgroundColor = o.hoverBackgroundColor ? o.hoverBackgroundColor : e.getValueAtIndexOrDefault(n.hoverBackgroundColor, i, e.getHoverColor(r.backgroundColor)),
								r.borderColor = o.hoverBorderColor ? o.hoverBorderColor : e.getValueAtIndexOrDefault(n.hoverBorderColor, i, e.getHoverColor(r.borderColor)),
								r.borderWidth = o.hoverBorderWidth ? o.hoverBorderWidth : e.getValueAtIndexOrDefault(n.hoverBorderWidth, i, r.borderWidth)
							},
							removeHoverStyle: function (t) {
								...
								r.backgroundColor = o.backgroundColor ? o.backgroundColor : e.getValueAtIndexOrDefault(n.backgroundColor, i, a.backgroundColor),
								r.borderColor = o.borderColor ? o.borderColor : e.getValueAtIndexOrDefault(n.borderColor, i, a.borderColor),
								r.borderWidth = o.borderWidth ? o.borderWidth : e.getValueAtIndexOrDefault(n.borderWidth, i, a.borderWidth)
							}
						}),
				...
				e.exports = function (t) {
					...
					t.controllers.bubble = t.DatasetController.extend({
							...
							updateElement: function (n, i, o) {
								...
								e.extend(n, {
									...
									_model: {
										...
										hitRadius: u.hitRadius ? u.hitRadius : e.getValueAtIndexOrDefault(c.hitRadius, i, h.hitRadius)
									}
								}),
								t.DatasetController.prototype.removeHoverStyle.call(r, n, h);
								var p = n._model;
								p.skip = u.skip ? u.skip : isNaN(p.x) || isNaN(p.y),
								n.pivot()
							},
							...
							setHoverStyle: function (n) {
								...
								r = n._index,
								a = n.custom || {};
								n._model.radius = a.hoverRadius ? a.hoverRadius : e.getValueAtIndexOrDefault(o.hoverRadius, r, i.chart.options.elements.point.hoverRadius) + i.getRadius(o.data[r])
							},
				...
				e.exports = function (t) {
						...
						tooltips: {
							callbacks: {
								...
								label: function (t, n) {
									...
									return e.isArray(i) ? (i = i.slice(), i[0] += o) : i += o,
									i
								}
							}
						}
					...
					t.controllers.doughnut = t.controllers.pie = t.DatasetController.extend({
							...
							update: function (t) {
								...
								i.offsetX = c.x * i.outerRadius,
								i.offsetY = c.y * i.outerRadius,
							...
							updateElement: function (t, n, i) {
								...
								h = s.rotation,
								f = o.getDataset(),
								p = i && l.animateRotate ? 0 : t.hidden ? 0 : o.calculateCircumference(f.data[n]) * (s.circumference / (2 * Math.PI)),
								g = i && l.animateScale ? 0 : o.innerRadius,
								m = i && l.animateScale ? 0 : o.outerRadius,
								...
								i && l.animateRotate || (y.startAngle = 0 === n ? s.rotation : o.getMeta().data[n - 1]._model.endAngle, y.endAngle = y.startAngle + y.circumference),
								t.pivot()
							},
							removeHoverStyle: function (e) {
							...
							getMaxBorderWidth: function (t) {
								for (var e, n, i = 0, o = this.index, r = t.length, a = 0; a < r; a++)
									e = t[a]._model ? t[a]._model.borderWidth : 0, n = t[a]._chart ? t[a]._chart.config.data.datasets[o].hoverBorderWidth : 0, i = e > i ? e : i, i = n > i ? n : i;
								return i
							}
						})
				}
					...
					t.controllers.line = t.DatasetController.extend({
							...
							update: function (t) {
								...
								for (p && (r = l.custom || {}, void 0 !== f.tension && void 0 === f.lineTension && (f.lineTension = f.tension), l._scale = h, l._datasetIndex = a.index, l._children = u, l._model = {
										...
										}, l.pivot()), i = 0, o = u.length; i < o; ++i)
									a.updateElement(u[i], i, t);
								for (p && 0 !== l._model.tension && a.updateBezierControlPoints(), i = 0, o = u.length; i < o; ++i)
									u[i].pivot()
							},
							getPointBackgroundColor: function (t, e) {
								...
								o = this.getDataset(),
								r = t.custom || {};
								return r.backgroundColor ? i = r.backgroundColor : o.pointBackgroundColor ? i = n.getValueAtIndexOrDefault(o.pointBackgroundColor, e, i) : o.backgroundColor && (i = o.backgroundColor),
								i
							},
							getPointBorderColor: function (t, e) {
								...
								o = this.getDataset(),
								r = t.custom || {};
								return r.borderColor ? i = r.borderColor : o.pointBorderColor ? i = n.getValueAtIndexOrDefault(o.pointBorderColor, e, i) : o.borderColor && (i = o.borderColor),
								i
							},
							getPointBorderWidth: function (t, e) {
								...
								o = this.getDataset(),
								r = t.custom || {};
								return isNaN(r.borderWidth) ? isNaN(o.pointBorderWidth) ? isNaN(o.borderWidth) || (i = o.borderWidth) : i = n.getValueAtIndexOrDefault(o.pointBorderWidth, e, i) : i = r.borderWidth,
								i
							},
							updateElement: function (t, e, i) {
								...
								o = f.getPixelForValue("object" == typeof d ? d : NaN, e, c, g),
								r = i ? h.getBasePixel() : a.calculatePointY(d, e, c),
								t._xScale = f,
								t._yScale = h,
								t._datasetIndex = c,
								t._index = e,
							...
							calculatePointY: function (t, e, n) {
								...
								if (u.options.stacked) {
									for (i = 0; i < n; i++)
										if (o = s.data.datasets[i], "line" === (r = s.getDatasetMeta(i)).type && r.yAxisID === u.id && s.isDatasetVisible(i)) {
							...
							updateBezierControlPoints: function () {
								...
								if (l.dataset._model.spanGaps && (c = c.filter(function (t) {
									...
									for (e = 0, i = c.length; e < i; ++e)
										o = c[e], r = o._model, a = n.splineCurve(n.previousItem(c, e)._model, r, n.nextItem(c, e)._model, l.dataset._model.tension), r.controlPointPreviousX = a.previous.x, r.controlPointPreviousY = a.previous.y, r.controlPointNextX = a.next.x, r.controlPointNextY = a.next.y;
								if (s.chart.options.elements.line.capBezierPoints)
									for (e = 0, i = c.length; e < i; ++e)
										r = c[e]._model, r.controlPointPreviousX = t(r.controlPointPreviousX, u.left, u.right), r.controlPointPreviousY = t(r.controlPointPreviousY, u.top, u.bottom), r.controlPointNextX = t(r.controlPointNextX, u.left, u.right), r.controlPointNextY = t(r.controlPointNextY, u.top, u.bottom)
							},
							draw: function () {
								var n = this,
								i = n.chart,
								...
								s = r.length,
								l = 0;
								for (t.canvasHelpers.clipArea(i.ctx, a), e(n.getDataset(), i.options) && o.dataset.draw(), t.canvasHelpers.unclipArea(i.ctx); l < s; ++l)
									r[l].draw(a)
							},
							setHoverStyle: function (t) {
								...
								o = t.custom || {},
								r = t._model;
								r.radius = o.hoverRadius || n.getValueAtIndexOrDefault(e.pointHoverRadius, i, this.chart.options.elements.point.hoverRadius),
								r.backgroundColor = o.hoverBackgroundColor || n.getValueAtIndexOrDefault(e.pointHoverBackgroundColor, i, n.getHoverColor(r.backgroundColor)),
								r.borderColor = o.hoverBorderColor || n.getValueAtIndexOrDefault(e.pointHoverBorderColor, i, n.getHoverColor(r.borderColor)),
								r.borderWidth = o.hoverBorderWidth || n.getValueAtIndexOrDefault(e.pointHoverBorderWidth, i, r.borderWidth)
							},
							removeHoverStyle: function (t) {
								var e = this,
								...
								a.radius = r.radius || n.getValueAtIndexOrDefault(i.pointRadius, o, e.chart.options.elements.point.radius),
								a.backgroundColor = e.getPointBackgroundColor(t, o),
								a.borderColor = e.getPointBorderColor(t, o),
								a.borderWidth = e.getPointBorderWidth(t, o)
							}
						})
				}
			}, {}
		...
		19: [function (t, e, n) {
				...
				e.exports = function (t) {
							...
							labels: {
								generateLabels: function (t) {
									...
									return n.labels.length && n.datasets.length ? n.labels.map(function (i, o) {
										...
										return {
											text: i,
											fillStyle: s.backgroundColor ? s.backgroundColor : l(a.backgroundColor, o, u.backgroundColor),
											strokeStyle: s.borderColor ? s.borderColor : l(a.borderColor, o, u.borderColor),
											lineWidth: s.borderWidth ? s.borderWidth : l(a.borderWidth, o, u.borderWidth),
											hidden: isNaN(a.data[o]) || r.data[o].hidden,
											index: o
										}
									}) : []
					...
					t.controllers.polarArea = t.DatasetController.extend({
							...
							updateElement: function (t, n, i) {
								for (var o = this, r = o.chart, a = o.getDataset(), s = r.options, l = s.animation, u = r.scale, c = e.getValueAtIndexOrDefault, d = r.data.labels, h = o.calculateCircumference(a.data[n]), f = u.xCenter, p = u.yCenter, g = 0, m = o.getMeta(), v = 0; v < n; ++v)
									isNaN(a.data[v]) || m.data[v].hidden || ++g;
								var y = s.startAngle,
								b = t.hidden ? 0 : u.getDistanceFromCenterForValue(a.data[n]),
								x = y + h * g,
								w = x + (t.hidden ? 0 : h),
								_ = l.animateScale ? 0 : u.getDistanceFromCenterForValue(a.data[n]);
								e.extend(t, {
									_datasetIndex: o.index,
									_index: n,
									_scale: u,
				...
				e.exports = function (t) {
					...
					t.controllers.radar = t.DatasetController.extend({
							...
							updateElement: function (t, n, i) {
								...
								u = s.getPointPositionForValue(n, a.data[n]);
								...
								e.extend(t, {
									...
									_model: {
										x: i ? s.xCenter : u.x,
										y: i ? s.yCenter : u.y,
										tension: r.tension ? r.tension : e.getValueOrDefault(a.lineTension, o.chart.options.elements.line.tension),
										radius: r.radius ? r.radius : e.getValueAtIndexOrDefault(a.pointRadius, n, l.radius),
										backgroundColor: r.backgroundColor ? r.backgroundColor : e.getValueAtIndexOrDefault(a.pointBackgroundColor, n, l.backgroundColor),
										borderColor: r.borderColor ? r.borderColor : e.getValueAtIndexOrDefault(a.pointBorderColor, n, l.borderColor),
										borderWidth: r.borderWidth ? r.borderWidth : e.getValueAtIndexOrDefault(a.pointBorderWidth, n, l.borderWidth),
										pointStyle: r.pointStyle ? r.pointStyle : e.getValueAtIndexOrDefault(a.pointStyle, n, l.pointStyle),
										hitRadius: r.hitRadius ? r.hitRadius : e.getValueAtIndexOrDefault(a.pointHitRadius, n, l.hitRadius)
									}
								}),
							...
							updateBezierControlPoints: function () {
								...
								e.each(n.data, function (i, o) {
									var r = i._model,
									a = e.splineCurve(e.previousItem(n.data, o, !0)._model, r, e.nextItem(n.data, o, !0)._model, r.tension);
							...
							setHoverStyle: function (t) {
								...
								o = t._index,
								r = t._model;
								r.radius = i.hoverRadius ? i.hoverRadius : e.getValueAtIndexOrDefault(n.pointHoverRadius, o, this.chart.options.elements.point.hoverRadius),
								r.backgroundColor = i.hoverBackgroundColor ? i.hoverBackgroundColor : e.getValueAtIndexOrDefault(n.pointHoverBackgroundColor, o, e.getHoverColor(r.backgroundColor)),
								r.borderColor = i.hoverBorderColor ? i.hoverBorderColor : e.getValueAtIndexOrDefault(n.pointHoverBorderColor, o, e.getHoverColor(r.borderColor)),
								r.borderWidth = i.hoverBorderWidth ? i.hoverBorderWidth : e.getValueAtIndexOrDefault(n.pointHoverBorderWidth, o, r.borderWidth)
							},
							removeHoverStyle: function (t) {
								var n = this.chart.data.datasets[t._datasetIndex],
								i = t.custom || {},
								...
								r.radius = i.radius ? i.radius : e.getValueAtIndexOrDefault(n.pointRadius, o, a.radius),
								r.backgroundColor = i.backgroundColor ? i.backgroundColor : e.getValueAtIndexOrDefault(n.pointBackgroundColor, o, a.backgroundColor),
								r.borderColor = i.borderColor ? i.borderColor : e.getValueAtIndexOrDefault(n.pointBorderColor, o, a.borderColor),
								r.borderWidth = i.borderWidth ? i.borderWidth : e.getValueAtIndexOrDefault(n.pointBorderWidth, o, a.borderWidth)
							}
						})
				}
			}, {}
		...
		21: [function (t, e, n) {
				...
				e.exports = function (t) {
					...
					t.animationService = {
						...
						advance: function (t) {
							for (var n, i, o = this.animations, r = 0; r < o.length; )
								n = o[r], i = n.chart, n.currentStep = (n.currentStep || 0) + t, n.currentStep = Math.min(n.currentStep, n.numSteps), e.callback(n.render, [i, n], i), e.callback(n.onAnimationProgress, [n], i), n.currentStep >= n.numSteps ? (e.callback(n.onAnimationComplete, [n], i), i.animating = !1, o.splice(r, 1)) : ++r
						}
					},
		...
		22: [function (t, e, n) {
				...
				e.exports = function (t) {
					...
					e.drawPoint = function (e, n, i, o, r) {
						var a,
						s,
						l,
						u,
						...
						if ("object" != typeof n || "[object HTMLImageElement]" !== (a = n.toString()) && "[object HTMLCanvasElement]" !== a) {
							if (!(isNaN(i) || i <= 0)) {
								...
								default:
									e.beginPath(),
									e.arc(o, r, i, 0, 2 * Math.PI),
									e.closePath(),
									e.fill();
									break;
								case "triangle":
									e.beginPath(),
									c = (s = 3 * i / Math.sqrt(3)) * Math.sqrt(3) / 2,
									e.moveTo(o - s / 2, r + c / 3),
									e.lineTo(o + s / 2, r + c / 3),
									e.lineTo(o, r - 2 * c / 3),
									e.closePath(),
									e.fill();
									break;
								case "rect":
									d = 1 / Math.SQRT2 * i,
									e.beginPath(),
									e.fillRect(o - d, r - d, 2 * d, 2 * d),
									e.strokeRect(o - d, r - d, 2 * d, 2 * d);
									break;
								case "rectRounded":
									var h = i / Math.SQRT2,
									f = o - h,
									p = r - h,
									g = Math.SQRT2 * i;
									t.helpers.drawRoundedRectangle(e, f, p, g, g, i / 2),
									e.fill();
									break;
								case "rectRot":
									d = 1 / Math.SQRT2 * i,
							...
							e.drawImage(n, o - n.width / 2, r - n.height / 2, n.width, n.height)
					},
		...
		23: [function (t, e, n) {
				...
				e.exports = function (t) {
					function e(e) {
						...
						n.labels = n.labels || [],
						e.options = o.configMerge(t.defaults.global, t.defaults[e.type], e.options || {}),
						e
					}
					function n(t) {
						var e = t.options;
					...
					o.extend(t.prototype, {
						...
						updateLayout: function () {
							var e = this;
							!1 !== r.notify(e, "beforeLayout") && (t.layoutService.update(this, this.width, this.height), r.notify(e, "afterScaleUpdate"), r.notify(e, "afterLayout"))
						},
						...
						updateDataset: function (t) {
							...
							!1 !== r.notify(e, "beforeDatasetUpdate", [i]) && (n.controller.update(), r.notify(e, "afterDatasetUpdate", [i]))
						},
						render: function (e, n) {
							var i = this;
						...
						draw: function (t) {
							...
							void 0 !== t && null !== t || (t = 1),
							e.transition(t),
							!1 !== r.notify(e, "beforeDraw", [t]) && (o.each(e.boxes, function (t) {
									t.draw(e.chartArea)
						...
						drawDataset: function (t, e) {
							...
							!1 !== r.notify(n, "beforeDatasetDraw", [o]) && (i.controller.draw(e), r.notify(n, "afterDatasetDraw", [o]))
						},
						...
						destroy: function () {
							...
							l && (s.unbindEvents(), o.clear(s), a.releaseContext(s.ctx), s.canvas = null, s.ctx = null),
							r.notify(s, "destroy"),
						...
						eventHandler: function (t) {
							...
							if (!1 !== r.notify(e, "beforeEvent", [t])) {
								...
								return o ? e.render(o.duration, o.lazy) : i && !e.animating && (e.stop(), e.render(e.options.hover.animationDuration, !0)),
								e._bufferedRender = !1,
								e._bufferedRequest = null,
								e
							}
						...
						handleEvent: function (t) {
							...
							r = !o.arrayEquals(e.active, e.lastActive),
				...
				e.exports = function (t) {
					...
					i.extend(t.DatasetController.prototype, {
						...
						buildOrUpdateElements: function () {
							...
							i = t.getDataset(),
							o = i.data || (i.data = []);
							t._data !== o && (t._data && n(t._data, t), e(o, t), t._data = o),
							t.resyncElements()
						},
						update: i.noop,
						transition: function (t) {
						...
						removeHoverStyle: function (t, e) {
							...
							s = t._model;
							s.backgroundColor = r.backgroundColor ? r.backgroundColor : a(n.backgroundColor, o, e.backgroundColor),
							s.borderColor = r.borderColor ? r.borderColor : a(n.borderColor, o, e.borderColor),
							s.borderWidth = r.borderWidth ? r.borderWidth : a(n.borderWidth, o, e.borderWidth)
						},
						setHoverStyle: function (t) {
							var e = this.chart.data.datasets[t._datasetIndex],
							n = t._index,
							...
							a = i.getHoverColor,
							s = t._model;
							s.backgroundColor = o.hoverBackgroundColor ? o.hoverBackgroundColor : r(e.hoverBackgroundColor, n, a(s.backgroundColor)),
							s.borderColor = o.hoverBorderColor ? o.hoverBorderColor : r(e.hoverBorderColor, n, a(s.borderColor)),
							s.borderWidth = o.hoverBorderWidth ? o.hoverBorderWidth : r(e.hoverBorderWidth, n, s.borderWidth)
						},
				...
				e.exports = function (t) {
					...
					n.extend(t.Element.prototype, {
						...
						transition: function (t) {
							...
							o = n._start,
							r = n._view;
							return i && 1 !== t ? (r || (r = n._view = {}), o || (o = n._start = {}), e(o, r, i, t), n) : (n._view = i, n._start = null, n)
						},
				...
				e.exports = function (t) {
					...
					r.configMerge = function (e) {
						...
						return r.each(Array.prototype.slice.call(arguments, 1), function (e) {
							r.each(e, function (e, i) {
								...
								a = o ? n[i] : {};
								"scales" === i ? n[i] = r.scaleMerge(a, e) : "scale" === i ? n[i] = r.configMerge(a, t.scaleService.getScaleDefaults(e.type), e) : !o || "object" != typeof a || r.isArray(a) || null === a || "object" != typeof e || r.isArray(e) ? n[i] = e : n[i] = r.configMerge(a, e)
							})
						}),
						n
					},
					r.scaleMerge = function (e, n) {
						...
						return r.each(n, function (e, n) {
							"xAxes" === n || "yAxes" === n ? i.hasOwnProperty(n) ? r.each(e, function (e, o) {
								var a = r.getValueOrDefault(e.type, "xAxes" === n ? "category" : "linear"),
								s = t.scaleService.getScaleDefaults(a);
								o >= i[n].length || !i[n][o].type ? i[n].push(r.configMerge(s, e)) : e.type && e.type !== i[n][o].type ? i[n][o] = r.configMerge(i[n][o], s, e) : i[n][o] = r.configMerge(i[n][o], e)
							}) : (i[n] = [], r.each(e, function (e) {
									var o = r.getValueOrDefault(e.type, "xAxes" === n ? "category" : "linear");
									i[n].push(r.configMerge(t.scaleService.getScaleDefaults(o), e))
					...
					r.splineCurveMonotone = function (t) {
						...
						h;
						for (e = 0; e < s - 1; ++e)
							i = a[e], o = a[e + 1], i.model.skip || o.model.skip || (r.almostEquals(i.deltaK, 0, this.EPSILON) ? i.mK = o.mK = 0 : (u = i.mK / i.deltaK, c = o.mK / i.deltaK, (h = Math.pow(u, 2) + Math.pow(c, 2)) <= 9 || (d = 3 / Math.sqrt(h), i.mK = u * d * i.deltaK, o.mK = c * d * i.deltaK)));
						var f;
						for (e = 0; e < s; ++e)
							(i = a[e]).model.skip || (n = e > 0 ? a[e - 1] : null, o = e < s - 1 ? a[e + 1] : null, n && !n.model.skip && (f = (i.model.x - n.model.x) / 3, i.model.controlPointPreviousX = i.model.x - f, i.model.controlPointPreviousY = i.model.y - f * i.mK), o && !o.model.skip && (f = (o.model.x - i.model.x) / 3, i.model.controlPointNextX = i.model.x + f, i.model.controlPointNextY = i.model.y + f * i.mK))
					},
					...
					r.getRelativePosition = function (t, e) {
						...
						return n = Math.round((n - s.left - u) / f * a.width / e.currentDevicePixelRatio),
						i = Math.round((i - s.top - c) / p * a.height / e.currentDevicePixelRatio), {
							x: n,
							y: i
						}
					},
					...
					r.longestText = function (t, e, n, i) {
						...
						i.font !== e && (o = i.data = {}, a = i.garbageCollect = [], i.font = e),
						t.font = e;
						var s = 0;
						r.each(n, function (e) {
					...
					r.measureText = function (t, e, n, i, o) {
						var r = e[o];
						return r || (r = e[o] = t.measureText(o).width, n.push(o)),
						r > i && (i = r),
						i
					},
					...
					r.drawRoundedRectangle = function (t, e, n, i, o, r) {
						t.beginPath(),
						t.moveTo(e + r, n),
						t.lineTo(e + i - r, n),
		...
		27: [function (t, e, n) {
				...
				e.exports = function (t) {
					...
					function o(t, e, i, o) {
						...
						s = [];
						return o || (o = a.distanceBetweenPoints),
						n(t, function (t) {
							if (!i || t.inRange(e.x, e.y)) {
								var n = t.getCenterPoint(),
								a = o(e, n);
								a < r ? (s = [t], r = a) : a === r && s.push(t)
							}
						}),
						s
					}
					...
					t.layoutService = {
						...
						configure: function (t, e, n) {
							for (var i, o = ["fullWidth", "position", "weight"], r = o.length, a = 0; a < r; ++a)
								i = o[a], n.hasOwnProperty(i) && (e[i] = n[i])
						},
						update: function (t, o, r) {
							function a(t) {
								var e,
								n = t.isHorizontal();
								n ? (e = t.update(t.fullWidth ? w : T, S), D -= e.height) : (e = t.update(C, k), T -= e.width),
								M.push({
									horizontal: n,
									minSize: e,
									box: t
							...
							function s(t) {
								...
								if (e)
									if (t.isHorizontal()) {
										...
										t.update(t.fullWidth ? w : T, _ / 2, n)
									} else
										t.update(e.minSize.width, D)
							}
							function l(t) {
								var e = i.findNextWhere(M, function (e) {
										return e.box === t
							...
							function u(t) {
								t.isHorizontal() ? (t.left = t.fullWidth ? h : P, t.right = t.fullWidth ? o - f : P + T, t.top = H, t.bottom = H + t.height, H = t.bottom) : (t.left = j, t.right = j + t.width, t.top = F, t.bottom = F + D, j = t.right)
							}
							if (t) {
				...
				e.exports = function (t) {
					...
					t.plugins = {
						...
						notify: function (t, e, n) {
							...
							u = l.length;
							for (i = 0; i < u; ++i)
								if (o = l[i], r = o.plugin, "function" == typeof(s = r[e]) && ((a = [t].concat(n || [])).push(o.options), !1 === s.apply(r, a)))
									return !1;
							return !0
						},
						descriptors: function (n) {
							...
							return this._plugins.concat(a.plugins || []).forEach(function (t) {
								if (-1 === o.indexOf(t)) {
									var n = t.id,
									i = l[n];
									!1 !== i && (!0 === i && (i = e.clone(s[n])), o.push(t), r.push({
											plugin: t,
											options: i || {}
										}))
								}
		...
		31: [function (t, e, n) {
				...
				e.exports = function (t) {
					...
					function n(e) {
						...
						o = t.defaults.global,
						r = n(e.fontSize, o.defaultFontSize),
						a = n(e.fontStyle, o.defaultFontStyle),
					...
					t.Scale = t.Element.extend({
							...
							calculateTickRotation: function () {
								...
								if (t.options.display && t.isHorizontal())
									for (var s, l = i.longestText(e, r.font, t.ticks, t.longestTextCache), u = l, c = t.getPixelForTick(1) - t.getPixelForTick(0) - 6; u > c && a < o.maxRotation; ) {
										var d = i.toRadians(a);
							...
							fit: function () {
								...
								if (o.width = c ? t.isFullWidth() ? t.maxWidth - t.margins.left - t.margins.right : t.maxWidth : u && l.drawTicks ? f : 0, o.height = c ? u && l.drawTicks ? f : 0 : t.maxHeight, s.display && u && (c ? o.height += h : o.width += h), a.display && u) {
									var p = i.longestText(t.ctx, d.font, t.ticks, t.longestTextCache),
									...
									if (c) {
										...
										o.height = Math.min(t.maxHeight, o.height + b),
										t.ctx.font = d.font;
										var x = t.ticks[0],
										w = e(t.ctx, x, d.font),
										_ = t.ticks[t.ticks.length - 1],
										k = e(t.ctx, _, d.font);
										0 !== t.labelRotation ? (t.paddingLeft = "bottom" === r.position ? y * w + 3 : y * m + 3, t.paddingRight = "bottom" === r.position ? y * m + 3 : y * k + 3) : (t.paddingLeft = w / 2 + 3, t.paddingRight = k / 2 + 3)
									} else
										a.mirror ? p = 0 : p += t.options.ticks.padding, o.width = Math.min(t.maxWidth, o.width + p), t.paddingTop = d.size / 2, t.paddingBottom = d.size / 2
								}
								t.handleMargins(),
								t.width = o.width,
								t.height = o.height
							...
							getPixelForTick: function (t, e) {
								...
								return n.top + t * (a / (n.ticks.length - 1))
							},
							...
							draw: function (e) {
								...
								if (r.display) {
									...
									var m = i.getValueOrDefault(c.fontColor, u.defaultFontColor),
									v = n(c),
									...
									if (i.each(o.ticks, function (t, n) {
											if (void 0 !== t && null !== t) {
												...
												if ((!(a > 1 && n % a > 0 || n % a == 0 && n + a >= o.ticks.length) || s) && void 0 !== t && null !== t) {
													var l,
													h,
													p,
													m;
													...
													F = "middle";
													if (g) {
														"bottom" === r.position ? (F = f ? "middle" : "top", $ = f ? "right" : "center", P = o.top + y) : (F = f ? "middle" : "bottom", $ = f ? "left" : "center", P = o.bottom - y);
														var N = o.getPixelForTick(n) + i.aliasPixel(l);
														O = o.getPixelForTick(n, d.offsetGridLines) + c.labelOffset,
														v = x = k = E = N,
														b = D,
														_ = M,
														A = e.top,
														...
														R = "left" === r.position,
														z = c.padding;
														c.mirror ? ($ = R ? "left" : "right", L = z) : ($ = R ? "right" : "left", L = y + z),
														O = R ? o.right - L : o.left + L;
														var W = o.getPixelForTick(n);
														W += i.aliasPixel(l),
														P = o.getPixelForTick(n, d.offsetGridLines),
														v = S,
														x = T,
														k = e.left,
														E = e.right,
											...
											if (d.display && (l.save(), l.lineWidth = t.glWidth, l.strokeStyle = t.glColor, l.setLineDash && (l.setLineDash(t.glBorderDash), l.lineDashOffset = t.glBorderDashOffset), l.beginPath(), d.drawTicks && (l.moveTo(t.tx1, t.ty1), l.lineTo(t.tx2, t.ty2)), d.drawOnChartArea && (l.moveTo(t.x1, t.y1), l.lineTo(t.x2, t.y2)), l.stroke(), l.restore()), c.display) {
												l.save(),
											...
											I = 0;
											if (g)
												A = o.left + (o.right - o.left) / 2, E = "bottom" === r.position ? o.bottom - x.size / 2 : o.top + x.size / 2;
											else {
												var O = "left" === r.position;
												A = O ? o.left + x.size / 2 : o.right - x.size / 2,
												E = o.top + (o.bottom - o.top) / 2,
												I = O ?  - .5 * Math.PI : .5 * Math.PI
											}
											l.save(),
											l.translate(A, E),
											l.rotate(I),
									...
									if (d.drawBorder) {
										...
										F = o.top,
										N = o.bottom,
										L = i.aliasPixel(l.lineWidth);
										g ? (F = N = "top" === r.position ? o.bottom : o.top, F += L, N += L) : (P = $ = "left" === r.position ? o.right : o.left, P += L, $ += L),
										l.beginPath(),
										l.moveTo(P, F),
										l.lineTo($, N),
										l.stroke()
					...
					t.Ticks = {
						generators: {
							linear: function (t, n) {
								...
								t.min && t.max && t.stepSize && e.almostWhole((t.max - t.min) / t.stepSize, i / 1e3) && (a = t.min, s = t.max);
								var l = (s - a) / i;
							...
							logarithmic: function (t, n) {
								...
								s = a(t.min, Math.pow(10, Math.floor(e.log10(n.min)))),
								l = Math.floor(e.log10(n.max)),
								u = Math.ceil(n.max / Math.pow(10, l));
								0 === s ? (i = Math.floor(e.log10(n.minNotZero)), o = Math.floor(n.minNotZero / Math.pow(10, i)), r.push(s), s = o * Math.pow(10, i)) : (i = Math.floor(e.log10(s)), o = Math.floor(s / Math.pow(10, i)));
								do {
									r.push(s),
									10 === ++o && (o = 1, ++i),
									s = o * Math.pow(10, i)
		...
		34: [function (t, e, n) {
				...
				e.exports = function (t) {
					...
					function r(t, e) {
						...
						return n.font = l.fontString(c, e._titleFontStyle, e._titleFontFamily),
						l.each(e.title, p),
						n.font = l.fontString(d, e._bodyFontStyle, e._bodyFontFamily),
						l.each(e.beforeBody.concat(e.afterBody), p),
					...
					function s(t, e, n) {
						...
						"top" === u ? o += c : o -= "bottom" === u ? e.height + c : e.height / 2,
						"center" === u ? "left" === l ? i += c : "right" === l && (i -= c) : "left" === l ? i -= d : "right" === l && (i += d), {
							x: i,
							y: o
						}
					}
					...
					t.Tooltip = t.Element.extend({
							...
							getBody: function (t, e) {
								...
								return l.each(t, function (t) {
									...
									n(a.before, o.beforeLabel.call(i, t, e)),
									n(a.lines, o.label.call(i, t, e)),
									n(a.after, o.afterLabel.call(i, t, e)),
									r.push(a)
								}),
								r
							},
							...
							update: function (e) {
								...
								if (p.length) {
									...
									l.each(w, function (t) {
										x.push(d.callbacks.labelColor.call(c, t, c._chart))
									}),
									f.title = c.getTitle(w, g),
									f.beforeBody = c.getBeforeBody(w, g),
									f.body = c.getBody(w, g),
									f.afterBody = c.getAfterBody(w, g),
									f.footer = c.getFooter(w, g),
									f.x = Math.round(b.x),
									f.y = Math.round(b.y),
									f.caretPadding = d.caretPadding,
									f.labelColors = x,
									f.dataPoints = w,
									v = s(f, y = r(this, f), m = a(this, y))
								} else
									f.opacity = 0;
							...
							getCaretPosition: function (t, e, n) {
								...
								m = e.height;
								if ("center" === h)
									s = p + m / 2, "left" === d ? (i = f, o = i - u, r = i, a = s + u, l = s - u) : (i = f + g, o = i + u, r = i, a = s - u, l = s + u);
								else if ("left" === d ? (o = f + c + u, i = o - u, r = o + u) : "right" === d ? (o = f + g - c - u, i = o - u, r = o + u) : (o = f + g / 2, i = o - u, r = o + u), "top" === h)
									a = p, s = a - u, l = a;
								else {
									s = (a = p + m) + u,
									l = a;
							...
							drawTitle: function (t, n, i, o) {
								...
								if (r.length) {
									...
									for (u = 0, c = r.length; u < c; ++u)
										i.fillText(r[u], t.x, t.y), t.y += a + s, u + 1 === r.length && (t.y += n.titleMarginBottom - s)
								}
							},
							drawBody: function (t, n, i, o) {
								...
								l.each(s, function (a, s) {
									...
									l.each(a.lines, function (a) {
										h && (i.fillStyle = e(n.legendColorBackground, o), i.fillRect(t.x, t.y, r, r), i.strokeStyle = e(n.labelColors[s].borderColor, o), i.strokeRect(t.x, t.y, r, r), i.fillStyle = e(n.labelColors[s].backgroundColor, o), i.fillRect(t.x + 1, t.y + 1, r - 2, r - 2), i.fillStyle = u),
										d(a)
									}),
									l.each(a.after, d)
								}),
							...
							drawFooter: function (t, n, i, o) {
								var r = n.footer;
								r.length && (t.y += n.footerMarginTop, i.textAlign = n._footerAlign, i.textBaseline = "top", i.fillStyle = e(n.footerFontColor, o), i.font = l.fontString(n.footerFontSize, n._footerFontStyle, n._footerFontFamily), l.each(r, function (e) {
				...
				e.exports = function (t) {
					...
					t.elements.Arc = t.Element.extend({
							...
							inRange: function (t, n) {
								var i = this._view;
								if (i) {
									for (var o = e.getAngleFromPoint(i, {
												x: t,
												y: n
											}), r = o.angle, a = o.distance, s = i.startAngle, l = i.endAngle; l < s; )
										l += 2 * Math.PI;
									for (; r > l; )
										r -= 2 * Math.PI;
									for (; r < s; )
										r += 2 * Math.PI;
									var u = r >= s && r <= l,
									c = a >= i.innerRadius && a <= i.outerRadius;
									return u && c
								}
								return !1
							},
				...
				e.exports = function (t) {
					...
					t.elements.Line = t.Element.extend({
							draw: function () {
								...
								d = n.elements.line,
								h = -1;
								for (a._loop && c.length && c.push(c[0]), l.save(), l.lineCap = s.borderCapStyle || d.borderCapStyle, l.setLineDash && l.setLineDash(s.borderDash || d.borderDash), l.lineDashOffset = s.borderDashOffset || d.borderDashOffset, l.lineJoin = s.borderJoinStyle || d.borderJoinStyle, l.lineWidth = s.borderWidth || d.borderWidth, l.strokeStyle = s.borderColor || n.defaultColor, l.beginPath(), h = -1, t = 0; t < c.length; ++t)
									i = c[t], o = e.previousItem(c, t), r = i._view, 0 === t ? r.skip || (l.moveTo(r.x, r.y), h = t) : (o = -1 === h ? o : c[h], r.skip || (h !== t - 1 && !u || -1 === h ? l.moveTo(r.x, r.y) : e.canvas.lineTo(l, o._view, i._view), h = t));
								l.stroke(),
								l.restore()
							}
						})
				...
				e.exports = function (t) {
					...
					function n(t) {
						...
						if (e(t)) {
							...
							n = a.x - s,
							i = a.x + s,
							o = Math.min(a.y, a.base),
							r = Math.max(a.y, a.base)
						} else {
							var l = a.height / 2;
					...
					t.elements.Rectangle = t.Element.extend({
							...
							inLabelRange: function (t, i) {
								...
								if (!o._view)
									return !1;
								var r = n(o);
								return e(o) ? t >= r.left && t <= r.right : i >= r.top && i <= r.bottom
							},
							inXRange: function (t) {
								var e = n(this);
					...
					return {
						...
						addEventListener: function (t, e, n) {
							...
							if ("resize" !== e) {
								...
								s = (r.proxies || (r.proxies = {}))[t.id + "_" + e] = function (e) {
									n(o(e, t))
								};
								l.addEvent(i, e, s)
							} else
		...
		41: [function (t, e, n) {
				...
				e.exports = function (t) {
					function e(t, e, n) {
						...
						o = t._model || {},
						r = o.fill;
						if (void 0 === r && (r = !!o.backgroundColor), !1 === r || null === r)
							return !1;
						if (!0 === r)
							return "origin";
					...
					function a(t, e, n, i, o) {
						...
						if (i && o) {
							...
							for (t.lineTo(n[o - 1].x, n[o - 1].y), r = o - 1; r > 0; --r)
					...
					function s(t, e, n, i, o, s) {
						...
						b = 0,
						x = 0;
						for (t.beginPath(), l = 0, u = g + !!s; l < u; ++l)
							c = l % g, d = e[c]._view, h = n(d, c, i), f = r(d), p = r(h), f && p ? (b = v.push(d), x = y.push(h)) : b && x && (m ? (f && v.push(d), p && y.push(h)) : (a(t, v, y, b, x), b = x = 0, v = [], y = []));
						a(t, v, y, b, x),
						t.closePath(),
						t.fillStyle = o,
						t.fill()
					...
					return {
						...
						afterDatasetsUpdate: function (r, a) {
							...
							f = [];
							for (l = 0; l < d; ++l)
								s = r.getDatasetMeta(l), u = s.dataset, c = null, u && u._model && u instanceof t.elements.Line && (c = {
							...
							for (l = 0; l < d; ++l)
								(c = f[l]) && (c.fill = i(f, l, h), c.boundary = n(c), c.mapper = o(c))
						},
						beforeDatasetDraw: function (t, e) {
							...
							if (n) {
								...
								a && u && r.length && s(t.ctx, r, a, o, u, i._loop)
							}
						}
					}
				}
				...
				e.exports = function (t) {
					...
					t.Legend = t.Element.extend({
								...
								if (m ? (g.width = n.maxWidth, g.height = a ? 10 : 0) : (g.width = a ? 10 : 0, g.height = n.maxHeight), a)
									if (s.font = f, m) {
										...
										i.each(n.legendItems, function (t, i) {
											...
											v[v.length - 1] + o + r.padding >= n.width && (y += c + r.padding, v[v.length] = n.left),
											p[i] = {
												left: 0,
												top: 0,
												width: o,
										...
										i.each(n.legendItems, function (t, n) {
											...
											k + C > g.height && (w += _ + r.padding, x.push(_), _ = 0, k = 0),
											_ = Math.max(_, i),
											k += C,
											p[n] = {
												left: 0,
								...
								if (o.display) {
									...
									x = function (e, n, i) {
										if (!(isNaN(y) || y <= 0)) {
											...
											d.lineDashOffset = h(i.lineDashOffset, s.borderDashOffset),
											...
											if (d.setLineDash && d.setLineDash(h(i.lineDash, s.borderDash)), o.labels && o.labels.usePointStyle) {
												...
												c = e + u,
												f = n + u;
												t.canvasHelpers.drawPoint(d, i.pointStyle, l, c, f)
											} else
												r || d.strokeRect(e, n, y, p), d.fillRect(e, n, y, p);
											d.restore()
										}
									},
									w = function (t, e, n, i) {
										d.fillText(n.text, y + p / 2 + t, e),
										n.hidden && (d.beginPath(), d.lineWidth = 2, d.moveTo(y + p / 2 + t, e + p / 2), d.lineTo(y + p / 2 + t + i, e + p / 2), d.stroke())
									},
									_ = n.isHorizontal();
									c = _ ? {
										x: n.left + (l - u[0]) / 2,
									...
									i.each(n.legendItems, function (t, e) {
										...
										a = c.x,
										s = c.y;
										_ ? a + o >= l && (s = c.y += k, c.line++, a = c.x = n.left + (l - u[c.line]) / 2) : s + k > n.bottom && (a = c.x = a + n.columnWidths[c.line] + r.padding, s = c.y = n.top + r.padding, c.line++),
										x(a, s, t),
										b[e].left = a,
										b[e].top = s,
										w(a, s, t, i),
										_ ? c.x += o + r.padding : c.y += k
									})
								}
							},
							handleEvent: function (t) {
						...
						beforeUpdate: function (e) {
							...
							a = e.legend;
							r ? (r = i.configMerge(t.defaults.global.legend, r), a ? (o.configure(e, a, r), a.options = r) : n(e, r)) : a && (o.removeBox(e, a), delete e.legend)
						},
				...
				e.exports = function (t) {
					...
					t.Title = t.Element.extend({
							...
							fit: function () {
								...
								l = e.minSize;
								e.isHorizontal() ? (l.width = e.maxWidth, l.height = a ? s + 2 * o.padding : 0) : (l.width = a ? s + 2 * o.padding : 0, l.height = e.maxHeight),
								e.width = l.width,
								e.height = l.height
							},
							afterFit: o,
							...
							draw: function () {
								...
								if (r.display) {
									...
									l,
									u,
									c = o(r.fontSize, a.defaultFontSize),
									...
									v = e.bottom,
									y = e.right;
									i.fillStyle = o(r.fontColor, a.defaultFontColor),
									i.font = f,
									e.isHorizontal() ? (s = m + (y - m) / 2, l = g + (v - g) / 2, u = y - m) : (s = "left" === r.position ? m + c / 2 : y - c / 2, l = g + (v - g) / 2, u = v - g, p = Math.PI * ("left" === r.position ?  - .5 : .5)),
									i.save(),
									i.translate(s, l),
									i.rotate(p),
									i.textAlign = "center",
						...
						beforeUpdate: function (o) {
							...
							a = o.titleBlock;
							r ? (r = n.configMerge(t.defaults.global.title, r), a ? (i.configure(o, a, r), a.options = r) : e(o, r)) : a && (t.layoutService.removeBox(o, a), delete o.titleBlock)
						}
					}
				}
			}, {}
				...
				e.exports = function (t) {
					...
					i = t.Scale.extend({
							...
							determineDataLimits: function () {
								...
								var i;
								void 0 !== t.options.ticks.min && (i = e.indexOf(n, t.options.ticks.min), t.minIndex = -1 !== i ? i : t.minIndex),
								void 0 !== t.options.ticks.max && (i = e.indexOf(n, t.options.ticks.max), t.maxIndex = -1 !== i ? i : t.maxIndex),
								t.min = n[t.minIndex],
								t.max = n[t.maxIndex]
							},
							buildTicks: function () {
							...
							getPixelForValue: function (t, e, n, i) {
								...
								if (r.isHorizontal()) {
									var u = r.width / a,
									c = u * (e - r.minIndex);
									return (r.options.gridLines.offsetGridLines && i || r.maxIndex === r.minIndex && i) && (c += u / 2),
									r.left + Math.round(c)
								}
								var d = r.height / a,
								h = d * (e - r.minIndex);
								return r.options.gridLines.offsetGridLines && i && (h += d / 2),
								r.top + Math.round(h)
							},
							getPixelForTick: function (t, e) {
		...
		45: [function (t, e, n) {
				...
				e.exports = function (t) {
					...
					i = t.LinearScaleBase.extend({
							determineDataLimits: function () {
								function t(t) {
									return a ? t.xAxisID === n.id : t.yAxisID === n.id
								}
								var n = this,
								i = n.options,
								o = n.chart,
								...
								n.max = null;
								var s = i.stacked;
								if (void 0 === s && e.each(r, function (e, n) {
										if (!s) {
									...
									e.each(r, function (r, a) {
										...
										u = [s.type, void 0 === i.stacked && void 0 === s.stack ? a : "", s.stack].join(".");
										void 0 === l[u] && (l[u] = {
												positiveValues: [],
												negativeValues: []
											});
										...
										o.isDatasetVisible(a) && t(s) && e.each(r.data, function (t, e) {
											...
											isNaN(o) || s.data[e].hidden || (c[e] = c[e] || 0, d[e] = d[e] || 0, i.relativePoints ? c[e] = 100 : o < 0 ? d[e] += o : c[e] += o)
										})
									}),
									e.each(l, function (t) {
				...
				e.exports = function (t) {
					...
					t.LinearScaleBase = t.Scale.extend({
							...
							buildTicks: function () {
								...
								a = n.ticks = t.Ticks.generators.linear(r, n);
								n.handleDirectionalChanges(),
								n.max = e.max(a),
								n.min = e.min(a),
								i.reverse ? (a.reverse(), n.start = n.max, n.end = n.min) : (n.start = n.min, n.end = n.max)
							},
							convertTicksToLabels: function () {
								var e = this;
				...
				e.exports = function (t) {
					...
					i = t.Scale.extend({
							determineDataLimits: function () {
								...
								n.minNotZero = null;
								var u = i.stacked;
								if (void 0 === u && e.each(a, function (e, n) {
										if (!u) {
									...
									e.each(a, function (o, a) {
										...
										r.isDatasetVisible(a) && t(s) && (void 0 === c[l] && (c[l] = []), e.each(o.data, function (t, e) {
												var o = c[l],
												r = +n.getRightValue(t);
												isNaN(r) || s.data[e].hidden || (o[e] = o[e] || 0, i.relativePoints ? o[e] = 100 : o[e] += r)
											}))
									}),
									e.each(c, function (t) {
										var i = e.min(t),
									...
									e.each(a, function (i, o) {
										var a = r.getDatasetMeta(o);
										r.isDatasetVisible(o) && t(a) && e.each(i.data, function (t, e) {
											var i = +n.getRightValue(t);
											isNaN(i) || a.data[e].hidden || (null === n.min ? n.min = i : i < n.min && (n.min = i), null === n.max ? n.max = i : i > n.max && (n.max = i), 0 !== i && (null === n.minNotZero || i < n.minNotZero) && (n.minNotZero = i))
										})
									});
								n.min = s(o.min, n.min),
								n.max = s(o.max, n.max),
								n.min === n.max && (0 !== n.min && null !== n.min ? (n.min = Math.pow(10, Math.floor(e.log10(n.min)) - 1), n.max = Math.pow(10, Math.floor(e.log10(n.max)) + 1)) : (n.min = 1, n.max = 10))
							},
							buildTicks: function () {
								var n = this,
								i = n.options.ticks,
								...
								n.max = e.max(r),
								n.min = e.min(r),
								i.reverse ? (r.reverse(), n.start = n.max, n.end = n.min) : (n.start = n.min, n.end = n.max)
							},
							convertTicksToLabels: function () {
							...
							getPixelForValue: function (t) {
								...
								s = +r.getRightValue(t),
								l = r.options.ticks;
								return r.isHorizontal() ? (o = e.log10(r.end) - e.log10(a), 0 === s ? i = r.left : (n = r.width, i = r.left + n / o * (e.log10(s) - e.log10(a)))) : (n = r.height, 0 !== a || l.reverse ? 0 === r.end && l.reverse ? (o = e.log10(r.start) - e.log10(r.minNotZero), i = s === r.end ? r.top : s === r.minNotZero ? r.top + .02 * n : r.top + .02 * n + .98 * n / o * (e.log10(s) - e.log10(r.minNotZero))) : 0 === s ? i = l.reverse ? r.top : r.bottom : (o = e.log10(r.end) - e.log10(a), n = r.height, i = r.bottom - n / o * (e.log10(s) - e.log10(a))) : (o = e.log10(r.end) - e.log10(r.minNotZero), i = s === a ? r.bottom : s === r.minNotZero ? r.bottom - .02 * n : r.bottom - .02 * n - .98 * n / o * (e.log10(s) - e.log10(r.minNotZero)))),
								i
							},
							getValueForPixel: function (t) {
								var n,
								...
								return o.isHorizontal() ? (i = o.width, n = o.start * Math.pow(10, (t - o.left) * r / i)) : (i = o.height, n = Math.pow(10, (o.bottom - t) * r / i) / o.start),
								n
							}
						});
				...
				e.exports = function (t) {
					...
					function r(t) {
						...
						for (r = 0; r < h; r++) {
							...
							a = i(t.ctx, l.size, t.pointLabels[r] || ""),
							t._pointLabelSizes[r] = a;
							var p = t.getIndexAngle(r),
							g = f.toDegrees(p) % 360,
							m = o(g, s.x, a.w, 0, 180),
							v = o(g, s.y, a.h, 90, 270);
							m.start < c.l && (c.l = m.start, d.l = p),
							m.end > c.r && (c.r = m.end, d.r = p),
							v.start < c.t && (c.t = v.start, d.t = p),
							v.end > c.b && (c.b = v.end, d.b = p)
						}
					...
					function l(t, e, n, i) {
						if (f.isArray(e))
							for (var o = n.y, r = 1.5 * i, a = 0; a < e.length; ++a)
					...
					function c(t) {
						...
						for (var g = e(t) - 1; g >= 0; g--) {
							...
							if (c.display) {
								...
								x = f.toDegrees(b);
								i.textAlign = s(x),
								u(x, t._pointLabelSizes[g], v),
								l(i, t.pointLabels[g] || "", v, h.size)
							}
						}
					}
					function d(t, n, i, o) {
						var r = t.ctx;
						if (r.strokeStyle = f.getValueAtIndexOrDefault(n.color, o - 1), r.lineWidth = f.getValueAtIndexOrDefault(n.lineWidth, o - 1), t.options.gridLines.circular)
					...
					m = t.LinearScaleBase.extend({
							...
							setReductions: function (t, e, n) {
								...
								a = h(a),
								s = h(s),
								i.drawingArea = Math.min(Math.round(t - (o + r) / 2), Math.round(t - (a + s) / 2)),
								...
								if (e.display) {
									...
									f.each(t.ticks, function (s, l) {
										if (l > 0 || e.reverse) {
											...
											h = t.yCenter - c;
											if (n.display && 0 !== l && d(t, n, c, l), i.display) {
												...
												if (r.font = u, i.showLabelBackdrop) {
													...
													r.fillRect(t.xCenter - g / 2 - i.backdropPaddingX, h - a / 2 - i.backdropPaddingY, g + 2 * i.backdropPaddingX, a + 2 * i.backdropPaddingY)
												}
												r.textAlign = "center",
		...
		49: [function (t, e, n) {
				...
				e.exports = function (t) {
					...
					function n(t, e, n, i) {
						for (var o, r = Object.keys(s), a = r.length, l = r.indexOf(t); l < a; l++) {
							o = r[l];
							var u = s[o],
							c = u.steps && u.steps[u.steps.length - 1] || u.maxStep;
							if (void 0 === c || Math.ceil((n - e) / (c * u.size)) <= i)
								break
						}
						return o
					}
					function o(t, e, n, i) {
						...
						u = e - t;
						if (o.steps)
							for (var c = o.steps.length, d = 0; d < c && a > i; d++)
								l = o.steps[d], a = Math.ceil(u / (r * l));
						else
							for (; a > i && i > 0; )
								++l, a = Math.ceil(u / (r * l));
						return l
					...
					function r(t, e, n) {
						...
						if (t.maxTicks) {
							...
							for (var a = i(n.min); a.add(r, t.unit).valueOf() < n.max; )
								o.push(a.valueOf());
							var s = t.max || n.max;
					...
					t.Ticks.generators.time = function (t, e) {
						...
						o,
						a = t.isoWeekday;
						return "week" === t.unit && !1 !== a ? (n = i(e.min).startOf("isoWeek").isoWeekday(a).valueOf(), o = i(e.max).startOf("isoWeek").isoWeekday(a), e.max - o > 0 && o.add(1, "week"), o = o.valueOf()) : (n = i(e.min).startOf(t.unit).valueOf(), o = i(e.max).startOf(t.unit), e.max - o > 0 && o.add(1, t.unit), o = o.valueOf()),
						r(t, e, {
							min: n,
							max: o
						})
					...
					var u = t.Scale.extend({
							...
							determineDataLimits: function () {
								...
								a.each(s.labels, function (a, s) {
									var u = e(n, a);
									u.isValid() && (i.round && u.startOf(i.round), t = u.valueOf(), o = Math.min(t, o), r = Math.max(t, r), l.labels[s] = t)
								}),
								a.each(s.datasets, function (s, u) {
									var c = [];
									"object" == typeof s.data[0] && null !== s.data[0] && n.chart.isDatasetVisible(u) ? a.each(s.data, function (a, s) {
										var l = e(n, n.getRightValue(a));
										l.isValid() && (i.round && l.startOf(i.round), t = l.valueOf(), o = Math.min(t, o), r = Math.max(t, r), c[s] = t)
									}) : c = l.labels.slice(),
									l.datasets[u] = c
								}),
								n.dataMin = o,
							...
							buildTicks: function () {
								...
								f = l.unit || n(l.minUnit, i || u, r || c, h);
								s.displayFormat = l.displayFormats[f];
								var p = l.stepSize || o(i || u, r || c, f, h);
							...
							getLabelForIndex: function (t, n) {
								...
								return null !== r && "object" == typeof r && (o = i.getRightValue(r)),
								i.options.time.tooltipFormat && (o = e(i, o).format(i.options.time.tooltipFormat)),
								o
							},
							...
							getPixelForValue: function (t, n, i) {
								var o = this,
								r = null;
								if (void 0 !== n && void 0 !== i && (r = o._parsedData.datasets[i][n]), null === r && (t && t.isValid || (t = e(o, o.getRightValue(t))), t && t.isValid && t.isValid() && (r = t.valueOf())), null !== r)
									return o.getPixelForOffset(r)
							},
							getPixelForTick: function (t) {
							...
							getLabelWidth: function (e) {
								...
								return o * r + a.getValueOrDefault(i.fontSize, t.defaults.global.defaultFontSize) * s
							},
...
(this, function (t) {
	...
	function () {
		function e(t, e) {
			var n = parseInt(t, 10);
			return isNaN(n) ? 0 : "string" == typeof t && -1 !== t.indexOf("%") ? n / 100 * e : n
		}
		function n(t) {
			var n = t[c],
			i = t.chart.canvas;
			...
			r = e(n.yOffset || 0, o.height),
			a = e(n.xOffset || 0, o.width);
			return o.right - a >= 0 && o.bottom - r >= 0 && o.left + a <= window.innerWidth && o.top + r <= window.innerHeight
		}
		function i(e) {
			var n = t.Deferred.defaults,
			i = e.options.deferred,
			o = l.getValueOrDefault;
			return void 0 === i ? i = {}
			 : "boolean" == typeof i && (i = {
					enabled: i
				}), {
				enabled: o(i.enabled, n.enabled),
				xOffset: o(i.xOffset, n.xOffset),
				yOffset: o(i.yOffset, n.yOffset),
				delay: o(i.delay, n.delay),
				appeared: !1,
				delayed: !1,
				loaded: !1,
				elements: []
		...
		function o(e) {
			var i = e.target[u];
			i.ticking || (i.ticking = !0, t.platform.defer(function () {
					var t,
					e,
					o = i.instances.slice(),
					r = o.length;
					for (e = 0; e < r; ++e)
						t = o[e], n(t) && (s(t), t[c].appeared = !0, t.update());
					i.ticking = !1
				}))
		}
		function r(t) {
			if (t.nodeType === Node.ELEMENT_NODE) {
				...
				n = l.getStyle(t, "overflow-y");
				return "auto" === e || "scroll" === e || "auto" === n || "scroll" === n
			}
			return t.nodeType === Node.DOCUMENT_NODE
		}
		function a(t) {
			for (var e, n, i = t.chart.canvas.parentElement; i; )
				r(i) && (e = i[u] || (i[u] = {}), 0 === (n = e.instances || (e.instances = [])).length && i.addEventListener("scroll", o, {
						passive: !0
					}), n.push(t), t[c].elements.push(i)), i = i.parentElement || i.ownerDocument
		}
		function s(t) {
			t[c].elements.forEach(function (e) {
				var n = e[u].instances;
				n.splice(n.indexOf(t), 1),
				n.length || (l.removeEvent(e, "scroll", o), delete e[u])
			}),
			t[c].elements = []
		}
		var l = t.helpers,
		...
		t.platform = l.extend(t.platform || {}, {
				defer: function (t, e, n) {
					var i = function () {
						t.call(n)
					};
					e ? window.setTimeout(i, e) : l.requestAnimFrame.call(window, i)
				}
			}),
		t.plugins.register({
			beforeInit: function (t) {
			...
			beforeDatasetsUpdate: function (e) {
				...
				if (!i.loaded) {
					if (!i.appeared && !n(e))
						return !1;
					if (i.appeared = !0, i.loaded = !0, s(e), i.delay > 0)
						return i.delayed = !0, t.platform.defer(function () {
							i.delayed = !1,
							e.update()
						}, i.delay), !1
				}
				return !i.delayed && void 0
			},
			destroy: function (t) {
				s(t)
			}
...
(this, function () {
	...
	return e.prototype = {
		...
		_generatePath: function (t, e, n, i) {
			var o = document.createElementNS("http://www.w3.org/2000/svg", "path");
			return o.setAttribute("fill", "transparent"),
			o.setAttribute("stroke", n),
			o.setAttribute("stroke-width", this._strokeWidth),
			o.setAttribute("d", this._calculatePath(t, e)),
			o.setAttribute("class", i),
			this._svg.appendChild(o),
			this
		},
		_calculatePath: function (t, e) {
			var n = this._start + t / 100 * this._circ,
			i = this._precise(n);
			return this._arc(i, e)
		},
		_arc: function (t, e) {
			var n = t - .001,
			i = t - this._startPrecise < Math.PI ? 0 : 1;
			return ["M", this._radius + this._radiusAdjusted * Math.cos(this._startPrecise), this._radius + this._radiusAdjusted * Math.sin(this._startPrecise), "A", this._radiusAdjusted, this._radiusAdjusted, 0, i, 1, this._radius + this._radiusAdjusted * Math.cos(n), this._radius + this._radiusAdjusted * Math.sin(n), e ? "" : "Z"].join(" ")
		},
		_precise: function (t) {
		...
		htmlifyNumber: function (t, e, n) {
			...
			var i = (t + "").split("."),
			o = '<span class="' + e + '">' + i[0] + "</span>";
			return i.length > 1 && (o += '.<span class="' + n + '">' + i[1].substring(0, 2) + "</span>"),
			o
		},
		...
		update: function (e, n) {
			...
			n ? (i = s.getPercent(), o = i > l, u += i % 1, r = Math.floor(Math.abs(i - l) / u), a = n / r, function e(n) {
				if (o ? l += u : l -= u, o && l >= i || !o && i >= l)
					t(function () {
						s._setPercentage(i)
					});
				else {
	...
	o.Workers = [{
			...
			run: function () {
				...
				l = "";
				for (a /= 2; a--; )
					e.push(this.normalize(e.length / 2, !0)), s += n[e[e.length - 1]][0].outerHTML, e.push(this.normalize(n.length - 1 - (e.length - 1) / 2, !0)), l = n[e[e.length - 1]][0].outerHTML + l;
				this._clones = e,
			...
			run: function () {
				...
				for (n = 0, i = this._coordinates.length; n < i; n++)
					t = this._coordinates[n - 1] || 0, e = Math.abs(this._coordinates[n]) + r * o, (this.op(t, "<=", a) && this.op(t, ">", s) || this.op(e, "<", a) && this.op(e, ">", s)) && l.push(n);
	...
	o.prototype.setup = function () {
		...
		n ? (t.each(n, function (t) {
				t <= e && t > i && (i = Number(t))
			}), "function" == typeof(o = t.extend({}, this.options, n[i])).stagePadding && (o.stagePadding = o.stagePadding()), delete o.responsive, o.responsiveClass && this.$element.attr("class", this.$element.attr("class").replace(new RegExp("(" + this.options.responsiveClass + "-)\\S+\\s", "g"), "$1" + i))) : o = t.extend({}, this.options),
		this.trigger("change", {
			property: {
				name: "settings",
				value: o
	...
	o.prototype.onDragEnd = function (e) {
		...
		(0 !== i.x && this.is("dragging") || !this.is("valid")) && (this.speed(this.settings.dragEndSpeed || this.settings.smartSpeed), this.current(this.closest(o.x, 0 !== i.x ? r : this._drag.direction)), this.invalidate("position"), this.update(), this._drag.direction = r, (Math.abs(i.x) > 3 || (new Date).getTime() - this._drag.time > 300) && this._drag.target.one("click.owl.core", function () {
				return !1
			})),
	...
	o.prototype.closest = function (e, n) {
		...
		return this.settings.freeDrag || t.each(r, t.proxy(function (t, a) {
				return "left" === n && e > a - 30 && e < a + 30 ? i = t : "right" === n && e > a - o - 30 && e < a - o + 30 ? i = t + 1 : this.op(e, "<", a) && this.op(e, ">", r[t + 1] || a - o) && (i = "left" === n ? t + 1 : t),
				-1 === i
			}, this)),
	...
	o.prototype.normalize = function (t, e) {
		...
		return !this.isNumeric(t) || n < 1 ? t = i : (t < 0 || t >= n + o) && (t = ((t - o / 2) % n + n) % n + o / 2),
		t
	},
	...
	o.prototype.to = function (t, e) {
		...
		s = this.minimum(),
		l = this.maximum();
		this.settings.loop ? (!this.settings.rewind && Math.abs(o) > a / 2 && (o += -1 * r * a), t = n + o, (i = ((t - s) % a + a) % a + s) !== t && i - o <= l && i - o > 0 && (n = i - o, t = i, this.reset(n))) : this.settings.rewind ? (l += 1, t = (t % l + l) % l) : t = Math.max(s, Math.min(l, t)),
	...
	o.prototype.onTransitionEnd = function (t) {
		if (t !== i && (t.stopPropagation(), (t.target || t.srcElement || t.originalTarget) !== this.$stage.get(0)))
			return !1;
	...
	o.prototype.add = function (e, n) {
		...
		e = this.prepare(e),
		0 === this._items.length || n === this._items.length ? (0 === this._items.length && this.$stage.append(e), 0 !== this._items.length && this._items[n - 1].after(e), this._items.push(e), this._mergers.push(1 * e.find("[data-merge]").addBack("[data-merge]").attr("data-merge") || 1)) : (this._items[n].before(e), this._items.splice(n, 0, e), this._mergers.splice(n, 0, 1 * e.find("[data-merge]").addBack("[data-merge]").attr("data-merge") || 1)),
	...
	o.prototype.register = function (e) {
		if (e.type === o.Type.Event) {
			...
			e.type === o.Type.State && (this._states.tags[e.name] ? this._states.tags[e.name] = this._states.tags[e.name].concat(e.tags) : this._states.tags[e.name] = e.tags, this._states.tags[e.name] = t.grep(this._states.tags[e.name], t.proxy(function (n, i) {
		...
		this._handlers = {
			"initialized.owl.carousel change.owl.carousel resized.owl.carousel": t.proxy(function (e) {
				if (e.namespace && this._core.settings && this._core.settings.lazyLoad && (e.property && "position" == e.property.name || "initialized" == e.type))
					for (var n = this._core.settings, i = n.center && Math.ceil(n.items / 2) || n.items, o = n.center && -1 * i || 0, r = (e.property && void 0 !== e.property.value ? e.property.value : this._core.current()) + o, a = this._core.clones().length, s = t.proxy(function (t, e) {
								this.load(e)
							}, this); o++ < i; )
						this.load(a / 2 + this._core.relative(r)), a && t.each(this._core.clones(this._core.relative(r)), s), r++
			}, this)
		},
		this._core.options = t.extend({}, o.Defaults, this._core.options),
		this._core.$element.on(this._handlers)
...
(window.Zepto || window.jQuery, window, document), function (t, e, n, i) {
	...
	o.prototype.fetch = function (t, e) {
		...
		if ((i = a.match(/(http:|https:|)\/\/(player.|www.|app.)?(vimeo\.com|youtu(be\.com|\.be|be\.googleapis\.com)|vzaar\.com)\/(video\/|videos\/|embed\/|channels\/.+\/|groups\/.+\/|watch\?v=|v\/)?([A-Za-z0-9._%-]*)(\&\S+)?/))[3].indexOf("youtu") > -1)
			n = "youtube";
	...
	o.prototype.thumbnail = function (e, n) {
		...
		o,
		r,
		a = n.width && n.height ? 'style="width:' + n.width + "px;height:" + n.height + 'px;"' : "",
		s = e.find("img"),
		l = "src",
		u = "",
		...
		if (e.wrap('<div class="owl-video-wrapper"' + a + "></div>"), this._core.settings.lazyLoad && (l = "data-src", u = "owl-lazy"), s.length)
...
(window.Zepto || window.jQuery, window, document), function (t, e, n, i) {
	...
	u.csstransitions() && (t.support.transition = new String(r("transition")), t.support.transition.end = l.transition.end[t.support.transition]),
	u.cssanimations() && (t.support.animation = new String(r("animation")), t.support.animation.end = l.animation.end[t.support.animation]),
	u.csstransforms() && (t.support.transform = new String(r("transform")), t.support.transform3d = u.csstransforms3d())
}
...
(function (t) {
		...
		return function (e) {
			...
			if (i)
				for (var r = 0, a = i.length; r < a; ++r) {
					...
					h = null;
					s = s[2],
					l.hasOwnProperty(s) && (h = l[s], h = Number(t[h])),
					null !== h && ("!" === c && (h = o(d, h)), "" === c && h < 10 && (h = "0" + h.toString()), e = e.replace(u, h.toString()))
				}
			return e = e.replace(/%%/, "%")
		}
	}
	...
	u = function (e, n, i) {
		...
		i && ("function" == typeof i ? (this.$el.on("update.countdown", i), this.$el.on("stoped.countdown", i), this.$el.on("finish.countdown", i)) : this.options = t.extend({}, s, i)),
		this.setFinalDate(n),
	...
	t.extend(u.prototype, {
		...
		update: function () {
			if (0 !== this.$el.closest("html").length) {
				...
				this.totalSecsLeft !== e && n && (this.totalSecsLeft = e, this.elapsed = i >= this.finalDate, this.offset = {
	...
	t.fn.countdown = function () {
		...
		return this.each(function () {
			...
			if (void 0 !== n) {
				var i = r[n],
				o = e[0];
				u.prototype.hasOwnProperty(o) ? i[o].apply(i, e.slice(1)) : null === String(o).match(/^[$A-Z_][0-9A-Z_$]*$/i) ? (i.setFinalDate.call(i, o), i.start()) : t.error("Method %s does not exist on jQuery.countdown".replace(/\%s/gi, o))
			} else
				new u(this, e[0], e[1])
		})
	}
	...
	t.MixItUp.prototype = {
		...
		_platformDetect: function () {
			...
			for (var s = 0; s < i.length && !window.requestAnimationFrame; s++)
		...
		_refresh: function (t, n) {
			...
			for (u = 0; u < i._$targets.length; u++) {
				if ((c = i._$targets[u]).dataset === e || n) {
					c.dataset = {};
					for (var o = 0; o < c.attributes.length; o++) {
						...
						s = r.value;
						if (a.indexOf("data-") > -1) {
							var l = i._helpers._camelCase(a.substring(5, a.length));
							c.dataset[l] = s
						}
					}
				}
				c.mixParent === e && (c.mixParent = i._id)
			}
			if (i._$targets.length && t || !i._origOrder.length && i._$targets.length) {
				i._origOrder = [];
				for (var u = 0; u < i._$targets.length; u++) {
					var c = i._$targets[u];
					i._origOrder.push(c)
				}
			}
		...
		_bindHandlers: function () {
			...
			i[n.selectors.filter] = i[n.selectors.filter] === e ? 1 : i[n.selectors.filter] + 1,
			o[n.selectors.sort] = o[n.selectors.sort] === e ? 1 : o[n.selectors.sort] + 1,
		...
		_processClick: function (n, i) {
			...
			r = function (n, i, r) {
				...
				a._handled["_" + i][o.selectors[i]] = a._handled["_" + i][o.selectors[i]] === e ? 1 : a._handled["_" + i][o.selectors[i]] + 1,
				a._handled["_" + i][o.selectors[i]] === a._bound["_" + i][o.selectors[i]] && (n[(r ? "remove" : "add") + "Class"](o.controls.activeClass), delete a._handled["_" + i][o.selectors[i]])
			};
			if (o._execAction("_processClick", 0, arguments), !o._mixing || o.animation.queue && o._queue.length < o.animation.queueLimit) {
				if (o._clicking = !0, "sort" === i) {
					...
					(!n.hasClass(o.controls.activeClass) || a.indexOf("random") > -1) && (t(o.selectors.sort).removeClass(o.controls.activeClass), r(n, i), o.sort(a))
				}
				if ("filter" === i) {
					var s,
					l = n.attr("data-filter"),
					u = "or" === o.controls.toggleLogic ? "," : "";
					o.controls.toggleFilterButtons ? (o._buildToggleArray(), n.hasClass(o.controls.activeClass) ? (r(n, i, !0), s = o._toggleArray.indexOf(l), o._toggleArray.splice(s, 1)) : (r(n, i), o._toggleArray.push(l)), o._toggleArray = t.grep(o._toggleArray, function (t) {
								return t
							}), o._toggleString = o._toggleArray.join(u), o.filter(o._toggleString)) : n.hasClass(o.controls.activeClass) || (t(o.selectors.filter).removeClass(o.controls.activeClass), r(n, i), o.filter(l))
				}
				o._execAction("_processClick", 1, arguments)
			} else
				"function" == typeof o.callbacks.onMixBusy && o.callbacks.onMixBusy.call(o._domNode, o._state, o), o._execAction("_processClickBusy", 1, arguments)
		},
		...
		_updateControls: function (n, i) {
			...
			n.filter === e && (r.filter = o._activeFilter),
			n.sort === e && (r.sort = o._activeSort),
			r.filter === o.selectors.target && (r.filter = "all");
			for (var l = 0; 2 > l; l++)
				(s = o.controls.live ? t(o.selectors[a]) : o["_$" + a + "Buttons"]) && function (t, e) {
					try {
						i && "filter" === a && "none" !== r.filter && "" !== r.filter ? t.filter(e).addClass(o.controls.activeClass) : t.removeClass(o.controls.activeClass).filter(e).addClass(o.controls.activeClass)
					} catch (t) {}
				}
			(s, "[data-" + a + '="' + r[a] + '"]'),
			a = "sort";
		...
		_compare: function (t, e, n) {
			...
			return s > a ? "asc" === o ? -1 : 1 : a > s ? "asc" === o ? 1 : -1 : a === s && i._newSort.length > n + 1 ? i._compare(t, e, n + 1) : 0
		},
		_printSort: function (t) {
			...
			for (l = 0; l < i.length; l++) {
				var a = i[l],
				s = a.nextSibling;
				"absolute" !== a.style.position && (s && "#text" === s.nodeName && e._$parent[0].removeChild(s), e._$parent[0].removeChild(a))
			}
			for (var l = 0; l < n.length; l++) {
				...
				if ("default" !== e._newSort[0].sortBy || "desc" !== e._newSort[0].order || t)
					...
					var c = r.firstChild;
					r.insertBefore(u, c),
					r.insertBefore(document.createTextNode(" "), u)
				}
			}
		...
		_parseSort: function (t) {
			for (var e = this, n = "string" == typeof t ? t.split(" ") : [t], i = [], o = 0; o < n.length; o++) {
				var r = "string" == typeof t ? n[o].split(":") : ["custom", n[o]],
				a = {
					sortBy: e._helpers._camelCase(r[0]),
					order: r[1] || "asc"
				};
				if (i.push(a), "default" === a.sortBy || "random" === a.sortBy)
					break
			}
		...
		_parseEffects: function () {
			...
			o = function (t, o) {
				for (var r = [["scale", ".01"], ["translateX", "20px"], ["translateY", "20px"], ["translateZ", "20px"], ["rotateX", "90deg"], ["rotateY", "90deg"], ["rotateZ", "180deg"]], a = 0; a < r.length; a++) {
					...
					l = r[a][1],
					u = o && "scale" !== s;
					e[t] += n(s) ? s + "(" + i(n(s, !0).val || l, u) + ") " : ""
				}
			};
			return e.opacity = n("fade") ? n("fade", !0).val || "0" : "1",
			o("transformIn"),
			...
			t.animation.stagger = !!n("stagger"),
			t.animation.staggerDuration = parseInt(n("stagger") && n("stagger", !0).val ? n("stagger", !0).val : 100),
			t._execFilter("_parseEffects", e)
		},
		_buildState: function (t) {
			var e = this,
			n = {};
			return e._execAction("_buildState", 0),
			n = {
		...
		_goMix: function (t) {
			var e = this,
			n = function () {
				e._chrome && 31 === e._chrome && r(e._$parent[0]),
				e._setInter(),
				i()
			},
			i = function () {
			...
			e._getOrigMixData(),
			t && !e._suckMode ? window.requestAnimationFrame ? requestAnimationFrame(n) : n() : e._cleanUp(),
		...
		_getTargetData: function (t, e) {
			...
			i.animation.animateResizeTargets && (n = i._suckMode ? {
					marginBottom: "",
					marginRight: ""
				}
		...
		_setInter: function () {
			...
			t._changingLayout && t.animation.animateChangeLayout ? (t._$toShow.css("display", t._newDisplay), t._changingClass && t._$container.removeClass(t.layout.containerClass).addClass(t._newClass)) : t._$toShow.css("display", t.layout.display),
			t._execAction("_setInter", 1)
		},
		_getInterMixData: function () {
			var t = this;
			t._execAction("_getInterMixData", 0);
			for (e = 0; e < t._$toShow.length; e++) {
				n = t._$toShow[e];
		...
		_prepTargets: function () {
			...
			for (r = 0; r < e._$toShow.length; r++) {
				var i = e._$toShow[r],
				o = t(i);
				i.style.opacity = e.effects.opacity,
				i.style.display = e._changingLayout && e.animation.animateChangeLayout ? e._newDisplay : e.layout.display,
				o.css(n._in),
				e.animation.animateResizeTargets && (i.style.width = i.dataset.finalWidth + "px", i.style.height = i.dataset.finalHeight + "px", i.style.marginRight =  - (i.dataset.finalWidth - i.dataset.interWidth) + 1 * i.dataset.finalMarginRight + "px", i.style.marginBottom =  - (i.dataset.finalHeight - i.dataset.interHeight) + 1 * i.dataset.finalMarginBottom + "px")
			}
			for (var r = 0; r < e._$pre.length; r++) {
				...
				n = e._getPrefixedCSS("transform", "translate(" + a.x + "px," + a.y + "px)");
				o.css(n),
				e.animation.animateResizeTargets && (i.style.width = i.dataset.origWidth + "px", i.style.height = i.dataset.origHeight + "px", i.dataset.origWidth - i.dataset.finalWidth && (i.style.marginRight =  - (i.dataset.origWidth - i.dataset.interWidth) + 1 * i.dataset.origMarginRight + "px"), i.dataset.origHeight - i.dataset.finalHeight && (i.style.marginBottom =  - (i.dataset.origHeight - i.dataset.interHeight) + 1 * i.dataset.origMarginBottom + "px"))
			}
		...
		_animateTargets: function () {
			...
			for (l = 0; l < e._$toShow.length; l++) {
				...
				for (c = 0; 2 > c; c++) {
					...
					e._ff && e._ff <= 20 && (a[s + "transition-property"] = "all", a[s + "transition-timing-function"] = e.animation.easing + "ms", a[s + "transition-duration"] = e.animation.duration + "ms"),
					a[s + "transition-delay"] = r + "ms",
					a[s + "transform"] = "translate(" + o.x + "px," + o.y + "px)"
				}
				(e.effects.transform || e.effects.opacity) && e._bindTargetDone(i),
				e._ff && e._ff <= 20 ? i.css(a) : i.css(e.effects.transition).css(a)
			}
			for (l = 0; l < e._$pre.length; l++) {
				...
				r = e._getDelay(l);
				(n.dataset.finalPosX !== n.dataset.origPosX || n.dataset.finalPosY !== n.dataset.origPosY) && e._bindTargetDone(i),
				i.css(e._getPrefixedCSS("transition", "all " + e.animation.duration + "ms " + e.animation.easing + " " + r + "ms")),
				i.css(e._getPrefixedCSS("transform", "translate(" + o.x + "px," + o.y + "px)")),
				e.animation.animateResizeTargets && (n.dataset.origWidth - n.dataset.finalWidth && 1 * n.dataset.finalWidth && (n.style.width = n.dataset.finalWidth + "px", n.style.marginRight =  - (n.dataset.finalWidth - n.dataset.interWidth) + 1 * n.dataset.finalMarginRight + "px"), n.dataset.origHeight - n.dataset.finalHeight && 1 * n.dataset.finalHeight && (n.style.height = n.dataset.finalHeight + "px", n.style.marginBottom =  - (n.dataset.finalHeight - n.dataset.interHeight) + 1 * n.dataset.finalMarginBottom + "px"))
			}
			e._changingClass && e._$container.removeClass(e.layout.containerClass).addClass(e._newClass);
			for (var l = 0; l < e._$toHide.length; l++) {
				for (var n = e._$toHide[l], i = t(n), r = e._getDelay(l), u = {}, c = 0; 2 > c; c++)
					u[(s = 0 === c ? s = e._prefix : "") + "transition-delay"] = r + "ms", u[s + "transform"] = e.effects.transformOut, u.opacity = e.effects.opacity;
				i.css(e.effects.transition).css(u),
				(e.effects.transform || e.effects.opacity) && e._bindTargetDone(i)
			}
		...
		_bindTargetDone: function (e) {
			...
			i.dataset.bound || (i.dataset.bound = !0, n._targetsBound++, e.on("webkitTransitionEnd.mixItUp transitionend.mixItUp", function (o) {
					(o.originalEvent.propertyName.indexOf("transform") > -1 || o.originalEvent.propertyName.indexOf("opacity") > -1) && t(o.originalEvent.target).is(n.selectors.target) && (e.off(".mixItUp"), i.dataset.bound = "", n._targetDone())
				})),
		...
		_cleanUp: function () {
			...
			e._changingLayout && (e._changingDisplay && (e.layout.display = e._newDisplay, e._changingDisplay = !1), e._changingClass && (e._$parent.removeClass(e.layout.containerClass).addClass(e._newClass), e.layout.containerClass = e._newClass, e._changingClass = !1), e._changingLayout = !1),
			e._refresh(),
			e._buildState(),
			...
			e._state.fail && ("function" == typeof e.callbacks.onMixFail && e.callbacks.onMixFail.call(e._domNode, e._state, e), e._$container.trigger("mixFail", [e._state, e])),
			e._loading && ("function" == typeof e.callbacks.onMixLoad && e.callbacks.onMixLoad.call(e._domNode, e._state, e), e._$container.trigger("mixLoad", [e._state, e])),
			e._queue.length && (e._execAction("_queue", 0), e.multiMix(e._queue[0][0], e._queue[0][1], e._queue[0][2]), e._queue.splice(0, 1)),
		...
		_parseInsertArgs: function (e) {
			for (var n = this, i = {
				...
				var r = e[o];
				"number" == typeof r ? i.index = r : "object" == typeof r && r instanceof t ? i.$object = r : "object" == typeof r && n._helpers._isElement(r) ? i.$object = t(r) : "object" == typeof r && null !== r ? i.multiMix = r : "boolean" != typeof r || r ? "function" == typeof r && (i.callback = r) : i.multiMix = !1
			}
		...
		_execAction: function (t, e, n) {
			...
			if (!i._actions.isEmptyObject && i._actions.hasOwnProperty(t))
				for (var r in i._actions[t][o])
					i._actions[t][o][r].call(i, n)
		},
		_execFilter: function (t, e, n) {
			var i = this;
			if (i._filters.isEmptyObject || !i._filters.hasOwnProperty(t))
				return e;
			for (var o in i._filters[t])
				return i._filters[t][o].call(i, n)
		},
		_helpers: {
		...
		multiMix: function () {
			...
			if (t._execAction("multiMix", 0, arguments), t._mixing)
				...
				t.controls.enable && !t._clicking && (t.controls.toggleFilterButtons && t._buildToggleArray(), t._updateControls(n.command, t.controls.toggleFilterButtons)),
				...
				t._refresh(),
				i && (t._newSort = t._parseSort(i), t._newSortString = i, t._sorting = !0, t._sort()),
				o !== e && (o = "all" === o ? t.selectors.target : o, t._activeFilter = o),
				t._filter(),
				r && (t._newDisplay = "string" == typeof r ? r : r.display || t.layout.display, t._newClass = r.containerClass || "", (t._newDisplay !== t.layout.display || t._newClass !== t.layout.containerClass) && (t._changingLayout = !0, t._changingClass = t._newClass !== t.layout.containerClass, t._changingDisplay = t._newDisplay !== t.layout.display)),
				t._$targets.css(t._brake),
				t._goMix(n.animate ^ t.animation.enable ? n.animate : t.animation.enable),
		...
		getOption: function (t) {
			var n = this;
			return t ? n._execFilter("getOption", function (t, n) {
				for (var i = n.split("."), o = i.pop(), r = i.length, a = 1, s = i[0] || n; (t = t[s]) && r > a; )
					s = i[a], a++;
		...
		destroy: function (e) {
			...
			n._$body.add(t(n.selectors.sort)).add(t(n.selectors.filter)).off(".mixItUp");
			...
			i[n.selectors.filter] && i[n.selectors.filter] > 1 ? i[n.selectors.filter]-- : 1 === i[n.selectors.filter] && delete i[n.selectors.filter],
			o[n.selectors.sort] && o[n.selectors.sort] > 1 ? o[n.selectors.sort]-- : 1 === o[n.selectors.sort] && delete o[n.selectors.sort],
	...
	t.fn.mixItUp = function () {
		...
		r = function (e, n) {
			...
			e.id = e.id ? e.id : "MixItUp" + function () {
			...
			for (var o = this, r = n.split(" "), a = 0; a < r.length; a++)
				for (var s = 0; 4 > s; s++) {
					...
					case 2:
						...
						break;
					case 3:
						var l = t.MixItUp.prototype._helpers._camelCase(i + r[a])
					}
					if (o.style[l] !== e && "unknown" != typeof o.style[l] && o.style[l].length > 0 && (o.style[l] = ""), !i && 1 === s)
						break
				}
...
("undefined" != typeof global ? global : this.window || this.global, function (t) {
	...
	d = function () {
		...
		for ("[object Boolean]" === Object.prototype.toString.call(arguments[0]) && (e = arguments[0], n++); n < i; n++)
			!function (n) {
				for (var i in n)
					Object.prototype.hasOwnProperty.call(n, i) && (e && "[object Object]" === Object.prototype.toString.call(n[i]) ? t[i] = d(!0, t[i], n[i]) : t[i] = n[i])
			}
		(arguments[n]);
		return t
	},
	...
	p = function (t) {
		...
		for (var e, n = String(t), i = n.length, o = -1, r = "", a = n.charCodeAt(0); ++o < i; ) {
			...
			r += e >= 1 && e <= 31 || 127 == e || 0 === o && e >= 48 && e <= 57 || 1 === o && e >= 48 && e <= 57 && 45 === a ? "\\" + e.toString(16) + " " : e >= 128 || 45 === e || 95 === e || e >= 48 && e <= 57 || e >= 65 && e <= 90 || e >= 97 && e <= 122 ? n.charAt(o) : "\\" + n.charAt(o)
		}
		return "#" + r
	},
	g = function (t, e) {
	...
	l.animateScroll = function (n, i, a) {
		...
		if (h || f) {
			...
			var v,
			_,
			k = h ? n : m(f, r, parseInt("function" == typeof u.offset ? u.offset() : u.offset, 10)),
			C = k - p,
			S = y(),
			T = 0,
			D = function (e, o, r) {
				var a = t.pageYOffset;
				(e == o || a == o || t.innerHeight + a >= S) && (clearInterval(r), w(n, o, h), u.callback(n, i))
			},
			M = function () {
				v = (T += 16) / parseInt(u.speed, 10),
				v = v > 1 ? 1 : v,
				_ = p + C * g(u.easing, v),
	...
	var _ = function (e) {
		try {
			p(decodeURIComponent(t.location.hash))
		} catch (e) {
			p(t.location.hash)
		}
		n && (n.id = n.getAttribute("data-scroll-id"), l.animateScroll(n, i), n = null, i = null)
	},
	k = function (o) {
		if (0 === o.button && !o.metaKey && !o.ctrlKey && (i = f(o.target, e.selector)) && "a" === i.tagName.toLowerCase() && i.hostname === t.location.hostname && i.pathname === t.location.pathname && /#/.test(i.href)) {
			var r;
			try {
				r = p(decodeURIComponent(i.hash))
			} catch (t) {
				r = p(i.hash)
			}
			if ("#" === r) {
				o.preventDefault();
				var a = (n = document.body).id ? n.id : "smooth-scroll-top";
				return n.setAttribute("data-scroll-id", a),
				n.id = "",
				void(t.location.hash.substring(1) === a ? _() : t.location.hash = a)
			}
			(n = document.querySelector(r)) && (n.setAttribute("data-scroll-id", n.id), n.id = "", i.hash === t.location.hash && (o.preventDefault(), _()))
		}
	},
	C = function (t) {
	...
	return l.destroy = function () {
		e && (document.removeEventListener("click", k, !1), t.removeEventListener("resize", C, !1), e = null, n = null, i = null, o = null, r = null, a = null, s = null)
	},
	l.init = function (n) {
		u && (l.destroy(), e = d(c, n || {}), o = e.selectorHeader ? document.querySelector(e.selectorHeader) : null, r = x(o), document.addEventListener("click", k, !1), t.addEventListener("hashchange", _, !1), o && t.addEventListener("resize", C, !1))
	},
	l
}), function (t, e) {
					...
					return o(t, [{
								...
								value: function (t, e) {
									...
									return !0 === this.pause.status ? void this.setPauseStatus(t, e, !0) : void(this.timeout = setTimeout(function () {
												...
												if ("^" === o.charAt(0)) {
													var r = 1;
													/^\^\d+/.test(o) && (o = /\d+/.exec(o)[0], r += o.length, i = parseInt(o), n.temporaryPause = !0, n.options.onTypingPaused(n.arrayPos, n)),
													n.toggleBlinking(!0),
												...
												n.timeout = setTimeout(function () {
														n.toggleBlinking(!1),
														e === t.length ? n.doneTyping(t, e) : n.keepTyping(t, e),
...
(this, function () {
	...
	t.show = function (i) {
		...
		if (r.style.margin = 0, r.style.padding = 0, r.style.color = o.textColor, r.style.fontSize = "14px", r.style.fontWeight = 300, r.style.lineHeight = "1em", r.innerHTML = o.text, t.snackbar.appendChild(r), t.snackbar.style.background = o.backgroundColor, o.showAction) {
			...
			a.className = "action",
			a.innerHTML = o.actionText,
			a.style.color = o.actionTextColor,
		...
		setTimeout(function () {
			t.current === this && (t.current.style.opacity = 0)
		}
			.bind(t.snackbar), o.duration),
		t.snackbar.addEventListener("transitionend", function (e, n) {
			"opacity" == e.propertyName && "0" == this.style.opacity && (this.parentElement.removeChild(this), t.current === this && (t.current = null))
		}
			.bind(t.snackbar)),
		t.current = t.snackbar,
		("top-left" === o.pos || "top-center" === o.pos || "top" === o.pos || "top-right" === o.pos) && (t.snackbar.style.top = "-100px"),
		...
		t.snackbar.className = "snackbar-container " + o.customClass + " snackbar-pos " + o.pos,
		"top-left" === o.pos || "top-right" === o.pos ? t.snackbar.style.top = 0 : "top-center" === o.pos || "top" === o.pos ? t.snackbar.style.top = "25px" : ("bottom-center" === o.pos || "bottom" === o.pos) && (t.snackbar.style.bottom = "-25px")
	},
	t.close = function () {
	...
	var n = function () {
		...
		for (; i > n; n++)
			!function (n) {
				for (var i in n)
					Object.prototype.hasOwnProperty.call(n, i) && (e && "[object Object]" === Object.prototype.toString.call(n[i]) ? t[i] = extend(!0, t[i], n[i]) : t[i] = n[i])
			}
		(arguments[n]);
		return t
	};
...
(function (t, e) {
	...
	function s(e, n) {
		...
		for (var l in r)
			n.test(l) && (o = l.replace(s, i), a[o] = r[l]);
		return a
	}
	function l(e) {
		var n = {};
		...
		var e = {
			...
			contains: function (t) {
				for (var e = t && t.valueOf(), n = 0, i = this.length; n < i; n++)
					if (0 <= this[n].valueOf() - e && this[n].valueOf() - e < 864e5)
						return n;
				return -1
			},
			remove: function (t) {
	...
	c.prototype = {
		...
		_process_options: function (e) {
			...
			r = o.language;
			m[r] || (r = r.split("-")[0], m[r] || (r = p.language)),
			o.language = r,
		...
		_applyEvents: function (t) {
			for (var n, i, o, r = 0; r < t.length; r++)
				n = t[r][0], 2 === t[r].length ? (i = e, o = t[r][1]) : 3 === t[r].length && (i = t[r][1], o = t[r][2]), n.on(o, i)
		},
		_unapplyEvents: function (t) {
			for (var n, i, o, r = 0; r < t.length; r++)
				n = t[r][0], 2 === t[r].length ? (o = e, i = t[r][1]) : 3 === t[r].length && (o = t[r][1], i = t[r][2]), n.off(i, o)
		},
		...
		place: function () {
			...
			o = i.width(),
			r = "body" === this.o.container ? t(document).scrollTop() : i.scrollTop(),
			a = i.offset(),
			s = [0];
			...
			h = u.left - a.left,
			f = u.top - a.top;
			"body" !== this.o.container && (f += r),
			this.picker.removeClass("datepicker-orient-top datepicker-orient-bottom datepicker-orient-right datepicker-orient-left"),
			"auto" !== this.o.orientation.x ? (this.picker.addClass("datepicker-orient-" + this.o.orientation.x), "right" === this.o.orientation.x && (h -= e - d)) : u.left < 0 ? (this.picker.addClass("datepicker-orient-left"), h -= u.left - 10) : h + e > o ? (this.picker.addClass("datepicker-orient-right"), h += d - e) : this.o.rtl ? this.picker.addClass("datepicker-orient-right") : this.picker.addClass("datepicker-orient-left");
			var p,
			g = this.o.orientation.y;
			if ("auto" === g && (p = -r + f - n, g = p < 0 ? "bottom" : "top"), this.picker.addClass("datepicker-orient-" + g), "top" === g ? f -= n + parseInt(this.picker.css("padding-top")) : f += c, this.o.rtl) {
				var m = o - (h + d);
				this.picker.css({
					top: f,
					right: m,
		...
		update: function () {
			...
			return arguments.length ? (t.each(arguments, t.proxy(function (t, e) {
						...
						n.push(e)
					}, this)), i = !0) : (n = this.isInput ? this.element.val() : this.element.data("date") || this.inputField.val(), n = n && this.o.multidate ? n.split(this.o.multidateSeparator) : [n], delete this.element.data().date),
		...
		fillDow: function () {
			if (this.o.showWeekDays) {
				...
				for (this.o.calendarWeeks && (n += '<th class="cw">&#160;</th>'); e < this.o.weekStart + 7; )
					n += '<th class="dow', -1 !== t.inArray(e, this.o.daysOfWeekDisabled) && (n += " disabled"), n += '">' + m[this.o.language].daysMin[e++ % 7] + "</th>";
				n += "</tr>",
				this.picker.find(".datepicker-days thead").append(n)
			}
		},
		fillMonths: function () {
			for (var t, e = this._utc_to_local(this.viewDate), n = "", i = 0; i < 12; i++)
				t = e && e.getMonth() === i ? " focused" : "", n += '<span class="month' + t + '">' + m[this.o.language].monthsShort[i] + "</span>";
		...
		getClassNames: function (e) {
			...
			s = i();
			return e.getUTCFullYear() < r || e.getUTCFullYear() === r && e.getUTCMonth() < a ? n.push("old") : (e.getUTCFullYear() > r || e.getUTCFullYear() === r && e.getUTCMonth() > a) && n.push("new"),
			this.focusDate && e.valueOf() === this.focusDate.valueOf() && n.push("focused"),
			this.o.todayHighlight && o(e, s) && n.push("today"),
		...
		_fill_yearsView: function (n, i, o, r, a, s, l) {
			for (var u, c, d, h = "", f = o / 10, p = this.picker.find(n), g = Math.floor(r / o) * o, m = g + 9 * f, v = Math.floor(this.viewDate.getFullYear() / f) * f, y = t.map(this.dates, function (t) {
						return Math.floor(t.getUTCFullYear() / f) * f
					}), b = g - f; b <= m + f; b += f)
				u = [i], c = null, b === g - f ? u.push("old") : b === m + f && u.push("new"), -1 !== t.inArray(b, y) && u.push("active"), (b < a || b > s) && u.push("disabled"), b === v && u.push("focused"), l !== t.noop && (d = l(new Date(b, 0, 1)), d === e ? d = {}
					 : "boolean" == typeof d ? d = {
						enabled: d
					}
					 : "string" == typeof d && (d = {
		...
		fill: function () {
			...
			if (!isNaN(a) && !isNaN(s)) {
				this.picker.find(".datepicker-days .datepicker-switch").text(v.formatDate(r, p, this.o.language)),
				this.picker.find("tfoot .today").text(h).css("display", !0 === this.o.todayBtn || "linked" === this.o.todayBtn ? "table-cell" : "none"),
				...
				b = b.valueOf();
				for (var x, w, _ = []; g.valueOf() < b; ) {
					if ((x = g.getUTCDay()) === this.o.weekStart && (_.push("<tr>"), this.o.calendarWeeks)) {
						var k = new Date(+g + (this.o.weekStart - x - 7) % 7 * 864e5),
						C = new Date(Number(k) + (11 - k.getUTCDay()) % 7 * 864e5),
						S = new Date(Number(S = n(C.getUTCFullYear(), 0, 1)) + (11 - S.getUTCDay()) % 7 * 864e5),
						T = (C - S) / 864e5 / 7 + 1;
						_.push('<td class="cw">' + T + "</td>")
					}
					(w = this.getClassNames(g)).push("day");
					var D = g.getUTCDate();
					this.o.beforeShowDay !== t.noop && (o = this.o.beforeShowDay(this._utc_to_local(g)), o === e ? o = {}
						 : "boolean" == typeof o ? o = {
							enabled: o
						}
						 : "string" == typeof o && (o = {
								classes: o
							}), !1 === o.enabled && w.push("disabled"), o.classes && (w = w.concat(o.classes.split(/\s+/))), o.tooltip && (i = o.tooltip), o.content && (D = o.content)),
					w = t.isFunction(t.uniqueSort) ? t.uniqueSort(w) : t.unique(w),
					_.push('<td class="' + w.join(" ") + '"' + (i ? ' title="' + i + '"' : "") + ' data-date="' + g.getTime().toString() + '">' + D + "</td>"),
					i = null,
					x === this.o.weekEnd && _.push("</tr>"),
				...
				A = this.picker.find(".datepicker-months").find(".datepicker-switch").text(this.o.maxViewMode < 2 ? M : a).end().find("tbody span").removeClass("active");
				if (t.each(this.dates, function (t, e) {
						e.getUTCFullYear() === a && A.eq(e.getUTCMonth()).addClass("active")
					}), (a < l || a > c) && A.addClass("disabled"), a === l && A.slice(0, u).addClass("disabled"), a === c && A.slice(d + 1).addClass("disabled"), this.o.beforeShowMonth !== t.noop) {
					var E = this;
					t.each(A, function (n, i) {
						...
						!1 !== r.enabled || t(i).hasClass("disabled") || t(i).addClass("disabled"),
						r.classes && t(i).addClass(r.classes),
						r.tooltip && t(i).prop("title", r.tooltip)
					})
				}
		...
		updateNavArrows: function () {
			if (this._allow_update) {
				...
				case 2:
					u *= 10;
				case 1:
					t = Math.floor(i / u) * u <= r,
					e = Math.floor(i / u) * u + u >= s
				}
		...
		click: function (e) {
			...
			a,
			s;
			(o = t(e.target)).hasClass("datepicker-switch") && this.viewMode !== this.o.maxViewMode && this.setViewMode(this.viewMode + 1),
			...
			o.hasClass("disabled") || (o.hasClass("month") || o.hasClass("year") || o.hasClass("decade") || o.hasClass("century")) && (this.viewDate.setUTCDate(1), r = 1, 1 === this.viewMode ? (s = o.parent().find("span").index(o), a = this.viewDate.getUTCFullYear(), this.viewDate.setUTCMonth(s)) : (s = 0, a = Number(o.text()), this.viewDate.setUTCFullYear(a)), this._trigger(v.viewModes[this.viewMode - 1].e, this.viewDate), this.viewMode === this.o.minViewMode ? this._setDate(n(a, s, r)) : (this.setViewMode(this.viewMode - 1), this.fill())),
		...
		moveMonth: function (t, e) {
			...
			for (; i(); )
				o.setUTCDate(--r), o.setUTCMonth(n);
			return o
		},
		...
		keydown: function (t) {
			if (this.picker.is(":visible")) {
				...
				case 40:
					...
					0 === this.viewMode ? t.ctrlKey ? (n = this.moveAvailableDate(o, e, "moveYear")) && this._trigger("changeYear", this.viewDate) : t.shiftKey ? (n = this.moveAvailableDate(o, e, "moveMonth")) && this._trigger("changeMonth", this.viewDate) : 37 === t.keyCode || 39 === t.keyCode ? n = this.moveAvailableDate(o, e, "moveDay") : this.weekOfDateIsDisabled(o) || (n = this.moveAvailableDate(o, e, "moveWeek")) : 1 === this.viewMode ? (38 !== t.keyCode && 40 !== t.keyCode || (e *= 4), n = this.moveAvailableDate(o, e, "moveMonth")) : 2 === this.viewMode && (38 !== t.keyCode && 40 !== t.keyCode || (e *= 4), n = this.moveAvailableDate(o, e, "moveYear")),
				...
				case 13:
					...
					this.o.keyboardNavigation && (this._toggle_multidate(o), i = !0),
					this.focusDate = null,
		...
		setViewMode: function (t) {
			this.viewMode = t,
			this.picker.children("div").hide().filter(".datepicker-" + v.viewModes[this.viewMode].clsName).show(),
			this.updateNavArrows(),
	...
	var d = function (e, n) {
		...
		f.call(t(this.inputs), n).on("changeDate", t.proxy(this.dateUpdated, this)),
				...
				if (i !== e) {
					...
					if (-1 !== a) {
						if (t.each(this.pickers, function (t, e) {
								e.getUTCDate() || e !== i && r || e.setUTCDate(o)
							}), o < this.dates[s])
							for (; s >= 0 && o < this.dates[s]; )
								this.pickers[s--].setUTCDate(o);
						else if (o > this.dates[l])
							for (; l < u && o > this.dates[l]; )
								this.pickers[l++].setUTCDate(o);
						this.updateDates(),
		...
		if (this.each(function () {
				...
				if (!r) {
					...
					e.hasClass("input-daterange") || f.inputs ? (t.extend(f, {
						...
						}), r = new d(this, f)) : r = new c(this, f),
					e.data("datepicker", r)
				}
				"string" == typeof n && "function" == typeof r[n] && (o = r[n].apply(r, i))
			}), o === e || o instanceof c || o instanceof d)
			return this;
		if (this.length > 1)
	...
	v = {
		...
		parseDate: function (n, o, r, a) {
			...
			function l() {
				var t = this.slice(0, u[f].length),
				e = u[f].slice(0, t.length);
			...
			if (n instanceof Date)
				return n;
			if ("string" == typeof o && (o = v.parseFormat(o)), o.toValue)
				return o.toValue(n, o, r);
			var u,
			d,
			h,
			f,
			...
			if (n in y && (n = y[n]), /^[\-+]\d+[dmwy]([\s,]+[\-+]\d+[dmwy])*$/i.test(n)) {
				for (u = n.match(/([\-+]\d+)([dmwy])/gi), n = new Date, f = 0; f < u.length; f++)
					d = u[f].match(/([\-+]\d+)([dmwy])/i), h = Number(d[1]), p = g[d[2].toLowerCase()], n = c.prototype[p](n, h);
			...
			k = {
				yyyy: function (t, e) {
					return t.setUTCFullYear(a ? s(e, a) : e)
				},
				m: function (t, e) {
					if (isNaN(t))
						return t;
			...
			if (u.length !== C.length && (C = t(C).filter(function (e, n) {
							return -1 !== t.inArray(n, _)
						}).toArray()), u.length === C.length) {
				var S;
				for (f = 0, S = C.length; f < S; f++) {
					if (b = parseInt(u[f], 10), d = C[f], isNaN(b))
						switch (d) {
						case "MM":
							x = t(m[r].months).filter(l),
							b = t.inArray(x[0], m[r].months) + 1;
							break;
						case "M":
							x = t(m[r].monthsShort).filter(l),
							b = t.inArray(x[0], m[r].monthsShort) + 1
						}
					w[d] = b
				}
				var T,
				...
				for (f = 0; f < _.length; f++)
					(D = _[f])in w && !isNaN(w[D]) && (T = new Date(n), k[D](T, w[D]), isNaN(T) || (n = T))
			}
			return n
		},
		formatDate: function (e, n, i) {
			...
			o.mm = (o.m < 10 ? "0" : "") + o.m,
			e = [];
			for (var r = t.extend([], n.separators), a = 0, s = n.parts.length; a <= s; a++)
				r.length && e.push(r.shift()), e.push(o[n.parts[a]]);
			return e.join("")
		},
...
(this, function (t) {
	...
	e.prototype.enable = function () {
		...
		t("body").on("click", "a[rel^=lightbox], area[rel^=lightbox], a[data-lightbox], area[data-lightbox]", function (n) {
			return e.start(t(n.currentTarget)),
			!1
		})
	},
	e.prototype.build = function () {
		...
		this.$lightbox.hide().on("click", function (n) {
			return "lightbox" === t(n.target).attr("id") && e.end(),
			!1
		}),
	...
	e.prototype.changeImage = function (e) {
		...
		o.onload = function () {
			...
			u,
			c;
			i.attr("src", n.album[e].link),
			t(o),
			i.width(o.width),
			i.height(o.height),
			n.options.fitImagesInViewport && (c = t(window).width(), u = t(window).height(), l = c - n.containerPadding.left - n.containerPadding.right - n.imageBorderWidth.left - n.imageBorderWidth.right - 20, s = u - n.containerPadding.top - n.containerPadding.bottom - n.imageBorderWidth.top - n.imageBorderWidth.bottom - 120, n.options.maxWidth && n.options.maxWidth < l && (l = n.options.maxWidth), n.options.maxHeight && n.options.maxHeight < l && (s = n.options.maxHeight), (o.width > l || o.height > s) && (o.width / l > o.height / s ? (a = l, r = parseInt(o.height / (o.width / a), 10), i.width(a), i.height(r)) : (r = s, a = parseInt(o.width / (o.height / r), 10), i.width(a), i.height(r)))),
