...
function slidebar() {
	...
	i = !1;
	n.click(function () {
		i = i ? (t.removeClass("open"), !1) : (t.addClass("open"), !0),
		e = !0
	}),
	o.click(function () {
		!e && i && (t.removeClass("open"), i = !1),
		e = !1
	})
}
!function (c, p, t) {
...
(jQuery, window), $(document).ready(function () {
	...
	$(".navbar").on("click mousedown mouseup touchstart", "a.has_children", function () {
		return $(this).next("ul").hasClass("open_t") && !$(this).parents("ul").hasClass("open_t") ? $(".open_t").removeClass("open_t") : ($(".open_t").not($(this).parents("ul")).removeClass("open_t"), $(this).next("ul").addClass("open_t")),
		!1
	}),
	$(document).on("click", ":not(.has_children, .has_children *)", function () {
		if (0 < $(".open_t").length)
			return $(".open_t").removeClass("open_t"), $(".open_t").parent().removeClass("open"), !1
	});
	var n = $(".ms-navbar"),
	e = ($(".navbar-nav"), $("body")),
...
(jQuery), function (a) {
	...
	function o(t) {
		...
		t.closest("label").hover(function () {
			...
			n = a(this).find("input"),
			e = n.prop("disabled");
			i && (t = a(this), o = e, (t.hasClass("checkbox-inline") || t.hasClass("radio-inline") ? t : t.closest(".checkbox").length ? t.closest(".checkbox") : t.closest(".radio")).toggleClass("disabled", o)),
			e || s(n)
		}, function () {
			n(a(this).find("input"))
		})
	...
	a.material = {
		...
		input: function (t) {
			a(t || this.options.inputElements).filter(":notmdproc").data("mdproc", !0).each(function () {
				...
				0 !== e.length || "hidden" === n.attr("type") || n.attr("hidden") || (n.wrap("<div class='form-group'></div>"), e = n.closest(".form-group")),
				n.attr("data-hint") && (n.after("<p class='help-block'>" + n.attr("data-hint") + "</p>"), n.removeAttr("data-hint"));
				if (a.each({
...
function tabs() {
	for (var t = $(".nav.nav-tabs"), i = {}, a = {}, o = 0; o < t.length; o++) {
		...
		p = 0;
		for (m = 0; m < e; m++)
			c[m] = p, l[m] = $(s[m]).width(), $(s[m]).children().hasClass("active") && r.css({
				left: c[m] + "px",
				width: l[m] + "px"
			}), p += l[m]
	}
